...
for code contribution.  See [githooks](https://github.com/daos-stack/daos/blob/master/utils/githooks/README.md) 
for information about setting up some automated checks on commit to help with adherence to the
rules.
