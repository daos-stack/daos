...
To improve performance, directory are cached thanks in an hash table.  The size of this hash table
could be changed, thanks to the following environment variable:
