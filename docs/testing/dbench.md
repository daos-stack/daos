...
!!! note
  The example below makes use of DAOS pools and containers setup as part of [Run IOR and mdtest](https://docs.daos.io/v2.8/testing/ior/)
...
!!! note
  In the example below the `testfile` directory was created by the ior and the `test-dir.0-0`
  directory was created by mdtest in [Run IOR and mdtest](https://docs.daos.io/v2.8/testing/ior/).
  The `clients` directory was generated by running dbench.
