...
!!! note
  ...
  [Run IOR and mdtest](https://docs.daos.io/v2.8/testing/ior/). It also makes use of data
  written to the same pool as part of [Run dbench](https://docs.daos.io/v2.8/testing/dbench/).
