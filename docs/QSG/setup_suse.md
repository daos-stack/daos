...
1. Configure access to the [DAOS package repository](https://packages.daos.io/v2.2/):
		...
		pdsh -w $ALL_NODES 'sudo zypper ar https://packages.daos.io/v2.2/Leap15/packages/x86_64/daos_packages.repo'
...
2. (Optional) Check daos\_agent status:
		...
		node-2: agent INFO 2022/05/05 22:38:46 DAOS Agent v2.2 (pid 47580) listening on /var/run/daos_agent/daos_agent.sock
		node-3: agent INFO 2022/05/05 22:38:53 DAOS Agent v2.2 (pid 39135) listening on /var/run/daos_agent/daos_agent.sock
