...
over which domain-specific data models are ported,
such as [HDF5](https://docs.daos.io/v2.0/user/hdf5/),
[MPI-IO](https://docs.daos.io/v2.0/user/mpi-io/),
and Apache [Hadoop](https://docs.daos.io/v2.0/user/spark/).
A [POSIX](https://docs.daos.io/v2.0/user/filesystem/) I/O emulation layer implementing files and
