...
[DAOS Administration Guide](https://docs.daos.io/v2.0/admin/deployment/#certificate-configuration).
...
[certificates](https://docs.daos.io/v2.0/admin/deployment/#certificate-configuration)
...
are the [rules](https://docs.daos.io/v2.0/overview/security/#enforcement)
