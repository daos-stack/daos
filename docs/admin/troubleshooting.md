...
|-|-|-|
|Control Plane|control_log_file|/var/log/daos_server/daos_server.log|
|Data Plane|log_file|/var/log/daos_server/daos_engine.\*.log|
|[Privileged Helper](https://docs.daos.io/v2.6/admin/predeployment_check/#privileged-helper)|helper_log_file|/var/log/daos_server/daos_admin.log|
|agent|log_file|/var/log/daos_client/daos_agent.log|
