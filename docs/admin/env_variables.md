...
|DAOS\_STRICT_SHUTDOWN|Use the strict mode when shutting down engines. BOOL. Default to 0. In the strict mode, hen certain resource leaks are detected, for instance, the engine will raise an assertion failure.|
