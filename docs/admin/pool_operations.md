...
[pool permissions](https://docs.daos.io/v2.0/overview/security/#permissions).
...
The ACL file format is detailed in [here](https://docs.daos.io/v2.0/overview/security/#acl-file).
