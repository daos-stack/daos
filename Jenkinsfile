...
// Special for local CentOS 8 appstream repository
def centos_8_apstream() {
    String ret_str = ""
    if (env.REPOSITORY_URL && env.DAOS_STACK_APPSTREAM_REPO) {
        ret_str = " --build-arg REPO_APPSTREAM=" + env.DAOS_STACK_APPSTREAM_REPO
    }
    return ret_str
}
