...
#echo $run_cmd
#`$run_cmd`
bash -c "spdk_nvme_perf -q 16 -o 1048576 -w write -t 900 -c 0xf00000f ${transport_ids}"
rc_spdk_perf=`echo $?`
...
bash -c "spdk_nvme_perf -q 16 -o 1048576 -w read -t 900 -c 0xf00000f ${transport_ids}"
rc_spdk_perf=`echo $?`
if [[ $rc_spdk_perf != 0 ]]; then
