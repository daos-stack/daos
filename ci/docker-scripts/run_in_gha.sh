...
ci/docker-scripts/gha-file-check.sh.sh -n /opt/daos/bin/dmg
scons --jobs "$DEPS_JOBS" client install
ci/docker-scripts/gha-file-check.sh -n /opt/daos/bin/daos_engine
ci/docker-scripts/gha-file-check.sh -n /opt/daos/bin/vos_tests
ci/docker-scripts/gha-file-check.sh /opt/daos/bin/dmg
echo ::endgroup::
...
ci/docker-scripts/gha-file-check.sh /opt/daos/bin/daos_engine
ci/docker-scripts/gha-file-check.sh -n /opt/daos/bin/vos_tests
ci/docker-scripts/gha-file-check.sh -n /opt/daos/bin/dmg
echo ::endgroup::
...
scons install
ci/docker-scripts/gha-file-check.sh /opt/daos/bin/daos_engine
ci/docker-scripts/gha-file-check.sh /opt/daos/bin/vos_tests
ci/docker-scripts/gha-file-check.sh /opt/daos/bin/dmg
echo ::endgroup::
