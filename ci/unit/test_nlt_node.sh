...
# ./utils/node_local_test.py --max-log-size 1600MiB --dfuse-dir /localhome/jenkins/ \
#			   --server-valgrind all

./utils/node_local_test.py --max-log-size 1600MiB --dfuse-dir /localhome/jenkins/ all
