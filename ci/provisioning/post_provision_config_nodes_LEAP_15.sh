...
distro_custom() {
    ...
    python3 -m pip install "avocado-framework<83.0"
    python3 -m pip install "avocado-framework-plugin-result-html<83.0"
    python3 -m pip install "avocado-framework-plugin-varianter-yaml-to-mux<83.0"
