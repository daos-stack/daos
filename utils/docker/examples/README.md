...
The first step is to install and configure the `daos_agent` service on the docker host.  Please
refer to docs/QSG/setup\_rhel.md or docs/QSG/setup\_suse.md for detailled instructions.
