...
From a local, tree they could also be built with the following commands:
...
The value of the `DAOS_IFACE_IP` shall be replaced with the one of the interface which was provided
when the images have been built.
