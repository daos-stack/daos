...
libfabric="${LIBFABRIC_HASH:-2e97711b8faf0876b95d813b28fae0beb4d6016e}"
# https://github.com/daos-stack/mercury.git
mercury="${MERCURY_HASH:-3e568e6f9ed3646d82e7cec3e27d4f38fcd929bc}"
# https://github.com/daos-stack/isa-l.git
isal="${ISA-L_HASH:-500b6b0f4f0748385265e77ec8dc0c2063a6f8d1}"
# https://github.com/daos-stack/isa-l_crypto.git
isal_crypto="${ISA-L_CRYPTO_HASH:-f98224c2f481e3f119248ff6e27aa7d34a39b8f0}"
# https://github.com/daos-stack/argobots.git
argobots="${ARGOBOTS_HASH:-7a123c8bf1c327adef682904eb813d0fd84b5dd6}"
# https://github.com/daos-stack/dpdk.git
# dpdk isn't specified in utils/build.config but
# changes with spdk
dpdk="${DPDK_HASH:-372c857e0122f0777a8e2b76c4988614917384bb}"
# https://github.com/daos-stack/spdk.git
spdk="${SPDK_HASH:-cefc39f9a511206fcb4e28b0f8f06ac593808a04}"
# https://github.com/daos-stack/raft.git
raft="${RAFT_HASH:-3a9c1d9e0e4b8f3bcf8141113c10d6ad55da91cf}"
# https://github.com/daos-stack/pmdk.git
pmdk="${PMDK_HASH:-7fe78c07067e988c61308139dc1f3ddb5b310607}"
