...
SUITES_YAML = [
    "src/bio/smd/tests/utest.yaml",
    "src/client/api/tests/utest.yaml",
    "src/common/tests/utest.yaml",
    "src/control/utest.yaml",
    "src/gurt/tests/utest.yaml",
    "src/mgmt/tests/utest.yaml",
    "src/object/tests/utest.yaml",
    "src/placement/tests/utest.yaml",
    "src/rdb/raft_tests/utest.yaml",
    "src/security/tests/utest.yaml",
    "src/tests/ftest/cart/utest/utest.yaml",
    "src/tests/rpc/utest.yaml",
    "src/vea/tests/utest.yaml",
    "src/vos/storage_estimator/common/tests/utest.yaml",
    "src/vos/tests/utest.yaml",
]
    ...
    def create_junit(self):
        ...
        if self.results["failures"]:
            self.test.add_failure_info(message=f"{self.results['failures']} of "
                                               + f"{self.results['tests'].tests} failed",
    ...
    for yamlfile in SUITES_YAML:
        ...
        for suite_yaml in all_suites:
            try:
                ...
                print(f"Error processing {yamlfile} {exception}")
                raise exception
            except (KeyError, ValueError) as exception:
                print(f"Error processing {yamlfile}")
                raise exception
