...
%endif
BuildRequires: libpmemobj-devel >= 2.0.1
%if (0%{?rhel} >= 8)
...
Requires: libpmemobj1 >= 2.0.1-1.suse1500
Requires: libfabric1 >= %{libfabric_version}
%else
Requires: ipmctl >= 03.00.00.0468
Requires: libpmemobj >= 2.0.1-1%{?dist}
%endif
...
%changelog
* Thu Dec 7 2023 Oksana Salyk <oksana.salyk@intel.com> 2.5.100-13
- Update to PMDK 2.0.1
