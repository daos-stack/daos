...
sed -i -e '1s/env //' %{buildroot}{%{daoshome}/TESTING/ftest/{cart/cart_logtest,config_file_gen,directory_tree,launch,slurm_setup,tags,verify_perms}.py,%{_bindir}/daos_storage_estimator.py}
