...
$(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)$(REPOSITORY_URL)$(DAOS_STACK_$(DISTRO_BASE)_RELEASEVER_APPSTREAM_REPO)|
else
...
chrootbuild: $(DEB_TOP)/$(DEB_DSC)
	...
	JOB_REPOS="$(JOB_REPOS)"                                                   \
	DISTRO_BASE_LOCAL_REPOS="$(subst $$,\$$,$(value DISTRO_BASE)_LOCAL_REPOS)" \
