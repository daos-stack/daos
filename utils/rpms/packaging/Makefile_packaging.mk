  ...
  ifneq ($(REPOSITORY_URL),)
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_$(DAOS_REPO_TYPE)_REPO),)
      ...
      ifeq ($(DISTRO_BASE), EL_8)
        ...
        $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(subst centos-$(ORIG_TARGET_VER),centos-$(DISTRO_VERSION),$(REPOSITORY_URL)repository/centos-8-base-x86_64-proxy)
        $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(subst centos-$(ORIG_TARGET_VER),centos-$(DISTRO_VERSION),$(REPOSITORY_URL)repository/centos-8-extras-x86_64-proxy)
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst $(ORIG_TARGET_VER),$(DISTRO_VERSION),$(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO))
    endif
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst $(ORIG_TARGET_VER),$(DISTRO_VERSION),$(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO))
    endif
