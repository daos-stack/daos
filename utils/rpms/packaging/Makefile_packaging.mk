...
ifeq ($(LOCAL_REPOS),true)
  ifneq ($(REPOSITORY_URL),)
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst 8.3,$(DISTRO_VERSION),$(DAOS_STACK_$(DISTRO_BASE)_APPSTREAM_REPO))
    endif
    ...
    ifneq ($(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO),)
      $(DISTRO_BASE)_LOCAL_REPOS := $($(DISTRO_BASE)_LOCAL_REPOS)|$(REPOSITORY_URL)$(subst 8.3,$(DISTRO_VERSION),$(DAOS_STACK_$(DISTRO_BASE)_POWERTOOLS_REPO))
    endif
