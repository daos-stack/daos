...
static const struct CMUnitTest discard_tests[] = {
	{ "VOS421: Discard SV with specified epoch",
	  discard_1, NULL, agg_tst_teardown },
	{ "VOS422: Discard SV with confined epr",
	  discard_2, NULL, agg_tst_teardown },
	{ "VOS423: Discard SV with epr [0, DAOS_EPOCH_MAX]",
	  discard_3, NULL, agg_tst_teardown },
	{ "VOS424: Discard SV with punch records",
	  discard_4, NULL, agg_tst_teardown },
	{ "VOS425: Discard SV with random punch, random yield",
	  discard_5, NULL, agg_tst_teardown },
	{ "VOS426: Discard SV, multiple objects, keys",
	  discard_6, NULL, agg_tst_teardown },
	{ "VOS427: Discard EV with specified epoch",
	  discard_7, NULL, agg_tst_teardown },
	{ "VOS428: Discard EV with confined epr",
	  discard_8, NULL, agg_tst_teardown },
	{ "VOS429: Discard EV with epr [0, DAOS_EPOCH_MAX]",
