...
punch_model_test(void **state)
{
	...
	set_iov(&dkey, &dkey_buf[0], arg->ofeat & DAOS_OT_DKEY_UINT64);
	set_iov(&akey, &akey_buf[0], arg->ofeat & DAOS_OT_AKEY_UINT64);
...
test_inprogress_parent_punch(void **state)
{
	...
	set_iov(&dkey, &dkey_buf[0], arg->ofeat & DAOS_OT_DKEY_UINT64);
	set_iov(&akey1, &akey1_buf[0], arg->ofeat & DAOS_OT_AKEY_UINT64);
	set_iov(&akey2, &akey2_buf[0], arg->ofeat & DAOS_OT_AKEY_UINT64);
	set_iov(&akey3, &akey3_buf[0], arg->ofeat & DAOS_OT_AKEY_UINT64);
...
uncommitted_parent(void **state)
{
	...
	set_iov(&akey[0], &akey_buf[0][0], arg->ofeat & DAOS_OT_AKEY_UINT64);
	vts_key_gen(&akey_buf[1][0], arg->akey_size, true, arg);
	set_iov(&akey[1], &akey_buf[1][0], arg->ofeat & DAOS_OT_AKEY_UINT64);
