...
static int
vos_ilog_status_get(struct umem_instance *umm, uint16_t tx_id,
...
static int
vos_ilog_is_same_tx(struct umem_instance *umm, uint16_t tx_id,
		    daos_epoch_t epoch, bool *same, void *args)
{
	uint16_t dtx = vos_dtx_get();
...
static int
vos_ilog_add(struct umem_instance *umm, umem_off_t ilog_off, uint16_t *tx_id,
...
static int
vos_ilog_del(struct umem_instance *umm, umem_off_t ilog_off, uint16_t tx_id,
