...
struct vos_agg_lgc_ent {
	struct evt_extent	 le_ext;
	struct vos_agg_phy_ent	*le_phy_ent;
};
...
struct vos_agg_lgc_seg {
	...
	struct vos_agg_phy_ent	*ls_phy_ent;
...
struct vos_agg_io_context {
	...
	struct vos_agg_lgc_seg	*ic_segs;
...
static unsigned int
csum_widen_biov(struct bio_iov *biov, struct vos_agg_phy_ent *phy_ent,
