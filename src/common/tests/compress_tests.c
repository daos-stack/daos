...
"ligula sed purus varius aliquet interdum vitae justo. Proin quis diam velit. "
"Nulla varius iaculis auctor. Cras volutpat, justo eu dictum pulvinar, elit "
...
"sed pellentesque lectus. Fusce sagittis sit amet elit vel varius. Donec "
"sed ligula nec ligula vulputate rutrum sed ut lectus. Etiam congue pharetra "
"leo vitae cursus. Morbi enim ante, porttitor ut varius vel, tincidunt quis "
...
test_alg_basic(const char *alg_name)
{
	...
	compressed_sz = daos_compressor_compress(compressor,
						origin_buf, origion_sz,
						comp_buf, compressed_sz);
