...
main(int argc, char **argv)
{
	...
	static const struct CMUnitTest umem_tests[] = {
	    {.name          = "BMEM001: Test atomic alloc/free",
	     .test_func     = test_atomic_alloc,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM002: Test null flags pmem",
	     .test_func     = test_invalid_flags,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM003: Test alloc pmem",
	     .test_func     = test_alloc,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM004: Test atomic copy",
	     .test_func     = test_atomic_copy,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM005: Test simple commit tx",
	     .test_func     = test_simple_commit_tx,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM006: Test simple abort tx",
	     .test_func     = test_simple_abort_tx,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM007: Test nested commit tx",
	     .test_func     = test_nested_commit_tx,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM008: Test nested outer abort tx",
	     .test_func     = test_nested_outer_abort_tx,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM009: Test nested inner abort tx",
	     .test_func     = test_nested_inner_abort_tx,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM010: Test tx alloc/free",
	     .test_func     = test_tx_alloc,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM011: Test tx add range",
	     .test_func     = test_tx_add,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM012: Test tx add ptr",
	     .test_func     = test_tx_add_ptr,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM013: Test tx xadd ptr",
	     .test_func     = test_tx_xadd_ptr,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM014: Test tx reserve publish/cancel",
	     .test_func     = test_tx_reserve_publish_cancel,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem},
	    {.name          = "BMEM015: Test tx defer free publish/cancel",
	     .test_func     = test_tx_dfree_publish_cancel,
	     .setup_func    = setup_pmem,
	     .teardown_func = teardown_pmem}};
