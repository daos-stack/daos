...
int main(int argc, char *argv[]) {
	if (argc != 6) {
		printf("need arguments of server group, pool UUID, container UUID, file name and file length\n");
		return 1;
	}
	...
	//create file
	dfs_obj_t *file = NULL;
	rc = dfs_open(dfs, NULL, file_name, S_IFREG | 0755, O_CREAT | 02, OC_SX, 8192, NULL, &file);
	if (rc) {
