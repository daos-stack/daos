...
JNIEXPORT jlong JNICALL
Java_io_daos_DaosClient_createEventQueue
        (JNIEnv *env, jclass clientClass, jint nbrOfEvents)
{
	...
	eq->events = (daos_event_t **)malloc(nbrOfEvents * sizeof(daos_event_t *));
...
JNIEXPORT void JNICALL
Java_io_daos_DaosClient_pollCompleted
...
JNIEXPORT void JNICALL
Java_io_daos_DaosClient_destroyEventQueue
