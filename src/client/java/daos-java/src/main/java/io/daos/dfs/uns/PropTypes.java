 ...
 * </pre>
 *
 * Protobuf enum {@code uns.PropTypes}
 */
public enum PropTypes
  ...
  public static PropTypes valueOf(int value) {
   ...
   * @return The enum associated with the given numeric wire value.
   */
  public static PropTypes forNumber(int value) {
    switch (value) {
  ...
  public static com.google.protobuf.Internal.EnumLiteMap<PropTypes>
      internalGetValueMap() {
    return internalValueMap;
  }
  private static final com.google.protobuf.Internal.EnumLiteMap<
      PropTypes> internalValueMap =
        new com.google.protobuf.Internal.EnumLiteMap<PropTypes>() {
          public PropTypes findValueByNumber(int number) {
            return PropTypes.forNumber(number);
          }
        };
  ...
  private static final PropTypes[] VALUES = values();

  public static PropTypes valueOf(
  ...
  private PropTypes(int value) {
    this.value = value;
  }

  // @@protoc_insertion_point(enum_scope:uns.PropTypes)
}
