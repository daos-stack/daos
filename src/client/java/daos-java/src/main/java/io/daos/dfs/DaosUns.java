...
public class DaosUns {
    ...
    private static void util() {
        ...
        switch (op) {
            case "list-object-types": listObjectTypes(); return;
                ...
                if (p.getEntriesCount() > 0) {
                    for (Entry e : p.getEntriesList()) {
                        ...
                        switch (e.getValueCase()) {
                            case STR: o = e.getStr(); break;
                            case VAL: o = e.getVal(); break;
                            case PVAL: o = e.getPval(); break;
                            default: throw new IllegalArgumentException("unknown value case: " + e.getValueCase());
                        }
