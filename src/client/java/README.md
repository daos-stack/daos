...
The URI is "daos://uns:\<sequence\>/\<your path\>". "\<your path\>" is your OS file path created by DAOS UNS method,
DaosUns.create(). "\<sequence\>" is to identify the unique UNS path in Hadoop. You can create the UNS path with below
command.
