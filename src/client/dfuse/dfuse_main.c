...
show_help(char *name)
{
	printf(
	    ...
	    "By default, the (TODO: clarify total or fuse?) thread count is one per available\n"
	    "core (TODO: hyperthread core or physical core?) to allow maximum throughput.\n"
	    ...
	    "enabled. The caching behavior for a dfuse mount can be controlled by command line.\n"
	    "options. Further caching controls can be set on a per-container basis through container\n"
	    "attributes.\n"
