...
enum dfuse_bypass_status {
	...
	DFUSE_IO_DIS_FLAG,     /* Bypass is disabled for file because O_APPEND or O_PATH was used
				*/
	DFUSE_IO_DIS_FCNTL,  /* Bypass is disabled for file because bypass doesn't support an fcntl
			      */
	DFUSE_IO_DIS_STREAM, /* Bypass is disabled for file opened as a stream.
			      */
