...
{
#define DEFINE_CONT(type, value) \
	PyModule_AddIntConstant(module, type, value)
	DEFINE_CONT("DAOS_PROP_CO_MIN", DAOS_PROP_CO_MIN);
	DEFINE_CONT("DAOS_PROP_CO_LABEL", DAOS_PROP_CO_LABEL);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_VER", DAOS_PROP_CO_LAYOUT_VER);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_TYPE", DAOS_PROP_CO_LAYOUT_TYPE);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_VER", DAOS_PROP_CO_LAYOUT_VER);
	DEFINE_CONT("DAOS_PROP_CO_CSUM", DAOS_PROP_CO_CSUM);
	DEFINE_CONT("DAOS_PROP_CO_CSUM_CHUNK_SIZE", DAOS_PROP_CO_CSUM_CHUNK_SIZE);
	DEFINE_CONT("DAOS_PROP_CO_CSUM_SERVER_VERIFY", DAOS_PROP_CO_CSUM_SERVER_VERIFY);
	DEFINE_CONT("DAOS_PROP_CO_REDUN_FAC", DAOS_PROP_CO_REDUN_FAC);
	DEFINE_CONT("DAOS_PROP_CO_REDUN_LVL", DAOS_PROP_CO_REDUN_LVL);
	DEFINE_CONT("DAOS_PROP_CO_SNAPSHOT_MAX", DAOS_PROP_CO_SNAPSHOT_MAX);
	DEFINE_CONT("DAOS_PROP_CO_ACL", DAOS_PROP_CO_ACL);
	DEFINE_CONT("DAOS_PROP_CO_COMPRESS", DAOS_PROP_CO_COMPRESS);
	DEFINE_CONT("DAOS_PROP_CO_ENCRYPT", DAOS_PROP_CO_ENCRYPT);
	DEFINE_CONT("DAOS_PROP_CO_MAX", DAOS_PROP_CO_MAX);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_UNKOWN", DAOS_PROP_CO_LAYOUT_UNKOWN);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_POSIX", DAOS_PROP_CO_LAYOUT_POSIX);
	DEFINE_CONT("DAOS_PROP_CO_LAYOUT_HDF5", DAOS_PROP_CO_LAYOUT_HDF5);
}
