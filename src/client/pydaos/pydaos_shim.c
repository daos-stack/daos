...
do {				\
	...
	DEFINE_OC_EXPL(EC_S2P1G);	/** OC_EC_2P1G1, OC_EC_2P1G2, ... */
	DEFINE_OC_EXPL(EC_M2P1G);	/** OC_EC_2P1G1, OC_EC_2P1G2, ... */
	DEFINE_OC_EXPL(EC_L2P1G);	/** OC_EC_2P1G1, OC_EC_2P1G2, ... */
	DEFINE_OC_EXPL(EC_S2P2G);	/** OC_EC_2P2G1, OC_EC_2P2G2, ... */
	DEFINE_OC_EXPL(EC_M2P2G);	/** OC_EC_2P2G1, OC_EC_2P2G2, ... */
	DEFINE_OC_EXPL(EC_L2P2G);	/** OC_EC_2P2G1, OC_EC_2P2G2, ... */
	DEFINE_OC_EXPL(EC_S4P1G);	/** OC_EC_4P1G1, OC_EC_4P1G2, ... */
	DEFINE_OC_EXPL(EC_M4P1G);	/** OC_EC_4P1G1, OC_EC_4P1G2, ... */
	DEFINE_OC_EXPL(EC_L4P1G);	/** OC_EC_4P1G1, OC_EC_4P1G2, ... */
	DEFINE_OC_EXPL(EC_S4P2G);	/** OC_EC_4P2G1, OC_EC_4P2G2, ... */
	DEFINE_OC_EXPL(EC_M4P2G);	/** OC_EC_4P2G1, OC_EC_4P2G2, ... */
	DEFINE_OC_EXPL(EC_L4P2G);	/** OC_EC_4P2G1, OC_EC_4P2G2, ... */
	DEFINE_OC_EXPL(EC_S8P1G);	/** OC_EC_8P1G1, OC_EC_8P1G2, ... */
	DEFINE_OC_EXPL(EC_M8P1G);	/** OC_EC_8P1G1, OC_EC_8P1G2, ... */
	DEFINE_OC_EXPL(EC_L8P1G);	/** OC_EC_8P1G1, OC_EC_8P1G2, ... */
	DEFINE_OC_EXPL(EC_S8P2G);	/** OC_EC_8P2G1, OC_EC_8P2G2, ... */
	DEFINE_OC_EXPL(EC_M8P2G);	/** OC_EC_8P2G1, OC_EC_8P2G2, ... */
	DEFINE_OC_EXPL(EC_L8P2G);	/** OC_EC_8P2G1, OC_EC_8P2G2, ... */
	DEFINE_OC_EXPL(EC_S16P1G);	/** OC_EC_16P1G1, OC_EC_16P1G2, ... */
	DEFINE_OC_EXPL(EC_M16P1G);	/** OC_EC_16P1G1, OC_EC_16P1G2, ... */
	DEFINE_OC_EXPL(EC_L16P1G);	/** OC_EC_16P1G1, OC_EC_16P1G2, ... */
	DEFINE_OC_EXPL(EC_S16P2G);	/** OC_EC_16P2G1, OC_EC_16P2G2, ... */
	DEFINE_OC_EXPL(EC_M16P2G);	/** OC_EC_16P2G1, OC_EC_16P2G2, ... */
	DEFINE_OC_EXPL(EC_L16P2G);	/** OC_EC_16P2G1, OC_EC_16P2G2, ... */
