...
export PYTHONPATH="${SL_PREFIX}/lib64/python2.7/site-packages"
export PATH="${PATH}:${SL_PREFIX}/bin"
...
print_header "SCM Estimator: Unit Testing"
...
print_header "SCM Estimator: Smoke Testing"
...
print_header "SCM Estimator: read_yaml"
...
print_header "SCM Estimator: explore_fs"
...
print_header "SCM Estimator: Successful"
