...
{
	struct pool_connect_0_in       *in = crt_req_get(rpc);
	struct pool_connect_1_out      *out = crt_reply_get(rpc);
	struct pool_svc		       *svc;
	struct pool_buf		       *map_buf = NULL;
	uint32_t			map_version;
	uint32_t			connectable;
...
void
ds_pool_connect_handler_0(crt_rpc_t *rpc)
{
	ds_pool_connect_handler(rpc, 0);
}

void
ds_pool_connect_handler_1(crt_rpc_t *rpc)
{
