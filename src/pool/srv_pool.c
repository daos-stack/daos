 ...
 * \param[in]	tgt_ids		target IDs (if empty, must specify tgt_addrs)
 * \param[in]	tgt_addrs	optional target addresses (requires
 *				inval_tgt_addrs)
 ...
 * \param[out]	tgt_map_ver	TODO: definition
 * \param[out]	inval_tgt_addrs	optional invalid target addresses
 */
static int
