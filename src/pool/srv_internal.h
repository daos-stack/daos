...
int ds_pool_tgt_disconnect_aggregator(crt_rpc_t *source, crt_rpc_t *result,
				      void *priv);
void ds_pool_tgt_query_handler_v6(crt_rpc_t *rpc);
void ds_pool_tgt_query_handler(crt_rpc_t *rpc);
int ds_pool_tgt_query_aggregator_v6(crt_rpc_t *source, crt_rpc_t *result, void *priv);
int ds_pool_tgt_query_aggregator(crt_rpc_t *source, crt_rpc_t *result, void *priv);
