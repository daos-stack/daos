...
CRT_RPC_DEFINE(pool_eval_self_heal, DAOS_ISEQ_POOL_EVAL_SELF_HEAL, DAOS_OSEQ_POOL_EVAL_SELF_HEAL)
CRT_RPC_DEFINE(pool_recov_cont, DAOS_ISEQ_POOL_RECOV_CONT, DAOS_OSEQ_POOL_RECOV_CONT)
