...
CRT_RPC_DEFINE(pool_connect_0, DAOS_ISEQ_POOL_CONNECT_0, DAOS_OSEQ_POOL_CONNECT)
CRT_RPC_DEFINE(pool_connect_1, DAOS_ISEQ_POOL_CONNECT_1, DAOS_OSEQ_POOL_CONNECT)
