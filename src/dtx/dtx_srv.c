...
dtx_init(void)
{
	...
	d_getenv_uint(&dtx_agg_thd_cnt_up, "DAOS_DTX_AGG_THD_CNT");
	...
	d_getenv_uint(&dtx_agg_thd_age_up, "DAOS_DTX_AGG_THD_AGE");
	...
	d_getenv_uint(&dtx_batched_ult_max, "DAOS_DTX_BATCHED_ULT_MAX");
