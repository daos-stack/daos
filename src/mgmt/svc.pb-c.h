...
typedef struct _Mgmt__HandleList Mgmt__HandleList;
typedef struct _Mgmt__PoolHandleCleanupReq Mgmt__PoolHandleCleanupReq;
typedef struct _Mgmt__PoolHandleCleanupResp Mgmt__PoolHandleCleanupResp;
...
struct  _Mgmt__HandleList
{
  ProtobufCMessage base;
  /*
   * Pool UUID for the list of handles
   */
  char *pooluuid;
  /*
   * List of handles to free
   */
  size_t n_poolhandles;
  char **poolhandles;
};
#define MGMT__HANDLE_LIST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__handle_list__descriptor) \
    , (char *)protobuf_c_empty_string, 0,NULL }


struct  _Mgmt__PoolHandleCleanupReq
{
  ProtobufCMessage base;
  /*
   * One or more sets of handles to free
   */
  size_t n_handles;
  Mgmt__HandleList **handles;
};
#define MGMT__POOL_HANDLE_CLEANUP_REQ__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__pool_handle_cleanup_req__descriptor) \
    , 0,NULL }


struct  _Mgmt__PoolHandleCleanupResp
{
  ProtobufCMessage base;
  int32_t status;
};
#define MGMT__POOL_HANDLE_CLEANUP_RESP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__pool_handle_cleanup_resp__descriptor) \
    , 0 }
...
void   mgmt__pool_monitor_req__free_unpacked
                     (Mgmt__PoolMonitorReq *message,
                      ProtobufCAllocator *allocator);
/* Mgmt__HandleList methods */
void   mgmt__handle_list__init
                     (Mgmt__HandleList         *message);
size_t mgmt__handle_list__get_packed_size
                     (const Mgmt__HandleList   *message);
size_t mgmt__handle_list__pack
                     (const Mgmt__HandleList   *message,
                      uint8_t             *out);
size_t mgmt__handle_list__pack_to_buffer
                     (const Mgmt__HandleList   *message,
                      ProtobufCBuffer     *buffer);
Mgmt__HandleList *
       mgmt__handle_list__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   mgmt__handle_list__free_unpacked
                     (Mgmt__HandleList *message,
                      ProtobufCAllocator *allocator);
/* Mgmt__PoolHandleCleanupReq methods */
void   mgmt__pool_handle_cleanup_req__init
                     (Mgmt__PoolHandleCleanupReq         *message);
size_t mgmt__pool_handle_cleanup_req__get_packed_size
                     (const Mgmt__PoolHandleCleanupReq   *message);
size_t mgmt__pool_handle_cleanup_req__pack
                     (const Mgmt__PoolHandleCleanupReq   *message,
                      uint8_t             *out);
size_t mgmt__pool_handle_cleanup_req__pack_to_buffer
                     (const Mgmt__PoolHandleCleanupReq   *message,
                      ProtobufCBuffer     *buffer);
Mgmt__PoolHandleCleanupReq *
       mgmt__pool_handle_cleanup_req__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   mgmt__pool_handle_cleanup_req__free_unpacked
                     (Mgmt__PoolHandleCleanupReq *message,
                      ProtobufCAllocator *allocator);
/* Mgmt__PoolHandleCleanupResp methods */
void   mgmt__pool_handle_cleanup_resp__init
                     (Mgmt__PoolHandleCleanupResp         *message);
size_t mgmt__pool_handle_cleanup_resp__get_packed_size
                     (const Mgmt__PoolHandleCleanupResp   *message);
size_t mgmt__pool_handle_cleanup_resp__pack
                     (const Mgmt__PoolHandleCleanupResp   *message,
                      uint8_t             *out);
size_t mgmt__pool_handle_cleanup_resp__pack_to_buffer
                     (const Mgmt__PoolHandleCleanupResp   *message,
                      ProtobufCBuffer     *buffer);
Mgmt__PoolHandleCleanupResp *
       mgmt__pool_handle_cleanup_resp__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data);
void   mgmt__pool_handle_cleanup_resp__free_unpacked
                     (Mgmt__PoolHandleCleanupResp *message,
                      ProtobufCAllocator *allocator);
...
typedef void (*Mgmt__PoolMonitorReq_Closure)
                 (const Mgmt__PoolMonitorReq *message,
                  void *closure_data);
typedef void (*Mgmt__HandleList_Closure)
                 (const Mgmt__HandleList *message,
                  void *closure_data);
typedef void (*Mgmt__PoolHandleCleanupReq_Closure)
                 (const Mgmt__PoolHandleCleanupReq *message,
                  void *closure_data);
typedef void (*Mgmt__PoolHandleCleanupResp_Closure)
                 (const Mgmt__PoolHandleCleanupResp *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor mgmt__handle_list__descriptor;
extern const ProtobufCMessageDescriptor mgmt__pool_handle_cleanup_req__descriptor;
extern const ProtobufCMessageDescriptor mgmt__pool_handle_cleanup_resp__descriptor;
