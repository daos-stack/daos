...
#ifndef PROTOBUF_C_mgmt_2fcheck_2eproto__INCLUDED
#define PROTOBUF_C_mgmt_2fcheck_2eproto__INCLUDED
...
typedef struct Mgmt__CheckEnableReq Mgmt__CheckEnableReq;
typedef struct Mgmt__CheckDisableReq Mgmt__CheckDisableReq;
...
typedef struct Mgmt__CheckGetPolicyResp Mgmt__CheckGetPolicyResp;
 ...
 */
struct  Mgmt__CheckSetPolicyReq
{
  ProtobufCMessage base;
  /*
   * DAOS system identifier.
 ...
 */
struct  Mgmt__CheckGetPolicyReq
{
  ProtobufCMessage base;
  /*
   * DAOS system identifier.
 ...
 */
struct  Mgmt__CheckGetPolicyResp
{
  ProtobufCMessage base;
  /*
   * DAOS error code.
...
#endif  /* PROTOBUF_C_mgmt_2fcheck_2eproto__INCLUDED */
