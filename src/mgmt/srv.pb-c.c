...
{
  static const Mgmt__DaosRequestStatus init_value = MGMT__DAOS_REQUEST_STATUS__INIT;
  *message = init_value;
}
size_t mgmt__daos_request_status__get_packed_size
                     (const Mgmt__DaosRequestStatus *message)
{
  assert(message->base.descriptor == &mgmt__daos_request_status__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
Mgmt__DaosRequestStatus *
       mgmt__daos_request_status__unpack
                     (ProtobufCAllocator  *allocator,
                      ...
                      const uint8_t       *data)
{
  return (Mgmt__DaosRequestStatus *)
     protobuf_c_message_unpack (&mgmt__daos_request_status__descriptor,
                                allocator, len, data);
}
...
static const ProtobufCEnumValue mgmt__daos_request_status__state__enum_values_by_number[6] =
{
  { "ERR_DAOS", "MGMT__DAOS_REQUEST_STATUS__STATE__ERR_DAOS", -5 },
  { "ERR_PROTO", "MGMT__DAOS_REQUEST_STATUS__STATE__ERR_PROTO", -4 },
  { "ERR_INVALID_UUID", "MGMT__DAOS_REQUEST_STATUS__STATE__ERR_INVALID_UUID", -3 },
  { "ERR_INVALID_RANK", "MGMT__DAOS_REQUEST_STATUS__STATE__ERR_INVALID_RANK", -2 },
  { "ERR_UNKNOWN", "MGMT__DAOS_REQUEST_STATUS__STATE__ERR_UNKNOWN", -1 },
  { "SUCCESS", "MGMT__DAOS_REQUEST_STATUS__STATE__SUCCESS", 0 },
};
static const ProtobufCIntRange mgmt__daos_request_status__state__value_ranges[] = {
{-5, 0},{0, 6}
};
static const ProtobufCEnumValueIndex mgmt__daos_request_status__state__enum_values_by_name[6] =
{
  { "ERR_DAOS", 0 },
  { "ERR_INVALID_RANK", 3 },
  { "ERR_INVALID_UUID", 2 },
...
const ProtobufCEnumDescriptor mgmt__daos_request_status__state__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  "mgmt.DaosRequestStatus.State",
  "State",
  "Mgmt__DaosRequestStatus__State",
  "mgmt",
  6,
  mgmt__daos_request_status__state__enum_values_by_number,
  6,
  mgmt__daos_request_status__state__enum_values_by_name,
  1,
  mgmt__daos_request_status__state__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
static const ProtobufCFieldDescriptor mgmt__daos_request_status__field_descriptors[2] =
{
  {
    "state",
    1,
    ...
    0,   /* quantifier_offset */
    offsetof(Mgmt__DaosRequestStatus, state),
    &mgmt__daos_request_status__state__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(Mgmt__DaosRequestStatus, der),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mgmt__daos_request_status__field_indices_by_name[] = {
  1,   /* field[1] = der */
  0,   /* field[0] = state */
};
static const ProtobufCIntRange mgmt__daos_request_status__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor mgmt__daos_request_status__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  ...
  "Mgmt__DaosRequestStatus",
  "mgmt",
  sizeof(Mgmt__DaosRequestStatus),
  2,
  mgmt__daos_request_status__field_descriptors,
  mgmt__daos_request_status__field_indices_by_name,
  1,  mgmt__daos_request_status__number_ranges,
  (ProtobufCMessageInit) mgmt__daos_request_status__init,
  NULL,NULL,NULL    /* reserved[123] */
};
