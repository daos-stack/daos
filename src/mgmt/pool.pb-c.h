...
typedef struct Mgmt__PoolReintReq Mgmt__PoolReintReq;
typedef struct Mgmt__PoolReintResp Mgmt__PoolReintResp;
...
typedef struct Mgmt__PoolQueryTargetReq Mgmt__PoolQueryTargetReq;
typedef struct Mgmt__StorageTargetUsage Mgmt__StorageTargetUsage;
typedef struct Mgmt__PoolQueryTargetInfo Mgmt__PoolQueryTargetInfo;
typedef struct Mgmt__PoolQueryTargetResp Mgmt__PoolQueryTargetResp;
 ...
 */
struct  Mgmt__PoolQueryTargetReq
{
  ProtobufCMessage base;
  /*
   * DAOS system identifier
 ...
 */
struct  Mgmt__StorageTargetUsage
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Mgmt__PoolQueryTargetInfo
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Mgmt__PoolQueryTargetResp
{
  ProtobufCMessage base;
  /*
   * DAOS error code
