...
typedef enum _Mgmt__StorageMediaType {
	...
	MGMT__STORAGE_MEDIA_TYPE__QLC =
	    2 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__STORAGE_MEDIA_TYPE)
...
typedef enum {
	...
	MGMT__POOL_PROPERTY__VALUE_NUMVAL =
	    3 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_PROPERTY__VALUE__CASE)
...
struct Mgmt__StorageTargetUsage {
	...
	uint64_t               free;
	/*
	 * see daos_media_type_t (e.g., SCM, NVME, QLC)
	 */
	Mgmt__StorageMediaType media_type;
};
