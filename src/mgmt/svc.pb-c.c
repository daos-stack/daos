...
static const ProtobufCFieldDescriptor mgmt__join_resp__field_descriptors[8] =
{
  {
    "status",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_STRING,
    offsetof(Mgmt__JoinResp, n_pool_uuids),
    offsetof(Mgmt__JoinResp, pool_uuids),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT64,
    0,   /* quantifier_offset */
    offsetof(Mgmt__JoinResp, data_version),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mgmt__join_resp__field_indices_by_name[] = {
  7,   /* field[7] = data_version */
  3,   /* field[3] = faultDomain */
  4,   /* field[4] = localJoin */
  5,   /* field[5] = map_version */
  6,   /* field[6] = pool_uuids */
  1,   /* field[1] = rank */
  2,   /* field[2] = state */
  0,   /* field[0] = status */
};
...
static const ProtobufCFieldDescriptor mgmt__set_rank_req__field_descriptors[4] =
{
  {
    "rank",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_STRING,
    offsetof(Mgmt__SetRankReq, n_pool_uuids),
    offsetof(Mgmt__SetRankReq, pool_uuids),
    NULL,
    &protobuf_c_empty_string,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT64,
    0,   /* quantifier_offset */
    offsetof(Mgmt__SetRankReq, data_version),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
