...
int ds_mgmt_dev_manage_led(Ctl__VmdLedAction led_action, uuid_t uuid, Ctl__VmdLedState led_state,
...
int ds_mgmt_dev_replace(uuid_t old_uuid, uuid_t new_uuid, Ctl__DevReplaceResp *resp);
