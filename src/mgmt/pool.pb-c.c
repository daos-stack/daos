...
static const ProtobufCFieldDescriptor mgmt__list_pools_resp__pool__field_descriptors[4] =
{
  {
    "uuid",
    1,
...
static const ProtobufCFieldDescriptor mgmt__pool_query_resp__field_descriptors[15] =
{
  {
    "status",
    1,
