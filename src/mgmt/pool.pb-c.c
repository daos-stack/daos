...
void
mgmt__pool_reint_req__init(Mgmt__PoolReintReq *message)
{
	static const Mgmt__PoolReintReq init_value = MGMT__POOL_REINT_REQ__INIT;
	*message                                   = init_value;
}
size_t
mgmt__pool_reint_req__get_packed_size(const Mgmt__PoolReintReq *message)
{
	assert(message->base.descriptor == &mgmt__pool_reint_req__descriptor);
	return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t
mgmt__pool_reint_req__pack(const Mgmt__PoolReintReq *message, uint8_t *out)
{
	assert(message->base.descriptor == &mgmt__pool_reint_req__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t
mgmt__pool_reint_req__pack_to_buffer(const Mgmt__PoolReintReq *message, ProtobufCBuffer *buffer)
{
	assert(message->base.descriptor == &mgmt__pool_reint_req__descriptor);
	return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
}
Mgmt__PoolReintReq *
mgmt__pool_reint_req__unpack(ProtobufCAllocator *allocator, size_t len, const uint8_t *data)
{
	return (Mgmt__PoolReintReq *)protobuf_c_message_unpack(&mgmt__pool_reint_req__descriptor,
							       allocator, len, data);
}
void
mgmt__pool_reint_req__free_unpacked(Mgmt__PoolReintReq *message, ProtobufCAllocator *allocator)
{
  if(!message)
    return;
  assert(message->base.descriptor == &mgmt__pool_reint_req__descriptor);
...
void
mgmt__pool_reint_resp__init(Mgmt__PoolReintResp *message)
{
	static const Mgmt__PoolReintResp init_value = MGMT__POOL_REINT_RESP__INIT;
	*message                                    = init_value;
}
size_t
mgmt__pool_reint_resp__get_packed_size(const Mgmt__PoolReintResp *message)
{
	assert(message->base.descriptor == &mgmt__pool_reint_resp__descriptor);
	return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t
mgmt__pool_reint_resp__pack(const Mgmt__PoolReintResp *message, uint8_t *out)
{
	assert(message->base.descriptor == &mgmt__pool_reint_resp__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t
mgmt__pool_reint_resp__pack_to_buffer(const Mgmt__PoolReintResp *message, ProtobufCBuffer *buffer)
{
	assert(message->base.descriptor == &mgmt__pool_reint_resp__descriptor);
	return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
}
Mgmt__PoolReintResp *
mgmt__pool_reint_resp__unpack(ProtobufCAllocator *allocator, size_t len, const uint8_t *data)
{
	return (Mgmt__PoolReintResp *)protobuf_c_message_unpack(&mgmt__pool_reint_resp__descriptor,
								allocator, len, data);
}
void
mgmt__pool_reint_resp__free_unpacked(Mgmt__PoolReintResp *message, ProtobufCAllocator *allocator)
{
  if(!message)
    return;
  assert(message->base.descriptor == &mgmt__pool_reint_resp__descriptor);
...
static const ProtobufCFieldDescriptor mgmt__pool_exclude_req__field_descriptors[5] = {
	...
	offsetof(Mgmt__PoolExcludeReq, n_ranks), offsetof(Mgmt__PoolExcludeReq, ranks), NULL, NULL,
	0,            /* flags */
	0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
...
static const ProtobufCFieldDescriptor mgmt__pool_drain_req__field_descriptors[5] = {
    ...
    {
	"ranks", 3, PROTOBUF_C_LABEL_REPEATED, PROTOBUF_C_TYPE_UINT32,
	offsetof(Mgmt__PoolDrainReq, n_ranks), offsetof(Mgmt__PoolDrainReq, ranks), NULL, NULL,
	0,            /* flags */
	0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
...
static const ProtobufCFieldDescriptor mgmt__pool_drain_resp__field_descriptors[3] = {
    {
    ...
    {
	"failed_rank", 2, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
	offsetof(Mgmt__PoolDrainResp, failed_rank), NULL, NULL, 0,          /* flags */
	0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
	"drained_ranks", 3, PROTOBUF_C_LABEL_REPEATED, PROTOBUF_C_TYPE_UINT32,
	offsetof(Mgmt__PoolDrainResp, n_drained_ranks),
	offsetof(Mgmt__PoolDrainResp, drained_ranks), NULL, NULL, 0, /* flags */
	0, NULL, NULL                                                /* reserved1,reserved2, etc */
    },
};
static const unsigned mgmt__pool_drain_resp__field_indices_by_name[] = {
    2, /* field[2] = drained_ranks */
    1, /* field[1] = failed_rank */
    0, /* field[0] = status */
};
static const ProtobufCIntRange   mgmt__pool_drain_resp__number_ranges[1 + 1] = {{1, 0}, {0, 3}};
...
static const ProtobufCFieldDescriptor mgmt__pool_reint_req__field_descriptors[7] = {
    ...
    {
	"ranks", 3, PROTOBUF_C_LABEL_REPEATED, PROTOBUF_C_TYPE_UINT32,
	offsetof(Mgmt__PoolReintReq, n_ranks), offsetof(Mgmt__PoolReintReq, ranks), NULL, NULL,
	0,            /* flags */
	0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
...
static const ProtobufCFieldDescriptor mgmt__pool_reint_resp__field_descriptors[3] = {
    {
	"status", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT32, 0, /* quantifier_offset */
    ...
    {
	"failed_rank", 2, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
	offsetof(Mgmt__PoolReintResp, failed_rank), NULL, NULL, 0,          /* flags */
	0, NULL, NULL /* reserved1,reserved2, etc */
    },
    {
	"reinted_ranks", 3, PROTOBUF_C_LABEL_REPEATED, PROTOBUF_C_TYPE_UINT32,
	offsetof(Mgmt__PoolReintResp, n_reinted_ranks),
	offsetof(Mgmt__PoolReintResp, reinted_ranks), NULL, NULL, 0, /* flags */
	0, NULL, NULL                                                /* reserved1,reserved2, etc */
    },
};
static const unsigned mgmt__pool_reint_resp__field_indices_by_name[] = {
    1, /* field[1] = failed_rank */
    2, /* field[2] = reinted_ranks */
    0, /* field[0] = status */
};
static const ProtobufCIntRange   mgmt__pool_reint_resp__number_ranges[1 + 1] = {{1, 0}, {0, 3}};
...
static const ProtobufCFieldDescriptor mgmt__pool_query_resp__field_descriptors[21] = {
    {
	"status", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT32, 0, /* quantifier_offset */
