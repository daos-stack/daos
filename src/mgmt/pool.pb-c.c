...
static const ProtobufCFieldDescriptor mgmt__pool_rebuild_stop_req__field_descriptors[3] = {
    {
	"sys", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_STRING, 0, /* quantifier_offset */
...
static const ProtobufCIntRange mgmt__pool_rebuild_stop_req__number_ranges[1 + 1] = {{1, 0}, {0, 3}};
