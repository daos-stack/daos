...
CRT_GEN_PROC_FUNC(rsvc_hint, DAOS_SEQ_RSVC_HINT);
...
CRT_RPC_DEFINE(mgmt_query, DAOS_ISEQ_MGMT_QUERY, DAOS_OSEQ_MGMT_QUERY)
CRT_RPC_DEFINE(mgmt_query_server, DAOS_ISEQ_MGMT_QUERY_SERVER,
