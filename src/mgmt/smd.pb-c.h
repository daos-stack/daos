...
typedef struct Ctl__SmdDevResp__Device Ctl__SmdDevResp__Device;
...
typedef struct Ctl__DevStateReq Ctl__DevStateReq;
typedef struct Ctl__DevStateResp Ctl__DevStateResp;
typedef struct Ctl__DevReplaceReq Ctl__DevReplaceReq;
typedef struct Ctl__DevReplaceResp Ctl__DevReplaceResp;
typedef struct Ctl__DevIdentifyReq Ctl__DevIdentifyReq;
typedef struct Ctl__DevIdentifyResp Ctl__DevIdentifyResp;
typedef struct Ctl__SmdQueryReq Ctl__SmdQueryReq;
typedef struct Ctl__SmdQueryResp Ctl__SmdQueryResp;
typedef struct Ctl__SmdQueryResp__Device Ctl__SmdQueryResp__Device;
...
struct  Ctl__SmdDevResp__Device
{
  ProtobufCMessage base;
  /*
   * UUID of blobstore
...
struct  Ctl__SmdQueryResp__Device
{
  ProtobufCMessage base;
  /*
   * UUID of blobstore
