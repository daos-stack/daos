 ...
 */
int
daos_pool_connect(const uuid_t uuid, const char *grp, unsigned int flags, daos_handle_t *poh,
 ...
 */
int
daos_pool_connect_by_label(const char *label, const char *grp, unsigned int flags,
