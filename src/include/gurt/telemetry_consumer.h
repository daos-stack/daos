...
typedef void (*d_tm_iter_cb_t)(struct d_tm_context *ctx, struct d_tm_node_t *node,
			       int level, char *path, int format, int opt_fields,
			       void *cb_arg);
...
void d_tm_reset_node(struct d_tm_context *ctx, struct d_tm_node_t *node, int level,
