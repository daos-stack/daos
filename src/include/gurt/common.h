...
#else
#define d_ref_tracker_init(tracker)                                                                \
	do {                                                                                       \
	} while (0)
#define d_ref_tracker_fini(tracker)                                                                \
	do {                                                                                       \
	} while (0)
#define d_ref_tracker_dump(tracker, func, line)                                                    \
	do {                                                                                       \
	} while (0)
#define d_ref_tracker_track(tracker, addr, func, line)                                             \
	do {                                                                                       \
	} while (0)
#define d_ref_tracker_untrack(tracker, addr)                                                       \
	do {                                                                                       \
	} while (0)
#define d_ref_tracker_retrack(tracker, new_addr, old_addr, func, line)                             \
	do {                                                                                       \
	} while (0)
#endif
