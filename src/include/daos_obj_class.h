...
enum daos_obj_redun {
	...
	/** EC 5+1 object classes */
	OC_EC_5P1G1  = OBJ_CLASS_DEF(OR_RS_5P1, 1ULL),
	OC_EC_5P1G2  = OBJ_CLASS_DEF(OR_RS_5P1, 2ULL),
	OC_EC_5P1G4  = OBJ_CLASS_DEF(OR_RS_5P1, 4ULL),
	OC_EC_5P1G6  = OBJ_CLASS_DEF(OR_RS_5P1, 6ULL),
	OC_EC_5P1G8  = OBJ_CLASS_DEF(OR_RS_5P1, 8ULL),
	OC_EC_5P1G12 = OBJ_CLASS_DEF(OR_RS_5P1, 12ULL),
	OC_EC_5P1G16 = OBJ_CLASS_DEF(OR_RS_5P1, 16ULL),
	OC_EC_5P1G32 = OBJ_CLASS_DEF(OR_RS_5P1, 32ULL),
	OC_EC_5P1GX  = OBJ_CLASS_DEF(OR_RS_5P1, MAX_NUM_GROUPS),

	/** EC 5+2 object classes */
	OC_EC_5P2G1  = OBJ_CLASS_DEF(OR_RS_5P2, 1ULL),
	OC_EC_5P2G2  = OBJ_CLASS_DEF(OR_RS_5P2, 2ULL),
	OC_EC_5P2G4  = OBJ_CLASS_DEF(OR_RS_5P2, 4ULL),
	OC_EC_5P2G6  = OBJ_CLASS_DEF(OR_RS_5P2, 6ULL),
	OC_EC_5P2G8  = OBJ_CLASS_DEF(OR_RS_5P2, 8ULL),
	OC_EC_5P2G12 = OBJ_CLASS_DEF(OR_RS_5P2, 12ULL),
	OC_EC_5P2G16 = OBJ_CLASS_DEF(OR_RS_5P2, 16ULL),
	OC_EC_5P2G32 = OBJ_CLASS_DEF(OR_RS_5P2, 32ULL),
	OC_EC_5P2GX  = OBJ_CLASS_DEF(OR_RS_5P2, MAX_NUM_GROUPS),
