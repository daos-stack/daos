...
enum {
	 ...
	 * - the first letter after OC_EC_: S - 16k, M - 64k, L - 512k
	 ...
	 *
	 * Examples:
	 * - 2P1G1S: 2+1 EC object with one redundancy group
	 * - 4P2G8S: 4+2 EC object with 8 redundancy groups
	 * - 8P2G2S: 8+2 EC object with 2 redundancy groups
	 * - 16P2GXS: 16+2 EC object spreads across all targets within the pool
	 */

	/** EC 2+1, small cell size, object classes */
	OC_EC_S2P1G1    = 280,
	OC_EC_S2P1G2,
	OC_EC_S2P1G4,
	OC_EC_S2P1G8,
	...
	/** EC 2+1, medium cell size, object classes */
	OC_EC_M2P1G1    = 300,
	OC_EC_M2P1G2,
	OC_EC_M2P1G4,
	OC_EC_M2P1G8,
	...
	/** EC 2+1, large cell size, object classes */
	OC_EC_L2P1G1    = 320,
	OC_EC_L2P1G2,
	OC_EC_L2P1G4,
	OC_EC_L2P1G8,
	...
	/** EC 2+2, small cell size, object classes */
	OC_EC_S2P2G1    = 340,
	OC_EC_S2P2G2,
	OC_EC_S2P2G4,
	OC_EC_S2P2G8,
	...
	/** EC 2+2, medium cell size, object classes */
	OC_EC_M2P2G1    = 360,
	OC_EC_M2P2G2,
	OC_EC_M2P2G4,
	OC_EC_M2P2G8,
	...
	/** EC 2+2, large cell size, object classes */
	OC_EC_L2P2G1    = 380,
	OC_EC_L2P2G2,
	OC_EC_L2P2G4,
	OC_EC_L2P2G8,
	...
	/** EC 4+1, small cell size, object classes */
	OC_EC_S4P1G1    = 400,
	OC_EC_S4P1G2,
	OC_EC_S4P1G4,
	OC_EC_S4P1G8,
	...
	/** EC 4+1, medium cell size, object classes */
	OC_EC_M4P1G1    = 420,
	OC_EC_M4P1G2,
	OC_EC_M4P1G4,
	OC_EC_M4P1G8,
	...
	/** EC 4+1, large cell size, object classes */
	OC_EC_L4P1G1    = 440,
	OC_EC_L4P1G2,
	OC_EC_L4P1G4,
	OC_EC_L4P1G8,
	...
	/** EC 4+2, small cell size, object classes */
	OC_EC_S4P2G1    = 460,
	OC_EC_S4P2G2,
	OC_EC_S4P2G4,
	OC_EC_S4P2G8,
	...
	/** EC 4+2, medium cell size, object classes */
	OC_EC_M4P2G1    = 480,
	OC_EC_M4P2G2,
	OC_EC_M4P2G4,
	OC_EC_M4P2G8,
	...
	/** EC 4+2, large cell_size, object classes */
	OC_EC_L4P2G1    = 500,
	OC_EC_L4P2G2,
	OC_EC_L4P2G4,
	OC_EC_L4P2G8,
	...
	/** EC 8+1, small cell size, object classes */
	OC_EC_S8P1G1    = 520,
	OC_EC_S8P1G2,
	OC_EC_S8P1G4,
	OC_EC_S8P1G8,
	...
	/** EC 8+1, medium cell size, object classes */
	OC_EC_M8P1G1    = 540,
	OC_EC_M8P1G2,
	OC_EC_M8P1G4,
	OC_EC_M8P1G8,
	...
	/** EC 8+1, large cell size, object classes */
	OC_EC_L8P1G1    = 560,
	OC_EC_L8P1G2,
	OC_EC_L8P1G4,
	OC_EC_L8P1G8,
	...
	/** EC 8+2, small cell size, object classes */
	OC_EC_S8P2G1    = 580,
	OC_EC_S8P2G2,
	OC_EC_S8P2G4,
	OC_EC_S8P2G8,
	...
	/** EC 8+2, medium cell size, object classes */
	OC_EC_M8P2G1    = 600,
	OC_EC_M8P2G2,
	OC_EC_M8P2G4,
	OC_EC_M8P2G8,
	...
	/** EC 8+2, large cell size, object classes */
	OC_EC_L8P2G1    = 620,
	OC_EC_L8P2G2,
	OC_EC_L8P2G4,
	OC_EC_L8P2G8,
	...
	/** EC 16+1, small cell size, object classes */
	OC_EC_S16P1G1    = 640,
	OC_EC_S16P1G2,
	OC_EC_S16P1G4,
	OC_EC_S16P1G8,
	...
	/** EC 16+1, medium cell size, object classes */
	OC_EC_M16P1G1    = 660,
	OC_EC_M16P1G2,
	OC_EC_M16P1G4,
	OC_EC_M16P1G8,
	...
	/** EC 16+1, large cell size, object classes */
	OC_EC_L16P1G1    = 680,
	OC_EC_L16P1G2,
	OC_EC_L16P1G4,
	OC_EC_L16P1G8,
	...
	/** EC 16+2, small cell size, object classes */
	OC_EC_S16P2G1    = 700,
	OC_EC_S16P2G2,
	OC_EC_S16P2G4,
	OC_EC_S16P2G8,
...
struct daos_oclass_attr {
	...
	union {
		...
		struct daos_ec_attr {
			...
			unsigned short	 e_p;
			/** exponent for the (approximate) power of 2 length
			 *  of each block of data (cell) */
			unsigned int	 e_cs;
		} ec;
	} u;
