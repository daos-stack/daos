 ...
 * \param[in]	add_md	indicate whether the user would maintain the array
 *			metadata, or the metadata should be stored in the obj.
 * \param[in]	args	Reserved.
 */
static inline int
daos_array_generate_id(daos_obj_id_t *oid, daos_oclass_id_t cid, bool add_md,
		       uint32_t args)
{
