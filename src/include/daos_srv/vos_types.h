...
enum {
	...
	VOS_OF_USE_TIMESTAMPS	= (1 << 8),
	/** replay punch (underwrite) */
	VOS_OF_REPLAY_PC	= (1 << 9),
};
...
/** Mask for any conditionals passed to to the punch */
#define VOS_COND_PUNCH_MASK	\
	(VOS_OF_COND_AKEY_PUNCH | VOS_OF_COND_DKEY_PUNCH)

/** Make for all dkey conditionals */
#define VOS_COND_DKEY_MASK	\
	(VOS_COND_DKEY_UPDATE_MASK | VOS_OF_COND_DKEY_PUNCH |	\
	 VOS_OF_COND_DKEY_FETCH)

/** Make for all akey conditionals */
#define VOS_COND_AKEY_MASK	\
	(VOS_COND_AKEY_UPDATE_MASK | VOS_OF_COND_AKEY_PUNCH |	\
	 VOS_OF_COND_AKEY_FETCH)
