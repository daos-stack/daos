...
void
ds_rebuild_leader_stop(const uuid_t pool_uuid, unsigned int version, uint32_t rebuild_gen);
void
ds_rebuild_abort(uuid_t pool_uuid, unsigned int version, uint32_t rebuild_gen);
#endif
