 ...
 *
 * \return		DTX_ACT_COMMIT_SYNC if current DTX should be committed.
 * \return		DTX_ACT_COMMIT_ASYNC if need to commit some old DTXs.
 * \return		DTX_ACT_AGGREGATE if need to aggregate some old DTXs.
