...
#define DAOS_OIT_DKEY_SET(dkey_ptr, bid_ptr) (d_iov_set((dkey_ptr), (bid_ptr), sizeof(*(bid_ptr))))
#define DAOS_OIT_AKEY_SET(akey_ptr, oid_ptr) (d_iov_set((akey_ptr), (oid_ptr), sizeof(*(oid_ptr))))
