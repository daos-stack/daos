...
#define DAOS_FILTER_FUNC_NE		2
#define DAOS_FILTER_FUNC_LT		3
#define DAOS_FILTER_FUNC_LE		4
#define DAOS_FILTER_FUNC_GE		5
#define DAOS_FILTER_FUNC_GT		6
#define DAOS_FILTER_FUNC_LIKE		7
#define DAOS_FILTER_FUNC_ISNULL		8
#define DAOS_FILTER_FUNC_ISNOTNULL	9
#define DAOS_FILTER_FUNC_AND		10
#define DAOS_FILTER_FUNC_OR		11
