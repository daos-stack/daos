...
#define D_FOREACH_DAOS_ERR(ACTION)                                                                 \
	...
	ACTION(DER_SHARDS_OVERLAP, (DER_ERR_DAOS_BASE + 30), Shards overlap)                       \
...
#define D_DEFINE_RANGE_ERRSTR(name)                                                                \
	...
	static const char *const g_##name##_strerror[] = {D_FOREACH_##name##_ERR(D_DEFINE_ERRDESC)};
...
#define D_REGISTER_RANGE(name)                                                                     \
	d_errno_register_range(DER_ERR_##name##_BASE, DER_ERR_##name##_LIMIT,                      \
			       g_##name##_error_strings, g_##name##_strerror)
