 ...
 *
 * \param[in,out]	cntrs	Pointer to structure to be populated based on the type.
 * 				For max compatibility, the structure pointed to by cntrs should be
 * 				allocated using	daos_metrics_alloc_cntrsbuf().
 *
 * \return   		0	If metrics is enabled on client, 1 if metrics is disabled, -ve on failure.
 */
int
 ...
 *
 * \param[in]		cntrs	metrics pointer passed to the function daos_metrics_alloc_cntrsbuf().
 *
 * \return   		0	success, -ve on failure.
 */
int
 ...
 *
 * \param[in,out]	stats	Pointer to structure to be populated based on the type.
 ...
 *
 * \param[in]		stats	metrics pointer passed to the function daos_metrics_alloc_statsbuf().
 *
 * \return   		0	success, -ve on failure.
 */
int
 ...
 *
 * \param[in,out]	dist	Pointer to structure to be populated based on the type.
 * 				For max compatibility, the structure pointed to by dist should be
