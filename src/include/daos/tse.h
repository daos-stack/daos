 ...
 * task is reinitialized in one of its completion CBs, that callback and the
 * ones that have already executed will have been removed from the cb list and
 * will need to be re-registered by the user after re-insertion.
 *
