...
#define DAOS_FAIL_POOL_CREATE_VERSION	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x9c)
#define DAOS_FORCE_OBJ_UPGRADE		(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x9d)
#define DAOS_FAIL_MIGRATE_FAILURE	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x9e)
