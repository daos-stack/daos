...
#define DAOS_RDB_FAIL_MODIFY_REPLICAS     (DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x1c)
...
#define DLCK_DECOMMISSIONED_00             (DAOS_FAIL_SYS_TEST_GROUP_LOC | 0x100)
...
#define DLCK_FAULT_TLS_INIT                (DAOS_FAIL_SYS_TEST_GROUP_LOC | 0x10b)
#define DLCK_FAULT_BIO_XSCTXT_ALLOC        (DAOS_FAIL_SYS_TEST_GROUP_LOC | 0x10c)
#define DLCK_FAULT_ABT_EVENTUAL_CREATE     (DAOS_FAIL_SYS_TEST_GROUP_LOC | 0x10d)
#define DLCK_FAULT_ULT_CREATE              (DAOS_FAIL_SYS_TEST_GROUP_LOC | 0x10e)
