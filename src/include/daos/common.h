...
#define DF_RECX			"["DF_U64"-"DF_U64", "DF_U64"]"
#define DP_RECX(r)		(r).rx_idx, ((r).rx_idx + (r).rx_nr - 1), ((r).rx_nr)


#define DF_IOV		"<%p,"DF_U64"/"DF_U64">"
#define DP_IOV(iov)	(iov)->iov_buf, (iov)->iov_len, (iov)->iov_buf_len
