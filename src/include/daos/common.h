...
#define DAOS_CHECKSUM_UPDATE_AKEY_FAIL	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x22)
#define DAOS_CHECKSUM_FETCH_AKEY_FAIL	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x23)
#define DAOS_CHECKSUM_UPDATE_DKEY_FAIL	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x24)
#define DAOS_CHECKSUM_FETCH_DKEY_FAIL	(DAOS_FAIL_UNIT_TEST_GROUP_LOC | 0x25)
