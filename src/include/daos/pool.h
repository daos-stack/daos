...
#define DAOS_PO_QUERY_PROP_SCRUB_MODE	(1ULL << 25)
#define DAOS_PO_QUERY_PROP_SCRUB_FREQ	(1ULL << 26)
#define DAOS_PO_QUERY_PROP_SCRUB_RATE	(1ULL << 27)
...
#define DAOS_PO_QUERY_PROP_ALL						\
	(DAOS_PO_QUERY_PROP_LABEL | DAOS_PO_QUERY_PROP_SPACE_RB |	\
	 ...
	 DAOS_PO_QUERY_PROP_EC_CELL_SZ | DAOS_PO_QUERY_PROP_SCRUB_MODE | \
	 DAOS_PO_QUERY_PROP_SCRUB_FREQ | DAOS_PO_QUERY_PROP_SCRUB_RATE |  \
