...
#define DAOS_PO_QUERY_PROP_SVC_REDUN_FAC	(1ULL << (PROP_BIT_START + 15))
#define DAOS_PO_QUERY_PROP_BIT_END		31
...
#define DAOS_PO_QUERY_PROP_ALL									\
	(DAOS_PO_QUERY_PROP_LABEL | DAOS_PO_QUERY_PROP_SPACE_RB |				\
	 ...
	 DAOS_PO_QUERY_PROP_UPGRADE_STATUS | DAOS_PO_QUERY_PROP_SVC_REDUN_FAC)
