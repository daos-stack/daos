...
#ifndef __DAOS_SECURITY_CLI_SECURITY_H__
#define __DAOS_SECURITY_CLI_SECURITY_H__
 ...
 */
int dc_security_request_creds(daos_iov_t *creds);

#endif /* __DAOS_SECURITY_CLI_SECURITY_H__ */
