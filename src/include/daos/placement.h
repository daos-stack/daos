...
void pl_map_attr_init(const struct pool_map *po_map, pl_map_type_t type,
		      struct pl_map_init_attr *mia);
int pl_map_create_inited(struct pool_map *pool_map,
			 struct pl_map_init_attr *mia, struct pl_map **pl_mapp);
