...
class EnvironmentalVariable():
    """Defines an environmental variable name, value and the ability to override."""

    def __init__(self, name, value, override=False):
        """Initialize a EnvironmentalVariable object.

        Args:
            name (str): the environmental variable name
            value (str): the environmental variable value
            override (bool, optional): whether or not the environmental variable value can be
    ...
    def __str__(self):
        """Get a string representing this RequiredEnvironmentalVariable object.

        Returns:
            str: the environmental variable name and value
        """
    ...
    @property
    def name(self):
        """Get the environmental variable name.

        Returns:
            str: the environmental variable name
        """
        return self._name
    ...
    def value(self):
        ...
        Returns:
            str: the environmental variable value
        """
        return self._value

    def update(self, value):
        """Update the environmental variable value if allowed.

        Args:
            value (str): the new environmental variable value
        """
        if self._override:
            self._value = str(value)
