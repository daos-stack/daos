...
class TestWithoutServers(Test):
    ...
    def setUp(self):
        ...
        load_mpi('mpich')
        self.orterun = find_executable('mpirun')
        if self.orterun is None:
            self.fail("Could not find mpirun")
...
class TestWithServers(TestWithoutServers):
    ...
    def setUp(self):
        ...
        self.manager_class = self.params.get("manager_class", "/", "Mpirun")
        ...
        self.stop_leftover_processes(["mpirun"], hosts)
