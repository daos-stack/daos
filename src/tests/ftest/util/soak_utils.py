    ...
    for cmd, log_name in commands:
        ...
        with open(scriptfile, 'w') as script_file:
            ...
            if self.job_scheduler == "slurm":
                ...
                script_file.write("export MPIR_CVAR_BCAST_POSIX_INTRA_ALGORITHM=release_gather \n")
                script_file.write("export MPIR_CVAR_ALLREDUCE_POSIX_INTRA_ALGORITHM=release_gather \n")
                script_file.write("export MPIR_CVAR_BARRIER_POSIX_INTRA_ALGORITHM=release_gather \n")
