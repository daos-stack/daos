...
class TelemetryUtils():
    ...
    ENGINE_NET_METRICS = [
        ...
        "engine_net_cm_uri_lookup_timedout",
        "engine_net_cm_failed_addr",
        "engine_net_cm_net_glitches",
        *_gen_stats_metrics("engine_net_cm_swim_delay"),
        "engine_net_cm_rpc_waitq_depth",
        "engine_net_cm_rpc_quota_exceeded",
        "engine_net_cm_rpcs_recv",
        "engine_net_cm_rpcs_fwd",
        "engine_net_cm_rpcs_replied",
        "engine_net_cm_rpcs_reply_failed",
        "engine_net_cm_rpcs_sent",
        "engine_net_cm_rpcs_completed",
        "engine_net_cm_rpcs_completed_err",
        "engine_net_cm_rpcs_timedout",
        "engine_net_cm_rpcs_double_complete",
        "engine_net_cm_bulk_create",
        "engine_net_cm_bulk_create_failed",
        "engine_net_cm_bulk_bound",
        "engine_net_cm_bulk_free",
        "engine_net_cm_corpcs_created",
        "engine_net_cm_corpcs_completed",
        "engine_net_cm_corpcs_completed_err"]
    ENGINE_RANK_METRICS = [
        "engine_rank"]
