...
class ContRedundancyFactor(RebuildTestBase):
    ...
    def create_test_container_and_write_obj(self, container, negative_test=False):
    ...
    def execute_cont_rf_test(self, create_container=True, mode=None):
        ...
        if cont_rf < oclass_rf:
            negative_test = False
        # Create a container and write objects
        self.create_test_container_and_write_obj(container, negative_test)
