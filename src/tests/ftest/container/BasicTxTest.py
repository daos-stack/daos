...
class BasicTxTest(Test):
    ...
    def setUp(self):
        ...
        with open('../../../.build_vars.json') as path_file:
            build_paths = json.load(path_file)
        ...
        # figure out which hosts are used to run the test
    ...
    def test_tx_basics(self):
        ...
        try:
            ...
            oid, transaction = container.write_an_obj(thedata, thedatasize,
                                                      dkey, akey, None,
                                                      None, 2)
            ...
            oid, transaction2 = container.write_an_obj(thedata3, thedatasize2,
                                                       dkey, akey, oid,
                                                       None, 2)
