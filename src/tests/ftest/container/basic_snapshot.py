...
class BasicSnapshot(TestWithServers):
    ...
    def test_basic_snapshot(self):
        ...
        try:
            self.log.info("Committing 500 additional transactions to the same KV")
        ...
        # List the snapshot
        try:
            reported_epoch = snapshot.list(container.container.coh)
        except DaosApiError as error:
        ...
        self.log.info("After 500 additional commits the snapshot is still available")
