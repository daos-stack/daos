...
class CartSelfTest(TestWithServers):
    ...
    def setUp(self):
        ...
        self.cart_env["D_PROVIDER"] = self.server_managers[0].get_config_value("provider")
        self.cart_env["D_INTERFACE"] = self.server_managers[0].get_config_value("fabric_iface")
