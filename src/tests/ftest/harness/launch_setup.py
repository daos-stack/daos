...
class HarnessLaunchSetupTest(TestWithoutServers):
    ...
    def test_harness_launch_setup_users(self):
        ...
        for user_group in expected_users:
            ...
            gids = get_group_id(hostlist_clients, group).keys()
            ...
            groups = get_user_groups(hostlist_clients, user)
            ...
            user_result_self = run_remote(hostlist_clients, command_as_user('id', user))
