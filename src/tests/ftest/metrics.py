...
def filelist(directory):
    ...
    This is meant to deal primarily with the structure of tests in the daos repo
    and would need to be changed to deal with random directory trees of tests.
...
def yamlforpy(path):
    ...
    Args:
        path (str): full path of the python test script

    Returns:
        str: full path of the yaml file associated with the python test
