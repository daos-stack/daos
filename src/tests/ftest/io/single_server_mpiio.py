...
class IorSingleServerMpiio(IorTestBase):
    """Test class Description: Runs IOR with 1 server with MPIIO.
    ...
    def test_ssf(self):
        ...
        :avocado: tags=all,singleservermpiio,ior_ssf,singleservermpiio_ssf
        """
    ...
    def test_fpp(self):
        ...
        :avocado: tags=all,singleservermpiio,ior_fpp,singleservermpiio_fpp
        """
