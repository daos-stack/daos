...
class DaosCoreTestRebuild(DaosCoreBase):
    ...
    def test_rebuild_0to10(self):
        ...
        :avocado: tags=cb,medium,stage_daos_test_rebuild
    ...
    def test_rebuild_12to15(self):
        ...
        :avocado: tags=all,pr,daily_regression
        :avocado: tags=cb,2,medium,stage_daos_test_rebuild
        :avocado: tags=unittest,rebuild
    ...
    def test_rebuild_35(self):
        """Jira ID: DAOS-16027

        Test Description:
            Run daos_test -r -s5 -u subtests=35
