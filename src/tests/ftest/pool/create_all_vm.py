...
class PoolCreateAllVmTests(PoolTestBase):
    ...
    def test_recycle_pools(self):
        ...
        :avocado: tags=vm
        :avocado: tags=pool,pool_create_all
        :avocado: tagspool_create_all_recycle_vm
        """
    ...
    def test_two_pools(self):
        ...
        self.assertLessEqual(abs(self.scm_avail_bytes - 2 * tier_bytes[0][0]), self.delta_bytes,
                ...
                f"delta={self.delta_bytes}")
        self.assertEqual(0, tier_bytes[0][1], f"Invalid SMD size: want={0}, got={tier_bytes[0][1]}")
        ...
        self.assertLessEqual(abs(self.scm_avail_bytes - tier_bytes[1][0]), self.delta_bytes,
                ...
                f"delta={self.delta_bytes}")
        self.assertEqual(0, tier_bytes[1][1], f"Invalid SMD size: want={0}, got={tier_bytes[1][1]}")
