...
class RebuildTests(Test):
    ...
    def test_simple_rebuild(self):
        ...
        try:
            ...
            saved_data = []
            for _i in range(0, objcount):
                obj = None
                for _j in range(0, reccount):
                    ...
                    obj, txn = container.write_an_obj(data, len(data),
                                                      dkey, akey, obj, rank)
        ...
        try:
            ...
            for _i in range(0, objcount):
                ...
                for _j in range(0, reccount):
                    ...
                    obj, txn = container1.write_an_obj(data, len(data),
                                                       dkey, akey, obj, rank)
                    obj, txn = container2.write_an_obj(data, len(data),
                                                       dkey, akey, obj, rank)
