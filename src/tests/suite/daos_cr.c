...
cr_repair_forall(void **state)
{
	...
	print_message("CR4: check repair option - for-all\n");

	/* Temporary disable it for DAOS-13975. */
	skip();
...
cr_stop_leader_interaction(void **state)
{
	...
	print_message("CR5: stop checker with pending check leader interaction\n");
...
cr_stop_engine_interaction(void **state)
{
	...
	print_message("CR6: stop checker with pending check engine interaction\n");
...
cr_stop_specified(void **state)
{
	...
	print_message("CR7: stop checker for specified pools\n");
...
cr_auto_reset(void **state)
{
	...
	print_message("CR8: reset checker automatically if former instance completed\n");
...
{
	print_message("CR9: checker shutdown\n");
...
cr_crash(void **state)
{
	print_message("CR10: checker crash\n");
...
cr_leader_resume(void **state)
{
	...
	print_message("CR11: check leader resume from former stop/paused phase\n");
...
cr_engine_resume(void **state)
{
	...
	print_message("CR12: check engine resume from former stop/paused phase\n");
...
cr_reset_specified(void **state)
{
	...
	print_message("CR13: reset checker for specified pools\n");
...
cr_failout(void **state)
{
	...
	print_message("CR14: check start option - failout\n");
 ...
 * 5. Query checker, instance should completed, inconsistent container label should be "ignored".
...
cr_auto_repair(void **state)
{
	...
	print_message("CR15: check start option - auto repair\n");
...
cr_orphan_pool(void **state)
{
	...
	print_message("CR16: check start option - scan orphan pools by force\n");
...
{
	print_message("CR17: PS leader fails to sync pool status with check leader\n");
...
{
	print_message("CR18: PS leader fails to sync pool status with check engines\n");
...
cr_engine_death(void **state)
{
	...
	print_message("CR19: check engine death during check\n");
...
cr_engine_rejoin_succ(void **state)
{
	...
	print_message("CR20: check engine rejoins check instance successfully\n");
...
cr_engine_rejoin_fail(void **state)
{
	...
	print_message("CR21: check engine fails to rejoin check instance\n");
...
cr_multiple_pools(void **state)
{
	...
	print_message("CR22: control multiple pools check start/stop sequence\n");
...
cr_fail_sync_orphan(void **state)
{
	...
	print_message("CR23: check leader failed to notify check engine about orphan process\n");
...
static const struct CMUnitTest cr_tests[] = {
	...
	{ "CR4: check repair option - for-all",
	  cr_repair_forall, async_disable, test_case_teardown},
	{ "CR5: stop checker with pending check leader interaction",
	  cr_stop_leader_interaction, async_disable, test_case_teardown},
	{ "CR6: stop checker with pending check engine interaction",
	  cr_stop_engine_interaction, async_disable, test_case_teardown},
	{ "CR7: stop checker for specified pools",
	  cr_stop_specified, async_disable, test_case_teardown},
	{ "CR8: reset checker automatically if former instance completed",
	  cr_auto_reset, async_disable, test_case_teardown},
	{ "CR9: checker shutdown",
	  cr_shutdown, async_disable, test_case_teardown},
	{ "CR10: checker crash",
	  cr_crash, async_disable, test_case_teardown},
	{ "CR11: check leader resume from former stop/paused phase",
	  cr_leader_resume, async_disable, test_case_teardown},
	{ "CR12: check engine resume from former stop/paused phase",
	  cr_engine_resume, async_disable, test_case_teardown},
	{ "CR13: reset checker for specified pools",
	  cr_reset_specified, async_disable, test_case_teardown},
	{ "CR14: check start option - failout",
	  cr_failout, async_disable, test_case_teardown},
	{ "CR15: check start option - auto repair",
	  cr_auto_repair, async_disable, test_case_teardown},
	{ "CR16: check start option - scan orphan pools by force",
	  cr_orphan_pool, async_disable, test_case_teardown},
	{ "CR17: PS leader fails to sync pool status with check leader",
	  cr_fail_sync_leader, async_disable, test_case_teardown},
	{ "CR18: PS leader fails to sync pool status with check engines",
	  cr_fail_sync_engine, async_disable, test_case_teardown},
	{ "CR19: check engine death during check",
	  cr_engine_death, async_disable, test_case_teardown},
	{ "CR20: check engine rejoins check instance successfully",
	  cr_engine_rejoin_succ, async_disable, test_case_teardown},
	{ "CR21: check engine fails to rejoin check instance",
	  cr_engine_rejoin_fail, async_disable, test_case_teardown},
	{ "CR22: control multiple pools check start/stop sequence",
	  cr_multiple_pools, async_disable, test_case_teardown},
	{ "CR23: check leader failed to notify check engine about orphan process",
