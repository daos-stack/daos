...
static const struct CMUnitTest extend_tests[] = {
    {.name          = "EXTEND1: extend small rec multiple dkeys",
     .test_func     = extend_dkeys,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND2: extend small rec multiple akeys",
     .test_func     = extend_akeys,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND3: extend small rec multiple indexes",
     .test_func     = extend_indexes,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND4: extend large rec single index",
     .test_func     = extend_large_rec,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND5: extend multiple objects",
     .test_func     = extend_objects,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND6: punch object during extend and kill",
     .test_func     = dfs_extend_punch_kill,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND7: punch object during extend and extend",
     .test_func     = dfs_extend_punch_extend,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND8: stat object during extend and kill",
     .test_func     = dfs_extend_stat_kill,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND9: stat object during extend and extend",
     .test_func     = dfs_extend_stat_extend,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND10: enumerate object during extend and kill",
     .test_func     = dfs_extend_enumerate_kill,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND11: enumerate object during extend and extend",
     .test_func     = dfs_extend_enumerate_extend,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND12: read object during extend and kill",
     .test_func     = dfs_extend_fetch_kill,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND13: read object during extend and extend",
     .test_func     = dfs_extend_fetch_extend,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND14: write object during extend and kill",
     .test_func     = dfs_extend_write_kill,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND15: write object during extend and extend",
     .test_func     = dfs_extend_write_extend,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
    {.name          = "EXTEND16: extend fail then retry",
     .test_func     = dfs_extend_fail_retry,
     .setup_func    = extend_small_sub_setup,
     .teardown_func = test_teardown},
};
