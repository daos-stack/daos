...
static const struct CMUnitTest extend_tests[] = {
	{"EXTEND1: extend small rec multiple dkeys",
	 extend_dkeys, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND2: extend small rec multiple akeys",
	 extend_akeys, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND3: extend small rec multiple indexes",
	 extend_indexes, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND4: extend large rec single index",
	 extend_large_rec, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND5: extend multiple objects",
	 extend_objects, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND6: punch object during extend and kill",
	 dfs_extend_punch_kill, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND7: punch object during extend and extend",
	 dfs_extend_punch_extend, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND8: stat object during extend and kill",
	 dfs_extend_stat_kill, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND9: stat object during extend and extend",
	 dfs_extend_stat_extend, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND10: enumerate object during extend and kill",
	 dfs_extend_enumerate_kill, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND11: enumerate object during extend and extend",
	 dfs_extend_enumerate_extend, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND12: read object during extend and kill",
	 dfs_extend_fetch_kill, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND13: read object during extend and extend",
	 dfs_extend_fetch_extend, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND14: write object during extend and kill",
	 dfs_extend_write_kill, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND15: write object during extend and extend",
	 dfs_extend_write_extend, rebuild_sub_3nodes_setup, test_teardown},
	{"EXTEND16: extend fail then retry",
	 dfs_extend_fail_retry, rebuild_sub_3nodes_setup, test_teardown},
};
