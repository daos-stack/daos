...
int create_ping_task(tse_sched_t *sched, daos_handle_t pool_hdl, struct dc_object *obj, struct obj_auxi_args *obj_auxi, tse_task_t **task) {
	struct dc_pool *pool;
	tse_task_t *t;
	int rc;
...
int
obj_tgt_ping_task(tse_sched_t *sched, struct dc_object *obj, struct obj_auxi_args *obj_auxi, tse_task_t **taskp)
{
	tse_task_t		*task;
	struct dc_pool *pool;
	daos_handle_t			ph;
