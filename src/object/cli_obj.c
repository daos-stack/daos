...
dc_obj_metrics_get_rpccntrs(daos_metrics_obj_rpc_cntrs_t *cntrs)
{
	...
	dc_metrics_cntr_copy(&cntrs->orc_dkey_enum_cnt,  &obj_rpc_cntrs[DAOS_OBJ_DKEY_RPC_ENUMERATE]);
	dc_metrics_cntr_copy(&cntrs->orc_akey_enum_cnt,  &obj_rpc_cntrs[DAOS_OBJ_AKEY_RPC_ENUMERATE]);
	dc_metrics_cntr_copy(&cntrs->orc_recx_enum_cnt,  &obj_rpc_cntrs[DAOS_OBJ_RECX_RPC_ENUMERATE]);
