...
struct obj_pool_metrics {
	...
	/** Total number of silently restarted fetch (type = counter) */
	struct d_tm_node_t	*opm_fetch_restart;
	/** Total number of resent fetch operations (type = counter) */
	struct d_tm_node_t	*opm_fetch_resent;
};
