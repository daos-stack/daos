...
An object can be chunked into multiple redundancy groups, which are spread
...
In a future release, it can be set to other domain like "node" or "rack".
...
is immutable which means that even if the pool size horizontally grows by
