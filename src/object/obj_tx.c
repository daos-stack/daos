...
dc_tx_commit_cb(tse_task_t *task, void *data)
{
	...
	if (rc == -DER_RECONNECT) {
		...
		ping_task_rc = obj_create_ping_task(sched, ph, &tgt_list_head, &task);
		if (ping_task_rc != 0) {
		...
		// 		ping_task_rc =
		// 		    obj_create_ping_task(sched, ph, &tgt_list_head, &task);
		// 		if (ping_task_rc != 0) {
		...
		// 		// if (task != NULL) {
		// 		// 	D_INFO("Adding %p as dependency on %p", task,
		// 		// 	       task);
		// 		// 	ping_task_rc = dc_task_depend(task, 1, &task);
		// 		// 	if (ping_task_rc != 0) {
		// 		// 		D_ERROR("Failed to add dependency on ping task "
		// 		// 			"(%p)\n",
		// 		// 			task);
		...
		// 		// 	ping_task_rc = tse_task_schedule(task, false);
		// 		// 	if (ping_task_rc != 0) {
		// 		// 		D_ERROR("Failed to schedule ping task %p: %d, %d\n",
		// 		// 			task, ping_task_rc, rc);
		// 		// 		tx->tx_status = TX_ABORTED;
		// 		// 	}
		// 		// }
		// 	}
