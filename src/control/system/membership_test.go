...
func TestSystem_Membership_AddRemove(t *testing.T) {
	...
	dupeRankMember.UUID = uuid.MustParse(test.MockUUID(2))
...
func TestSystem_Membership_CheckRanklist(t *testing.T) {
	...
	members := Members{
		...
		MockMember(t, 2, MemberStateStopped),
		MockMember(t, 3, MemberStateExcluded),
		NewMember(Rank(4), test.MockUUID(4), "", addr1, MemberStateStopped), // second host rank
	}
...
func TestSystem_Membership_CheckHostlist(t *testing.T) {
	...
	members := Members{
		...
		NewMember(Rank(6), test.MockUUID(6), "", addr1, MemberStateStopped), // second host rank
	}
