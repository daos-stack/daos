...
func TestEvents_ConvertPoolSvcRankUpdate(t *testing.T) {
	event := NewPoolSvcRankUpdateEvent("foo", 1, common.MockUUID(), []uint32{0, 1}, 1)
	...
	returnedEvent := new(PoolSvcRankUpdate)
