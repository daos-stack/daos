...
type (
	...
	managementServiceClient struct {
		log logging.Logger
		cfg mscConfig
	}
)

func newManagementServiceClient(ctx context.Context, log logging.Logger, cfg mscConfig) *managementServiceClient {
...
func (msc *managementServiceClient) withConnection(ctx context.Context, fn func(context.Context, string, mgmtpb.MgmtSvcClient) error) error {
...
func (msc *managementServiceClient) LeaderAddress() (string, error) {
...
func (msc *managementServiceClient) Join(ctx context.Context, req *mgmtpb.JoinReq) (resp *mgmtpb.JoinResp, joinErr error) {
