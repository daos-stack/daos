...
func (srv *iosrv) start() (err error) {
	...
	// TODO:
	//   1 Wait for a Ready request from the I/O server.
	//   2 Get the rank and send a SetRank request to the I/O server.
	//   3 If CreateMs, send a CreateMs request to the I/O server.
	//   4 Clear CreateMs and BootstrapMs in the superblock.
	//   5 Send a StartMs request to the I/O server.
