...
func (cmd *poolRebuildOpCmd) execute(opCode control.PoolRebuildOpCode) (errOut error) {
...
func (cmd *poolRebuildStartCmd) Execute(_ []string) error {
	return cmd.execute(control.PoolRebuildOpCodeStart)
}
...
func (cmd *poolRebuildStopCmd) Execute(_ []string) error {
	return cmd.execute(control.PoolRebuildOpCodeStop)
}
