...
func TestLoadNodeCertCached_ReloadOnFileChange(t *testing.T) {
	tmpDir, cleanup := test.CreateTestDir(t)
	defer cleanup()
	...
	// Rewrite both files. The key is 0400 once written, so remove
	// first; this mirrors how dmg writes replacement certs.
