...
func (c *localFabricCache) GetDevice(numaNode int, netDevClass uint32, requireDomain bool) (*FabricInterface, error) {
	if c == nil {
		return nil, NotCachedErr
	}
	...
	return c.localNUMAFabric.GetDevice(numaNode, netDevClass, requireDomain)
}
