...
const (
	...
	// AnnotatedSystemErrNotLeader defines an identifier for ErrrNotLeader errors
	// serialized as gRPC status metadata.
	AnnotatedSystemErrNotLeader = "proto.system.ErrNotLeader"
	// AnnotatedSystemErrNotReplica defines an identifier for ErrrNotReplica errors
	// serialized as gRPC status metadata.
