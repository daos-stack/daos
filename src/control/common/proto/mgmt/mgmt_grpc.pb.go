...
const (
	...
	MgmtSvc_SystemRemoveRanks_FullMethodName        = "/mgmt.MgmtSvc/SystemRemoveRanks"
...
type MgmtSvcClient interface {
	...
	// Remove DAOS ranks from MS database
	SystemRemoveRanks(ctx context.Context, in *SystemRemoveRanksReq, opts ...grpc.CallOption) (*SystemRemoveRanksResp, error)
...
func (c *mgmtSvcClient) SystemRemoveRanks(ctx context.Context, in *SystemRemoveRanksReq, opts ...grpc.CallOption) (*SystemRemoveRanksResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SystemRemoveRanksResp)
	err := c.cc.Invoke(ctx, MgmtSvc_SystemRemoveRanks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MgmtSvcServer interface {
	...
	// Remove DAOS ranks from MS database
	SystemRemoveRanks(context.Context, *SystemRemoveRanksReq) (*SystemRemoveRanksResp, error)
	// Drain or reintegrate DAOS ranks from all pools
...
func (UnimplementedMgmtSvcServer) PoolExtend(context.Context, *PoolExtendReq) (*PoolExtendResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PoolExtend not implemented")
}
func (UnimplementedMgmtSvcServer) PoolReintegrate(context.Context, *PoolReintReq) (*PoolReintResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PoolReintegrate not implemented")
}
func (UnimplementedMgmtSvcServer) PoolQuery(context.Context, *PoolQueryReq) (*PoolQueryResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PoolQuery not implemented")
}
func (UnimplementedMgmtSvcServer) PoolQueryTarget(context.Context, *PoolQueryTargetReq) (*PoolQueryTargetResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PoolQueryTarget not implemented")
}
func (UnimplementedMgmtSvcServer) PoolSetProp(context.Context, *PoolSetPropReq) (*PoolSetPropResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PoolSetProp not implemented")
}
...
func (UnimplementedMgmtSvcServer) SystemGetAttr(context.Context, *SystemGetAttrReq) (*SystemGetAttrResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SystemGetAttr not implemented")
}
func (UnimplementedMgmtSvcServer) SystemSetProp(context.Context, *SystemSetPropReq) (*DaosResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SystemSetProp not implemented")
}
func (UnimplementedMgmtSvcServer) SystemGetProp(context.Context, *SystemGetPropReq) (*SystemGetPropResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SystemGetProp not implemented")
}
func (UnimplementedMgmtSvcServer) FaultInjectReport(context.Context, *chk.CheckReport) (*DaosResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FaultInjectReport not implemented")
}
func (UnimplementedMgmtSvcServer) FaultInjectPoolFault(context.Context, *chk.Fault) (*DaosResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FaultInjectPoolFault not implemented")
}
func (UnimplementedMgmtSvcServer) FaultInjectMgmtPoolFault(context.Context, *chk.Fault) (*DaosResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FaultInjectMgmtPoolFault not implemented")
}
...
func RegisterMgmtSvcServer(s grpc.ServiceRegistrar, srv MgmtSvcServer) {
	// If the following call panics, it indicates UnimplementedMgmtSvcServer was
...
func _MgmtSvc_PoolRebuildStart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PoolRebuildStartReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MgmtSvcServer).PoolRebuildStart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MgmtSvc_PoolRebuildStart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MgmtSvcServer).PoolRebuildStart(ctx, req.(*PoolRebuildStartReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _MgmtSvc_PoolRebuildStop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PoolRebuildStopReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MgmtSvcServer).PoolRebuildStop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MgmtSvc_PoolRebuildStop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MgmtSvcServer).PoolRebuildStop(ctx, req.(*PoolRebuildStopReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MgmtSvc_SystemRemoveRanks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SystemRemoveRanksReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MgmtSvcServer).SystemRemoveRanks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MgmtSvc_SystemRemoveRanks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MgmtSvcServer).SystemRemoveRanks(ctx, req.(*SystemRemoveRanksReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MgmtSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PoolRebuildStart",
			Handler:    _MgmtSvc_PoolRebuildStart_Handler,
		},
		{
			MethodName: "PoolRebuildStop",
		...
		{
			MethodName: "SystemRemoveRanks",
			Handler:    _MgmtSvc_SystemRemoveRanks_Handler,
		},
		{
