...
type DevReplaceResp struct {
	Status               int32    `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	OldDevUuid           string   `protobuf:"bytes,2,opt,name=old_dev_uuid,json=oldDevUuid,proto3" json:"old_dev_uuid,omitempty"`
	NewDevUuid           string   `protobuf:"bytes,3,opt,name=new_dev_uuid,json=newDevUuid,proto3" json:"new_dev_uuid,omitempty"`
	DevState             string   `protobuf:"bytes,4,opt,name=dev_state,json=devState,proto3" json:"dev_state,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DevReplaceResp) GetOldDevUuid() string {
	if m != nil {
		return m.OldDevUuid
	}
	return ""
...
type SmdQueryReq struct {
	...
	ReplaceUUID          string   `protobuf:"bytes,9,opt,name=replaceUUID,proto3" json:"replaceUUID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SmdQueryReq) GetReplace() bool {
	if m != nil {
		return m.Replace
	}
	return false
...
var fileDescriptor_d87a8d20722a9416 = []byte{
	...
	,
}
