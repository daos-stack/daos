...
type CheckInconsistPolicy struct {
	...
	InconsistCas uint32 `protobuf:"varint,1,opt,name=inconsist_cas,json=inconsistCas,proto3" json:"inconsist_cas,omitempty"` // See CheckInconsistClass.
	InconsistAct uint32 `protobuf:"varint,2,opt,name=inconsist_act,json=inconsistAct,proto3" json:"inconsist_act,omitempty"` // See CheckInconsistAction.
}
...
func (x *CheckInconsistPolicy) GetInconsistCas() uint32 {
	if x != nil {
...
func (x *CheckInconsistPolicy) GetInconsistAct() uint32 {
	if x != nil {
...
type CheckQueryTarget struct {
	...
	Status uint32 `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"` // Check instance status on this target - see CheckInstStatus.
...
func (x *CheckQueryTarget) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
type CheckQueryPool struct {
	...
	Status uint32 `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"` // Pool status - see CheckPoolStatus.
	Phase  uint32 `protobuf:"varint,3,opt,name=phase,proto3" json:"phase,omitempty"`   // Scan phase - see CheckScanPhase.
	// Inconsistency statistics during the phases range
...
func (x *CheckQueryPool) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *CheckQueryPool) GetPhase() uint32 {
	if x != nil {
		return x.Phase
	}
	return 0
...
type CheckQueryResp struct {
	...
	InsStatus uint32 `protobuf:"varint,2,opt,name=ins_status,json=insStatus,proto3" json:"ins_status,omitempty"`
	...
	InsPhase uint32 `protobuf:"varint,3,opt,name=ins_phase,json=insPhase,proto3" json:"ins_phase,omitempty"`
	// Inconsistency statistics during the phases range
...
func (x *CheckQueryResp) GetInsStatus() uint32 {
	if x != nil {
		return x.InsStatus
	}
	return 0
...
func (x *CheckQueryResp) GetInsPhase() uint32 {
	if x != nil {
		return x.InsPhase
	}
	return 0
...
type CheckActReq struct {
	...
	Act    uint32 `protobuf:"varint,3,opt,name=act,proto3" json:"act,omitempty"`
...
func (x *CheckActReq) GetAct() uint32 {
	if x != nil {
		return x.Act
	}
	return 0
...
var file_mgmt_check_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6d, 0x65, 0x12, 0x2a, 0x0a, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x06, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73,
	0x22, 0x20, 0x0a, 0x0c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x71,
	0x12, 0x10, 0x0a, 0x03, 0x73, 0x79, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73,
	0x79, 0x73, 0x22, 0x75, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x52,
	...
	,
...
var file_mgmt_check_proto_depIdxs = []int32{
	0,  // 0: mgmt.CheckStartReq.policies:type_name -> mgmt.CheckInconsistPolicy
	7,  // 1: mgmt.CheckQueryTarget.inconsistency:type_name -> mgmt.CheckQueryInconsist
	6,  // 2: mgmt.CheckQueryTarget.time:type_name -> mgmt.CheckQueryTime
	7,  // 3: mgmt.CheckQueryPool.inconsistency:type_name -> mgmt.CheckQueryInconsist
	6,  // 4: mgmt.CheckQueryPool.time:type_name -> mgmt.CheckQueryTime
	8,  // 5: mgmt.CheckQueryPool.targets:type_name -> mgmt.CheckQueryTarget
	7,  // 6: mgmt.CheckQueryResp.inconsistency:type_name -> mgmt.CheckQueryInconsist
	6,  // 7: mgmt.CheckQueryResp.time:type_name -> mgmt.CheckQueryTime
	9,  // 8: mgmt.CheckQueryResp.pools:type_name -> mgmt.CheckQueryPool
	0,  // 9: mgmt.CheckPropResp.policies:type_name -> mgmt.CheckInconsistPolicy
