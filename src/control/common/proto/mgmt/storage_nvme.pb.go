...
type NvmeController struct {
	...
	Numanode             int32                       `protobuf:"varint,5,opt,name=numanode,proto3" json:"numanode,omitempty"`
...
func (*NvmeController) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{0}
}
...
func (m *NvmeController) GetNumanode() int32 {
	if m != nil {
		return m.Numanode
	}
	return 0
...
func (*NvmeController_Namespace) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{0, 0}
}
...
func (*NvmeControllerResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{1}
}
...
func (*ScanNvmeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{2}
}
...
func (*FormatNvmeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{3}
}
...
func (*UpdateNvmeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{4}
}
...
func (*BurninNvmeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_storage_nvme_ba9dd628bcfc251e, []int{5}
}
...
func init() { proto.RegisterFile("storage_nvme.proto", fileDescriptor_storage_nvme_ba9dd628bcfc251e) }

var fileDescriptor_storage_nvme_ba9dd628bcfc251e = []byte{
	// 366 bytes of a gzipped FileDescriptorProto
	,
}
