...
func (PoolRebuildStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8a14d8612184524f, []int{21, 0}
}
...
type PoolQueryReq struct {
	Uuid                 string   `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	Targetlist           []uint32 `protobuf:"varint,3,rep,packed,name=targetlist,proto3" json:"targetlist,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *PoolQueryReq) GetTargetlist() []uint32 {
	if m != nil {
		return m.Targetlist
	}
	return nil
...
type PoolQueryResp struct {
	...
	Queriedtargets       uint32             `protobuf:"varint,4,opt,name=queriedtargets,proto3" json:"queriedtargets,omitempty"`
	...
	Targetlist           []uint32           `protobuf:"varint,12,rep,packed,name=targetlist,proto3" json:"targetlist,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *PoolQueryResp) GetQueriedtargets() uint32 {
	if m != nil {
		return m.Queriedtargets
	}
	return 0
}
...
func (m *PoolQueryResp) GetTargetlist() []uint32 {
	if m != nil {
		return m.Targetlist
	}
	return nil
...
var fileDescriptor_8a14d8612184524f = []byte{
	...
	,
}
