...
type PoolQueryReq struct {
	...
	SvcRanks []uint32 `protobuf:"varint,3,rep,packed,name=svc_ranks,json=svcRanks,proto3" json:"svc_ranks,omitempty"` // List of pool service ranks
	InfoBit  int32    `protobuf:"varint,4,opt,name=info_bit,json=infoBit,proto3" json:"info_bit,omitempty"`           // Pool query bit set
}
...
func (x *PoolQueryReq) GetInfoBit() int32 {
	if x != nil {
		return x.InfoBit
	}
	return 0
...
type PoolQueryResp struct {
	...
	InfoBit         int32                `protobuf:"varint,12,opt,name=info_bit,json=infoBit,proto3" json:"info_bit,omitempty"`                        // Pool query bit set
	RankSet         string               `protobuf:"bytes,13,opt,name=rank_set,json=rankSet,proto3" json:"rank_set,omitempty"`                         // Set of ranks enabled or disabled
}
...
func (x *PoolQueryResp) GetInfoBit() int32 {
	if x != nil {
		return x.InfoBit
	}
	return 0
...
func (x *PoolQueryResp) GetRankSet() string {
	if x != nil {
		return x.RankSet
	}
	return ""
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x75, 0x75, 0x69, 0x64, 0x22, 0x68, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72,
	...
	0x6e, 0x6b, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x62, 0x69, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x69, 0x74, 0x22, 0x94,
	...
	0x52, 0x04, 0x6d, 0x65, 0x61, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x6d, 0x65, 0x64, 0x69,
	...
	0x59, 0x10, 0x02, 0x22, 0xbc, 0x03, 0x0a, 0x0d, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72,
	...
	0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x62, 0x69, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07,
	0x69, 0x6e, 0x66, 0x6f, 0x42, 0x69, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x61, 0x6e, 0x6b, 0x5f,
	0x73, 0x65, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x61, 0x6e, 0x6b, 0x53,
	0x65, 0x74, 0x22, 0x63, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72,
...
=======
	...
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68,
