...
type PoolQueryReq struct {
	...
	Sys    string               `protobuf:"bytes,1,opt,name=sys,proto3" json:"sys,omitempty"` // DAOS system identifier
	Pools  []*PoolQueryReq_Pool `protobuf:"bytes,5,rep,name=pools,proto3" json:"pools,omitempty"`
	NoDrpc bool                 `protobuf:"varint,6,opt,name=no_drpc,json=noDrpc,proto3" json:"no_drpc,omitempty"` // do not forward to engine over dRPC
}
...
func (x *PoolQueryReq) GetPools() []*PoolQueryReq_Pool {
	if x != nil {
		return x.Pools
	}
	return nil
...
func (x *PoolQueryReq) GetNoDrpc() bool {
	if x != nil {
		return x.NoDrpc
	}
	return false
...
type PoolQueryResp struct {
	...
	Status int32                 `protobuf:"varint,12,opt,name=status,proto3" json:"status,omitempty"` // DAOS error code
	Pools  []*PoolQueryResp_Pool `protobuf:"bytes,13,rep,name=pools,proto3" json:"pools,omitempty"`    // list of pool details
}
...
func (x *PoolQueryResp) GetPools() []*PoolQueryResp_Pool {
	if x != nil {
		return x.Pools
	}
	return nil
...
type PoolQueryReq_Pool struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id      string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                  // uuid or label of pool to query
	SvcReps []uint32 `protobuf:"varint,2,rep,packed,name=svc_reps,json=svcReps,proto3" json:"svc_reps,omitempty"` // list of pool service ranks
}

func (x *PoolQueryReq_Pool) Reset() {
	*x = PoolQueryReq_Pool{}
	if protoimpl.UnsafeEnabled {
...
func (x *PoolQueryReq_Pool) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PoolQueryReq_Pool) ProtoMessage() {}

func (x *PoolQueryReq_Pool) ProtoReflect() protoreflect.Message {
	mi := &file_mgmt_pool_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PoolQueryReq_Pool.ProtoReflect.Descriptor instead.
func (*PoolQueryReq_Pool) Descriptor() ([]byte, []int) {
	return file_mgmt_pool_proto_rawDescGZIP(), []int{16, 0}
}

func (x *PoolQueryReq_Pool) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PoolQueryReq_Pool) GetSvcReps() []uint32 {
	if x != nil {
		return x.SvcReps
	}
	return nil
...
type PoolQueryResp_Pool struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SvcReps         []uint32             `protobuf:"varint,12,rep,packed,name=svc_reps,json=svcReps,proto3" json:"svc_reps,omitempty"`                 // pool service replica ranks
}

func (x *PoolQueryResp_Pool) Reset() {
	*x = PoolQueryResp_Pool{}
	if protoimpl.UnsafeEnabled {
...
func (x *PoolQueryResp_Pool) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PoolQueryResp_Pool) ProtoMessage() {}

func (x *PoolQueryResp_Pool) ProtoReflect() protoreflect.Message {
	mi := &file_mgmt_pool_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PoolQueryResp_Pool.ProtoReflect.Descriptor instead.
func (*PoolQueryResp_Pool) Descriptor() ([]byte, []int) {
	return file_mgmt_pool_proto_rawDescGZIP(), []int{19, 0}
}

func (x *PoolQueryResp_Pool) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *PoolQueryResp_Pool) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *PoolQueryResp_Pool) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *PoolQueryResp_Pool) GetTotalTargets() uint32 {
	if x != nil {
...
func (x *PoolQueryResp_Pool) GetActiveTargets() uint32 {
	if x != nil {
...
func (x *PoolQueryResp_Pool) GetDisabledTargets() uint32 {
	if x != nil {
...
func (x *PoolQueryResp_Pool) GetRebuild() *PoolRebuildStatus {
	if x != nil {
		return x.Rebuild
	}
	return nil
...
func (x *PoolQueryResp_Pool) GetTierStats() []*StorageUsageStats {
	if x != nil {
		return x.TierStats
	}
	return nil
...
func (x *PoolQueryResp_Pool) GetTotalNodes() uint32 {
	if x != nil {
		return x.TotalNodes
	}
	return 0
...
func (x *PoolQueryResp_Pool) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *PoolQueryResp_Pool) GetLeader() uint32 {
	if x != nil {
		return x.Leader
	}
	return 0
...
func (x *PoolQueryResp_Pool) GetSvcReps() []uint32 {
	if x != nil {
		return x.SvcReps
	}
	return nil
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x22, 0x4c, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x12,
	...
	,
	...
	0x52, 0x07, 0x73, 0x76, 0x63, 0x52, 0x65, 0x70, 0x73, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x4a,
	0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22,
	0x94, 0x01, 0x0a, 0x11, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x55, 0x73, 0x61, 0x67, 0x65,
	...
	0x04, 0x52, 0x04, 0x6d, 0x65, 0x61, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x64, 0x69, 0x61,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x6d, 0x65, 0x64,
	...
	0x53, 0x59, 0x10, 0x02, 0x22, 0xf8, 0x03, 0x0a, 0x0d, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2e,
	0x0a, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65,
	0x73, 0x70, 0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x1a, 0x98,
	0x03, 0x0a, 0x04, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x19,
	0x0a, 0x08, 0x73, 0x76, 0x63, 0x5f, 0x72, 0x65, 0x70, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d,
	0x52, 0x07, 0x73, 0x76, 0x63, 0x52, 0x65, 0x70, 0x73, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x0c, 0x22,
	...
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69,
...
var file_mgmt_pool_proto_goTypes = []interface{}{
	...
	(*ListContReq)(nil),          // 15: mgmt.ListContReq
	(*ListContResp)(nil),         // 16: mgmt.ListContResp
	(*PoolQueryReq)(nil),         // 17: mgmt.PoolQueryReq
	(*StorageUsageStats)(nil),    // 18: mgmt.StorageUsageStats
	(*PoolRebuildStatus)(nil),    // 19: mgmt.PoolRebuildStatus
	(*PoolQueryResp)(nil),        // 20: mgmt.PoolQueryResp
	(*PoolProperty)(nil),         // 21: mgmt.PoolProperty
	(*PoolSetPropReq)(nil),       // 22: mgmt.PoolSetPropReq
	(*PoolSetPropResp)(nil),      // 23: mgmt.PoolSetPropResp
	(*PoolGetPropReq)(nil),       // 24: mgmt.PoolGetPropReq
	(*PoolGetPropResp)(nil),      // 25: mgmt.PoolGetPropResp
	(*ListContResp_Cont)(nil),    // 26: mgmt.ListContResp.Cont
	(*PoolQueryReq_Pool)(nil),    // 27: mgmt.PoolQueryReq.Pool
	(*PoolQueryResp_Pool)(nil),   // 28: mgmt.PoolQueryResp.Pool
}
var file_mgmt_pool_proto_depIdxs = []int32{
	21, // 0: mgmt.PoolCreateReq.properties:type_name -> mgmt.PoolProperty
	26, // 1: mgmt.ListContResp.containers:type_name -> mgmt.ListContResp.Cont
	27, // 2: mgmt.PoolQueryReq.pools:type_name -> mgmt.PoolQueryReq.Pool
	0,  // 3: mgmt.PoolRebuildStatus.state:type_name -> mgmt.PoolRebuildStatus.State
	28, // 4: mgmt.PoolQueryResp.pools:type_name -> mgmt.PoolQueryResp.Pool
	21, // 5: mgmt.PoolSetPropReq.properties:type_name -> mgmt.PoolProperty
	21, // 6: mgmt.PoolGetPropReq.properties:type_name -> mgmt.PoolProperty
	21, // 7: mgmt.PoolGetPropResp.properties:type_name -> mgmt.PoolProperty
	19, // 8: mgmt.PoolQueryResp.Pool.rebuild:type_name -> mgmt.PoolRebuildStatus
	18, // 9: mgmt.PoolQueryResp.Pool.tier_stats:type_name -> mgmt.StorageUsageStats
...
func file_mgmt_pool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mgmt_pool_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PoolQueryReq_Pool); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mgmt_pool_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PoolQueryResp_Pool); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
