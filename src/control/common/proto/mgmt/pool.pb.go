...
func (*PoolCreateReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_pool_9302dcc90d4ddfb4, []int{0}
}
...
func (*PoolCreateResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_pool_9302dcc90d4ddfb4, []int{1}
}
...
func (*PoolDestroyReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_pool_9302dcc90d4ddfb4, []int{2}
}
...
func (*PoolDestroyResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_pool_9302dcc90d4ddfb4, []int{3}
}
...
func init() { proto.RegisterFile("pool.proto", fileDescriptor_pool_9302dcc90d4ddfb4) }

var fileDescriptor_pool_9302dcc90d4ddfb4 = []byte{
