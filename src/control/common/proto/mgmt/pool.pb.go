...
// FIXME? Does this have to match definitions in enum daos_rebuild_state_t?
...
type PoolQueryTargetInfo struct {
	...
	//	TP_UNKNOWN = 0;
	//	TP_HDD = 1; // Rotating disk
	//	TP_SSD = 2; // Flash-based
	//	TP_PM = 3; // Persistent memory
	//	TP_VM = 4; // Volatile memory
	//}
	//TargetType type = 1; // Target type jsee enum daos_target_type_t
	Type int32 `protobuf:"varint,1,opt,name=type,proto3" json:"type,omitempty"` // Target type jsee enum daos_target_type_t
	//enum TargetState { // See enum daos_target_state_t
	//	TS_UNKNOWN = 0;
	//	TS_DOWN_OUT = 1; // Not available
	//	TS_DOWN = 2; // Not available, may need rebuild
	//	TS_UP = 3; // Up
	//	TS_UP_IN = 4; // Up and running
	//	TS_NEW = 5; // Intermediate state for pool map change
...
func (x *PoolQueryTargetInfo) GetState() int32 {
	if x != nil {
		return x.State
	}
	return 0
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x73, 0x76, 0x63, 0x52, 0x65, 0x70, 0x73, 0x22, 0x4c, 0x0a, 0x0b, 0x4c, 0x69, 0x73,
	...
	0x75, 0x75, 0x69, 0x64, 0x22, 0x4d, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c, 0x51, 0x75, 0x65, 0x72,
	...
	0x6e, 0x6b, 0x73, 0x22, 0x94, 0x01, 0x0a, 0x11, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x55,
	...
	0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x6d, 0x65, 0x61, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x6d,
	0x65, 0x64, 0x69, 0x61, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x0a, 0x04, 0x42, 0x55, 0x53, 0x59, 0x10, 0x02, 0x22, 0x86, 0x03, 0x0a, 0x0d, 0x50, 0x6f, 0x6f,
	...
	0x0a, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x09, 0x20,
	...
	0x72, 0x22, 0x63, 0x0a, 0x0c, 0x50, 0x6f, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	...
	0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0x68, 0x0a, 0x12,
	...
	0x67, 0x65, 0x74, 0x69, 0x64, 0x78, 0x22, 0x5d, 0x0a, 0x12, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
