...
type PoolCreateReq struct {
	...
	UnavailableRanks []uint32  `protobuf:"varint,15,rep,packed,name=unavailable_ranks,json=unavailableRanks,proto3" json:"unavailable_ranks,omitempty"` // Ranks that are unavailable (excluded/admin-excluded/stopped); enter the pool map as DOWNOUT
	...
	IncludeSystemUnavailableRanks bool `protobuf:"varint,16,opt,name=include_system_unavailable_ranks,json=includeSystemUnavailableRanks,proto3" json:"include_system_unavailable_ranks,omitempty"`
...
func (x *PoolCreateReq) GetIncludeSystemUnavailableRanks() bool {
	if x != nil {
		return x.IncludeSystemUnavailableRanks
	}
	return false
}
...
func (x *PoolProperty) GetValue() isPoolProperty_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *PoolProperty) GetStrval() string {
	if x != nil {
		if x, ok := x.Value.(*PoolProperty_Strval); ok {
			return x.Strval
		}
	}
	return ""
...
func (x *PoolProperty) GetNumval() uint64 {
	if x != nil {
		if x, ok := x.Value.(*PoolProperty_Numval); ok {
			return x.Numval
		}
	}
	return 0
...
func (x *PoolProperty) GetByteval() []byte {
	if x != nil {
		if x, ok := x.Value.(*PoolProperty_Byteval); ok {
			return x.Byteval
		}
	}
	return nil
...
const file_mgmt_pool_proto_rawDesc = "" +
	"\n" +
	"\x0fmgmt/pool.proto\x12\x04mgmt\"\x9a\x04\n" +
	...
	"\n" +
	"user_group\x18\x04 \x01(\tR\tuserGroup\x12\x10\n" +
	"\x03acl\x18\x05 \x03(\tR\x03acl\x122\n" +
	"\n" +
	"properties\x18\x06 \x03(\v2\x12.mgmt.PoolPropertyR\n" +
	"properties\x12#\n" +
	"\rfault_domains\x18\a \x03(\rR\ffaultDomains\x12 \n" +
	"\fnum_svc_reps\x18\b \x01(\rR\n" +
	"numSvcReps\x12\x1f\n" +
	"\vtotal_bytes\x18\t \x01(\x04R\n" +
	"totalBytes\x12\x1d\n" +
	"\n" +
	"tier_ratio\x18\n" +
	" \x03(\x01R\ttierRatio\x12\x1b\n" +
	"\tnum_ranks\x18\v \x01(\rR\bnumRanks\x12\x14\n" +
	...
	"\x11unavailable_ranks\x18\x0f \x03(\rR\x10unavailableRanks\x12G\n" +
	" include_system_unavailable_ranks\x18\x10 \x01(\bR\x1dincludeSystemUnavailableRanks\"\xe7\x01\n" +
	"\x0ePoolCreateResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x17\n" +
	"\asvc_ldr\x18\x02 \x01(\rR\x06svcLdr\x12\x19\n" +
	"\bsvc_reps\x18\x03 \x03(\rR\asvcReps\x12\x1b\n" +
	"\ttgt_ranks\x18\x04 \x03(\rR\btgtRanks\x12\x1d\n" +
	"\n" +
	"tier_bytes\x18\x05 \x03(\x04R\ttierBytes\x12$\n" +
	"\x0emem_file_bytes\x18\x06 \x01(\x04R\fmemFileBytes\x12'\n" +
	"\x10md_on_ssd_active\x18\a \x01(\bR\rmdOnSsdActive\"\x83\x01\n" +
	"\x0ePoolDestroyReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x14\n" +
	"\x05force\x18\x03 \x01(\bR\x05force\x12\x1b\n" +
	"\tsvc_ranks\x18\x04 \x03(\rR\bsvcRanks\x12\x1c\n" +
	"\trecursive\x18\x05 \x01(\bR\trecursive\")\n" +
	"\x0fPoolDestroyResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\"\xc0\x01\n" +
	"\fPoolEvictReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tsvc_ranks\x18\x03 \x03(\rR\bsvcRanks\x12\x18\n" +
	"\ahandles\x18\x04 \x03(\tR\ahandles\x12\x18\n" +
	"\adestroy\x18\x05 \x01(\bR\adestroy\x12#\n" +
	"\rforce_destroy\x18\x06 \x01(\bR\fforceDestroy\x12\x18\n" +
	"\amachine\x18\a \x01(\tR\amachine\"=\n" +
	"\rPoolEvictResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\"\x98\x01\n" +
	"\x0ePoolExcludeReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04rank\x18\x03 \x01(\rR\x04rank\x12\x1d\n" +
	"\n" +
	"target_idx\x18\x04 \x03(\rR\ttargetIdx\x12\x1b\n" +
	"\tsvc_ranks\x18\x05 \x03(\rR\bsvcRanks\x12\x14\n" +
	"\x05force\x18\x06 \x01(\bR\x05force\")\n" +
	"\x0fPoolExcludeResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\"\x80\x01\n" +
	"\fPoolDrainReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04rank\x18\x03 \x01(\rR\x04rank\x12\x1d\n" +
	"\n" +
	...
	"\rPoolDrainResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\"\xc5\x01\n" +
	"\rPoolExtendReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x14\n" +
	"\x05ranks\x18\x03 \x03(\rR\x05ranks\x12\x1b\n" +
	"\tsvc_ranks\x18\x04 \x03(\rR\bsvcRanks\x12\x1d\n" +
	"\n" +
	"tier_bytes\x18\x05 \x03(\x04R\ttierBytes\x12#\n" +
	"\rfault_domains\x18\x06 \x03(\rR\ffaultDomains\x12\x1b\n" +
	"\tmem_ratio\x18\a \x01(\x02R\bmemRatio\"G\n" +
	"\x0ePoolExtendResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x1d\n" +
	"\n" +
	"tier_bytes\x18\x02 \x03(\x04R\ttierBytes\"\xbc\x01\n" +
	"\fPoolReintReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04rank\x18\x03 \x01(\rR\x04rank\x12\x1d\n" +
	"\n" +
	"target_idx\x18\x04 \x03(\rR\ttargetIdx\x12\x1b\n" +
	"\tsvc_ranks\x18\x05 \x03(\rR\bsvcRanks\x12\x1d\n" +
	"\n" +
	"tier_bytes\x18\x06 \x03(\x04R\ttierBytes\x12\x1b\n" +
	"\tmem_ratio\x18\a \x01(\x02R\bmemRatio\"'\n" +
	"\rPoolReintResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\" \n" +
	"\fListPoolsReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\"\x83\x02\n" +
	"\rListPoolsResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12.\n" +
	"\x05pools\x18\x02 \x03(\v2\x18.mgmt.ListPoolsResp.PoolR\x05pools\x12!\n" +
	"\fdata_version\x18\x03 \x01(\x04R\vdataVersion\x1a\x86\x01\n" +
	"\x04Pool\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12\x19\n" +
	"\bsvc_reps\x18\x03 \x03(\rR\asvcReps\x12\x14\n" +
	"\x05state\x18\x04 \x01(\tR\x05state\x12#\n" +
	"\rrebuild_state\x18\x05 \x01(\tR\frebuildState\"L\n" +
	"\vListContReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tsvc_ranks\x18\x03 \x03(\rR\bsvcRanks\"{\n" +
	"\fListContResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x127\n" +
	"\n" +
	"containers\x18\x02 \x03(\v2\x17.mgmt.ListContResp.ContR\n" +
	"containers\x1a\x1a\n" +
	"\x04Cont\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\"l\n" +
	"\fPoolQueryReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tsvc_ranks\x18\x03 \x03(\rR\bsvcRanks\x12\x1d\n" +
	"\n" +
	"query_mask\x18\x04 \x01(\x04R\tqueryMask\"\xac\x01\n" +
	"\x11StorageUsageStats\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x04R\x05total\x12\x12\n" +
	"\x04free\x18\x02 \x01(\x04R\x04free\x12\x10\n" +
	"\x03min\x18\x03 \x01(\x04R\x03min\x12\x10\n" +
	"\x03max\x18\x04 \x01(\x04R\x03max\x12\x12\n" +
	"\x04mean\x18\x05 \x01(\x04R\x04mean\x125\n" +
	"\n" +
	"media_type\x18\x06 \x01(\x0e2\x16.mgmt.StorageMediaTypeR\tmediaType\"\xcf\x02\n" +
	"\x11PoolRebuildStatus\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x123\n" +
	"\x05state\x18\x02 \x01(\x0e2\x1d.mgmt.PoolRebuildStatus.StateR\x05state\x12\x18\n" +
	"\aobjects\x18\x03 \x01(\x04R\aobjects\x12\x18\n" +
	"\arecords\x18\x04 \x01(\x04R\arecords\x12B\n" +
	"\rderived_state\x18\x05 \x01(\x0e2\x1d.mgmt.PoolRebuildStatus.StateR\fderivedState\x12\x1a\n" +
	"\bdegraded\x18\x06 \x01(\bR\bdegraded\"Y\n" +
	"\x05State\x12\b\n" +
	"\x04BUSY\x10\x00\x12\b\n" +
	"\x04IDLE\x10\x01\x12\b\n" +
	"\x04DONE\x10\x02\x12\f\n" +
	"\bSTOPPING\x10\x03\x12\v\n" +
	"\aSTOPPED\x10\x04\x12\v\n" +
	"\aFAILING\x10\x05\x12\n" +
	"\n" +
	"\x06FAILED\x10\x06\"\x89\a\n" +
	"\rPoolQueryResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x12\n" +
	"\x04uuid\x18\x02 \x01(\tR\x04uuid\x12\x14\n" +
	"\x05label\x18\x03 \x01(\tR\x05label\x12#\n" +
	"\rtotal_targets\x18\x04 \x01(\rR\ftotalTargets\x12%\n" +
	"\x0eactive_targets\x18\x05 \x01(\rR\ractiveTargets\x12)\n" +
	"\x10disabled_targets\x18\x06 \x01(\rR\x0fdisabledTargets\x121\n" +
	"\arebuild\x18\a \x01(\v2\x17.mgmt.PoolRebuildStatusR\arebuild\x126\n" +
	"\n" +
	"tier_stats\x18\b \x03(\v2\x17.mgmt.StorageUsageStatsR\ttierStats\x12\x18\n" +
	"\aversion\x18\n" +
	" \x01(\rR\aversion\x12\x16\n" +
	"\x06leader\x18\v \x01(\rR\x06leader\x12#\n" +
	"\renabled_ranks\x18\f \x01(\tR\fenabledRanks\x12%\n" +
	"\x0edisabled_ranks\x18\r \x01(\tR\rdisabledRanks\x12#\n" +
	"\rtotal_engines\x18\x0e \x01(\rR\ftotalEngines\x12&\n" +
	"\x0fpool_layout_ver\x18\x0f \x01(\rR\rpoolLayoutVer\x12,\n" +
	"\x12upgrade_layout_ver\x18\x10 \x01(\rR\x10upgradeLayoutVer\x12,\n" +
	"\x05state\x18\x11 \x01(\x0e2\x16.mgmt.PoolServiceStateR\x05state\x12\x17\n" +
	"\asvc_ldr\x18\x12 \x01(\rR\x06svcLdr\x12\x19\n" +
	"\bsvc_reps\x18\x13 \x03(\rR\asvcReps\x12\x1d\n" +
	"\n" +
	"query_mask\x18\x14 \x01(\x04R\tqueryMask\x12$\n" +
	"\x0emem_file_bytes\x18\x15 \x01(\x04R\fmemFileBytes\x12\x1d\n" +
	"\n" +
	"dead_ranks\x18\x16 \x01(\tR\tdeadRanks\x12'\n" +
	"\x10md_on_ssd_active\x18\x17 \x01(\bR\rmdOnSsdActive\x12(\n" +
	"\x10self_heal_policy\x18\x18 \x01(\tR\x0eselfHealPolicy\x12/\n" +
	"\x14sys_self_heal_policy\x18\x19 \x01(\tR\x11sysSelfHealPolicyJ\x04\b\t\x10\n" +
	"R\vtotal_nodes\"\x7f\n" +
	"\fPoolProperty\x12\x16\n" +
	"\x06number\x18\x01 \x01(\rR\x06number\x12\x18\n" +
	"\x06strval\x18\x02 \x01(\tH\x00R\x06strval\x12\x18\n" +
	"\x06numval\x18\x03 \x01(\x04H\x00R\x06numval\x12\x1a\n" +
	"\abyteval\x18\x04 \x01(\fH\x00R\abytevalB\a\n" +
	"\x05value\"\x83\x01\n" +
	"\x0ePoolSetPropReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x122\n" +
	"\n" +
	"properties\x18\x03 \x03(\v2\x12.mgmt.PoolPropertyR\n" +
	"properties\x12\x1b\n" +
	"\tsvc_ranks\x18\x04 \x03(\rR\bsvcRanks\")\n" +
	"\x0fPoolSetPropResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\"\x83\x01\n" +
	"\x0ePoolGetPropReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x122\n" +
	"\n" +
	"properties\x18\x03 \x03(\v2\x12.mgmt.PoolPropertyR\n" +
	"properties\x12\x1b\n" +
	"\tsvc_ranks\x18\x04 \x03(\rR\bsvcRanks\"]\n" +
	"\x0fPoolGetPropResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x122\n" +
	"\n" +
	"properties\x18\x02 \x03(\v2\x12.mgmt.PoolPropertyR\n" +
	"properties\"O\n" +
	"\x0ePoolUpgradeReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tsvc_ranks\x18\x03 \x03(\rR\bsvcRanks\"\x81\x01\n" +
	"\x12PoolQueryTargetReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04rank\x18\x03 \x01(\rR\x04rank\x12\x18\n" +
	"\atargets\x18\x04 \x03(\rR\atargets\x12\x1b\n" +
	"\tsvc_ranks\x18\x05 \x03(\rR\bsvcRanks\"u\n" +
	"\x12StorageTargetUsage\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x04R\x05total\x12\x12\n" +
	"\x04free\x18\x02 \x01(\x04R\x04free\x125\n" +
	"\n" +
	"media_type\x18\x03 \x01(\x0e2\x16.mgmt.StorageMediaTypeR\tmediaType\"\xb8\x02\n" +
	"\x13PoolQueryTargetInfo\x12;\n" +
	"\x05state\x18\x02 \x01(\x0e2%.mgmt.PoolQueryTargetInfo.TargetStateR\x05state\x12.\n" +
	"\x05space\x18\x03 \x03(\v2\x18.mgmt.StorageTargetUsageR\x05space\x12$\n" +
	"\x0emem_file_bytes\x18\x04 \x01(\x04R\fmemFileBytes\x12'\n" +
	"\x10md_on_ssd_active\x18\x05 \x01(\bR\rmdOnSsdActive\"_\n" +
	"\vTargetState\x12\x11\n" +
	"\rSTATE_UNKNOWN\x10\x00\x12\f\n" +
	"\bDOWN_OUT\x10\x01\x12\b\n" +
	"\x04DOWN\x10\x02\x12\x06\n" +
	"\x02UP\x10\x03\x12\t\n" +
	"\x05UP_IN\x10\x04\x12\a\n" +
	"\x03NEW\x10\x05\x12\t\n" +
	"\x05DRAIN\x10\x06J\x04\b\x01\x10\x02\"^\n" +
	"\x13PoolQueryTargetResp\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12/\n" +
	"\x05infos\x18\x02 \x03(\v2\x19.mgmt.PoolQueryTargetInfoR\x05infos\"T\n" +
	"\x13PoolRebuildStartReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1b\n" +
	"\tsvc_ranks\x18\x03 \x03(\rR\bsvcRanks\"i\n" +
	"\x12PoolRebuildStopReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x14\n" +
	"\x05force\x18\x03 \x01(\bR\x05force\x12\x1b\n" +
	"\tsvc_ranks\x18\x04 \x03(\rR\bsvcRanks\"v\n" +
	"\x13PoolSelfHealEvalReq\x12\x10\n" +
	"\x03sys\x18\x01 \x01(\tR\x03sys\x12\x0e\n" +
	...
	"\x04NVME\x10\x01*]\n" +
	"\x10PoolServiceState\x12\f\n" +
	"\bCreating\x10\x00\x12\t\n" +
	"\x05Ready\x10\x01\x12\x0e\n" +
	"\n" +
	"Destroying\x10\x02\x12\x13\n" +
	"\x0fTargetsExcluded\x10\x03\x12\v\n" +
	"\aUnknown\x10\x04B:Z8github.com/daos-stack/daos/src/control/common/proto/mgmtb\x06proto3"

var (
	file_mgmt_pool_proto_rawDescOnce sync.Once
	file_mgmt_pool_proto_rawDescData []byte
)

func file_mgmt_pool_proto_rawDescGZIP() []byte {
	file_mgmt_pool_proto_rawDescOnce.Do(func() {
		file_mgmt_pool_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mgmt_pool_proto_rawDesc), len(file_mgmt_pool_proto_rawDesc)))
	})
...
func file_mgmt_pool_proto_init() {
	...
	file_mgmt_pool_proto_msgTypes[22].OneofWrappers = []any{
