...
const (
	...
	StorageMediaType_QLC  StorageMediaType = 2
)
...
type StorageTargetUsage struct {
	...
	MediaType StorageMediaType `protobuf:"varint,3,opt,name=media_type,json=mediaType,proto3,enum=mgmt.StorageMediaType" json:"media_type,omitempty"` // see daos_media_type_t (e.g., SCM, NVME, QLC)
}
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x6e, 0x66, 0x6f, 0x73, 0x2a, 0x2e, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x43,
	0x4d, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x56, 0x4d, 0x45, 0x10, 0x01, 0x12, 0x07, 0x0a,
	0x03, 0x51, 0x4c, 0x43, 0x10, 0x02, 0x2a, 0x56, 0x0a, 0x10, 0x50, 0x6f, 0x6f, 0x6c, 0x53, 0x65,
...
func file_mgmt_pool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mgmt_pool_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[20].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[21].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[23].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[24].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[25].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[26].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[27].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[28].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[29].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[32].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[33].Exporter = func(v any, i int) any {
		...
		file_mgmt_pool_proto_msgTypes[34].Exporter = func(v any, i int) any {
