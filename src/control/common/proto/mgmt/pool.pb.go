...
type PoolSelfHealEvalReq struct {
	...
	Sys      string   `protobuf:"bytes,1,opt,name=sys,proto3" json:"sys,omitempty"`                                   // DAOS system identifier
	Id       string   `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`                                     // DAOS pool identifier
	PropVal  string   `protobuf:"bytes,4,opt,name=prop_val,json=propVal,proto3" json:"prop_val,omitempty"`            // self_heal system property value
	SvcRanks []uint32 `protobuf:"varint,5,rep,packed,name=svc_ranks,json=svcRanks,proto3" json:"svc_ranks,omitempty"` // List of pool service ranks
}
...
func (x *PoolSelfHealEvalReq) GetPropVal() string {
	if x != nil {
		return x.PropVal
	}
	return ""
...
var file_mgmt_pool_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x6b, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x73, 0x76, 0x63, 0x52,
	0x61, 0x6e, 0x6b, 0x73, 0x22, 0x6f, 0x0a, 0x13, 0x50, 0x6f, 0x6f, 0x6c, 0x53, 0x65, 0x6c, 0x66,
	...
	0x08, 0x70, 0x72, 0x6f, 0x70, 0x5f, 0x76, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x70, 0x72, 0x6f, 0x70, 0x56, 0x61, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x76, 0x63, 0x5f,
	0x72, 0x61, 0x6e, 0x6b, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x73, 0x76, 0x63,
	0x52, 0x61, 0x6e, 0x6b, 0x73, 0x2a, 0x25, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	0x4d, 0x65, 0x64, 0x69, 0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x43, 0x4d,
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x56, 0x4d, 0x45, 0x10, 0x01, 0x2a, 0x5d, 0x0a, 0x10,
	...
	0x74, 0x72, 0x6f, 0x79, 0x69, 0x6e, 0x67, 0x10, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x54, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x73, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x10, 0x03, 0x12, 0x0b,
...
var file_mgmt_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_mgmt_pool_proto_goTypes = []interface{}{
	...
	(*PoolRebuildStopReq)(nil),           // 39: mgmt.PoolRebuildStopReq
	(*PoolSelfHealEvalReq)(nil),          // 40: mgmt.PoolSelfHealEvalReq
	(*ListPoolsResp_Pool)(nil),           // 41: mgmt.ListPoolsResp.Pool
	(*ListContResp_Cont)(nil),            // 42: mgmt.ListContResp.Cont
}
var file_mgmt_pool_proto_depIdxs = []int32{
	27, // 0: mgmt.PoolCreateReq.properties:type_name -> mgmt.PoolProperty
	41, // 1: mgmt.ListPoolsResp.pools:type_name -> mgmt.ListPoolsResp.Pool
	42, // 2: mgmt.ListContResp.containers:type_name -> mgmt.ListContResp.Cont
