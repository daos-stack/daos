...
func (JoinResp_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{1, 0}
}
...
func (*JoinReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{0}
}
...
func (*JoinResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{1}
}
...
func (*GetAttachInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{2}
}
...
func (*GetAttachInfoResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{3}
}
...
func (*GetAttachInfoResp_Psr) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_748b0c6c5cdb70d3, []int{3, 0}
}
...
func init() { proto.RegisterFile("mgmt.proto", fileDescriptor_mgmt_748b0c6c5cdb70d3) }

var fileDescriptor_mgmt_748b0c6c5cdb70d3 = []byte{
	// 502 bytes of a gzipped FileDescriptorProto
	,
}
