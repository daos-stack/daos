...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x32, 0xe3, 0x0b, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a, 0x04,
	...
	,
	...
	0x73, 0x70, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0b, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x45, 0x72,
	0x61, 0x73, 0x65, 0x12, 0x14, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x45, 0x72, 0x61, 0x73, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x15, 0x2e, 0x6d, 0x67, 0x6d, 0x74,
	0x2e, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x45, 0x72, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x22, 0x00, 0x12, 0x42, 0x0a, 0x0d, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x43, 0x6c, 0x65, 0x61,
	0x6e, 0x75, 0x70, 0x12, 0x16, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x43, 0x6c, 0x65, 0x61, 0x6e, 0x75, 0x70, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x6d, 0x67,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*ContSetOwnerReq)(nil),         // 18: mgmt.ContSetOwnerReq
	(*SystemQueryReq)(nil),          // 19: mgmt.SystemQueryReq
	(*SystemStopReq)(nil),           // 20: mgmt.SystemStopReq
	(*SystemStartReq)(nil),          // 21: mgmt.SystemStartReq
	(*SystemEraseReq)(nil),          // 22: mgmt.SystemEraseReq
	(*SystemCleanupReq)(nil),        // 23: mgmt.SystemCleanupReq
	...
	(*PoolDestroyResp)(nil),         // 28: mgmt.PoolDestroyResp
	(*PoolEvictResp)(nil),           // 29: mgmt.PoolEvictResp
	(*PoolExcludeResp)(nil),         // 30: mgmt.PoolExcludeResp
	(*PoolDrainResp)(nil),           // 31: mgmt.PoolDrainResp
	(*PoolExtendResp)(nil),          // 32: mgmt.PoolExtendResp
	(*PoolReintegrateResp)(nil),     // 33: mgmt.PoolReintegrateResp
	(*PoolQueryResp)(nil),           // 34: mgmt.PoolQueryResp
	(*PoolSetPropResp)(nil),         // 35: mgmt.PoolSetPropResp
	(*PoolGetPropResp)(nil),         // 36: mgmt.PoolGetPropResp
	(*ACLResp)(nil),                 // 37: mgmt.ACLResp
	(*GetAttachInfoResp)(nil),       // 38: mgmt.GetAttachInfoResp
	(*ListContResp)(nil),            // 39: mgmt.ListContResp
	(*ContSetOwnerResp)(nil),        // 40: mgmt.ContSetOwnerResp
	(*SystemQueryResp)(nil),         // 41: mgmt.SystemQueryResp
	(*SystemStopResp)(nil),          // 42: mgmt.SystemStopResp
	(*SystemStartResp)(nil),         // 43: mgmt.SystemStartResp
	(*SystemEraseResp)(nil),         // 44: mgmt.SystemEraseResp
	(*SystemCleanupResp)(nil),       // 45: mgmt.SystemCleanupResp
}
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	17, // 18: mgmt.MgmtSvc.ListContainers:input_type -> mgmt.ListContReq
	18, // 19: mgmt.MgmtSvc.ContSetOwner:input_type -> mgmt.ContSetOwnerReq
	19, // 20: mgmt.MgmtSvc.SystemQuery:input_type -> mgmt.SystemQueryReq
	20, // 21: mgmt.MgmtSvc.SystemStop:input_type -> mgmt.SystemStopReq
	21, // 22: mgmt.MgmtSvc.SystemStart:input_type -> mgmt.SystemStartReq
	22, // 23: mgmt.MgmtSvc.SystemErase:input_type -> mgmt.SystemEraseReq
	23, // 24: mgmt.MgmtSvc.SystemCleanup:input_type -> mgmt.SystemCleanupReq
	...
	28, // 29: mgmt.MgmtSvc.PoolDestroy:output_type -> mgmt.PoolDestroyResp
	29, // 30: mgmt.MgmtSvc.PoolEvict:output_type -> mgmt.PoolEvictResp
	30, // 31: mgmt.MgmtSvc.PoolExclude:output_type -> mgmt.PoolExcludeResp
	31, // 32: mgmt.MgmtSvc.PoolDrain:output_type -> mgmt.PoolDrainResp
	32, // 33: mgmt.MgmtSvc.PoolExtend:output_type -> mgmt.PoolExtendResp
	33, // 34: mgmt.MgmtSvc.PoolReintegrate:output_type -> mgmt.PoolReintegrateResp
	34, // 35: mgmt.MgmtSvc.PoolQuery:output_type -> mgmt.PoolQueryResp
	35, // 36: mgmt.MgmtSvc.PoolSetProp:output_type -> mgmt.PoolSetPropResp
	36, // 37: mgmt.MgmtSvc.PoolGetProp:output_type -> mgmt.PoolGetPropResp
	...
	39, // 43: mgmt.MgmtSvc.ListContainers:output_type -> mgmt.ListContResp
	40, // 44: mgmt.MgmtSvc.ContSetOwner:output_type -> mgmt.ContSetOwnerResp
	41, // 45: mgmt.MgmtSvc.SystemQuery:output_type -> mgmt.SystemQueryResp
	42, // 46: mgmt.MgmtSvc.SystemStop:output_type -> mgmt.SystemStopResp
	43, // 47: mgmt.MgmtSvc.SystemStart:output_type -> mgmt.SystemStartResp
	44, // 48: mgmt.MgmtSvc.SystemErase:output_type -> mgmt.SystemEraseResp
	45, // 49: mgmt.MgmtSvc.SystemCleanup:output_type -> mgmt.SystemCleanupResp
