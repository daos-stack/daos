...
func (JoinResp_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{1, 0}
}
...
func (*JoinReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{0}
}
...
func (*JoinResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{1}
}
...
func (*GetAttachInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{2}
}
...
func (*GetAttachInfoResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{3}
}
...
func (*GetAttachInfoResp_Psr) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_67fb8e72926e76c7, []int{3, 0}
}
...
func init() { proto.RegisterFile("mgmt.proto", fileDescriptor_mgmt_67fb8e72926e76c7) }

var fileDescriptor_mgmt_67fb8e72926e76c7 = []byte{
