...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xd6, 0x13, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x0d, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x12, 0x16, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e,
	0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x71,
	0x1a, 0x17, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x45, 0x78,
	0x63, 0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0b, 0x53,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*chk.CheckReport)(nil),         // 35: chk.CheckReport
	...
	(*JoinResp)(nil),                // 40: mgmt.JoinResp
	(*shared.ClusterEventResp)(nil), // 41: shared.ClusterEventResp
	(*LeaderQueryResp)(nil),         // 42: mgmt.LeaderQueryResp
	(*PoolCreateResp)(nil),          // 43: mgmt.PoolCreateResp
	(*PoolDestroyResp)(nil),         // 44: mgmt.PoolDestroyResp
	(*PoolEvictResp)(nil),           // 45: mgmt.PoolEvictResp
	(*PoolExcludeResp)(nil),         // 46: mgmt.PoolExcludeResp
	(*PoolDrainResp)(nil),           // 47: mgmt.PoolDrainResp
	(*PoolExtendResp)(nil),          // 48: mgmt.PoolExtendResp
	(*PoolReintegrateResp)(nil),     // 49: mgmt.PoolReintegrateResp
	(*PoolQueryResp)(nil),           // 50: mgmt.PoolQueryResp
	(*PoolQueryTargetResp)(nil),     // 51: mgmt.PoolQueryTargetResp
	(*PoolSetPropResp)(nil),         // 52: mgmt.PoolSetPropResp
	(*PoolGetPropResp)(nil),         // 53: mgmt.PoolGetPropResp
	(*ACLResp)(nil),                 // 54: mgmt.ACLResp
	(*GetAttachInfoResp)(nil),       // 55: mgmt.GetAttachInfoResp
	(*ListPoolsResp)(nil),           // 56: mgmt.ListPoolsResp
	(*ListContResp)(nil),            // 57: mgmt.ListContResp
	(*ContSetOwnerResp)(nil),        // 58: mgmt.ContSetOwnerResp
	(*SystemQueryResp)(nil),         // 59: mgmt.SystemQueryResp
	(*SystemStopResp)(nil),          // 60: mgmt.SystemStopResp
	(*SystemStartResp)(nil),         // 61: mgmt.SystemStartResp
	(*SystemExcludeResp)(nil),       // 62: mgmt.SystemExcludeResp
	(*SystemEraseResp)(nil),         // 63: mgmt.SystemEraseResp
	(*SystemCleanupResp)(nil),       // 64: mgmt.SystemCleanupResp
	(*DaosResp)(nil),                // 65: mgmt.DaosResp
	(*CheckStartResp)(nil),          // 66: mgmt.CheckStartResp
	(*CheckStopResp)(nil),           // 67: mgmt.CheckStopResp
	(*CheckQueryResp)(nil),          // 68: mgmt.CheckQueryResp
	(*CheckPropResp)(nil),           // 69: mgmt.CheckPropResp
	(*CheckActResp)(nil),            // 70: mgmt.CheckActResp
	(*PoolUpgradeResp)(nil),         // 71: mgmt.PoolUpgradeResp
	(*SystemGetAttrResp)(nil),       // 72: mgmt.SystemGetAttrResp
	(*SystemGetPropResp)(nil),       // 73: mgmt.SystemGetPropResp
}
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	35, // 36: mgmt.MgmtSvc.FaultInjectReport:input_type -> chk.CheckReport
	...
	40, // 41: mgmt.MgmtSvc.Join:output_type -> mgmt.JoinResp
	41, // 42: mgmt.MgmtSvc.ClusterEvent:output_type -> shared.ClusterEventResp
	42, // 43: mgmt.MgmtSvc.LeaderQuery:output_type -> mgmt.LeaderQueryResp
	43, // 44: mgmt.MgmtSvc.PoolCreate:output_type -> mgmt.PoolCreateResp
	44, // 45: mgmt.MgmtSvc.PoolDestroy:output_type -> mgmt.PoolDestroyResp
	45, // 46: mgmt.MgmtSvc.PoolEvict:output_type -> mgmt.PoolEvictResp
	46, // 47: mgmt.MgmtSvc.PoolExclude:output_type -> mgmt.PoolExcludeResp
	47, // 48: mgmt.MgmtSvc.PoolDrain:output_type -> mgmt.PoolDrainResp
	48, // 49: mgmt.MgmtSvc.PoolExtend:output_type -> mgmt.PoolExtendResp
	49, // 50: mgmt.MgmtSvc.PoolReintegrate:output_type -> mgmt.PoolReintegrateResp
	50, // 51: mgmt.MgmtSvc.PoolQuery:output_type -> mgmt.PoolQueryResp
	51, // 52: mgmt.MgmtSvc.PoolQueryTarget:output_type -> mgmt.PoolQueryTargetResp
	52, // 53: mgmt.MgmtSvc.PoolSetProp:output_type -> mgmt.PoolSetPropResp
	53, // 54: mgmt.MgmtSvc.PoolGetProp:output_type -> mgmt.PoolGetPropResp
	54, // 55: mgmt.MgmtSvc.PoolGetACL:output_type -> mgmt.ACLResp
	54, // 56: mgmt.MgmtSvc.PoolOverwriteACL:output_type -> mgmt.ACLResp
	54, // 57: mgmt.MgmtSvc.PoolUpdateACL:output_type -> mgmt.ACLResp
	54, // 58: mgmt.MgmtSvc.PoolDeleteACL:output_type -> mgmt.ACLResp
	55, // 59: mgmt.MgmtSvc.GetAttachInfo:output_type -> mgmt.GetAttachInfoResp
	56, // 60: mgmt.MgmtSvc.ListPools:output_type -> mgmt.ListPoolsResp
	57, // 61: mgmt.MgmtSvc.ListContainers:output_type -> mgmt.ListContResp
	58, // 62: mgmt.MgmtSvc.ContSetOwner:output_type -> mgmt.ContSetOwnerResp
	59, // 63: mgmt.MgmtSvc.SystemQuery:output_type -> mgmt.SystemQueryResp
	60, // 64: mgmt.MgmtSvc.SystemStop:output_type -> mgmt.SystemStopResp
	61, // 65: mgmt.MgmtSvc.SystemStart:output_type -> mgmt.SystemStartResp
	62, // 66: mgmt.MgmtSvc.SystemExclude:output_type -> mgmt.SystemExcludeResp
	63, // 67: mgmt.MgmtSvc.SystemErase:output_type -> mgmt.SystemEraseResp
	64, // 68: mgmt.MgmtSvc.SystemCleanup:output_type -> mgmt.SystemCleanupResp
	65, // 69: mgmt.MgmtSvc.SystemCheckEnable:output_type -> mgmt.DaosResp
	65, // 70: mgmt.MgmtSvc.SystemCheckDisable:output_type -> mgmt.DaosResp
	66, // 71: mgmt.MgmtSvc.SystemCheckStart:output_type -> mgmt.CheckStartResp
	67, // 72: mgmt.MgmtSvc.SystemCheckStop:output_type -> mgmt.CheckStopResp
	68, // 73: mgmt.MgmtSvc.SystemCheckQuery:output_type -> mgmt.CheckQueryResp
	69, // 74: mgmt.MgmtSvc.SystemCheckProp:output_type -> mgmt.CheckPropResp
	70, // 75: mgmt.MgmtSvc.SystemCheckRepair:output_type -> mgmt.CheckActResp
	71, // 76: mgmt.MgmtSvc.PoolUpgrade:output_type -> mgmt.PoolUpgradeResp
	65, // 77: mgmt.MgmtSvc.FaultInjectReport:output_type -> mgmt.DaosResp
	65, // 78: mgmt.MgmtSvc.SystemSetAttr:output_type -> mgmt.DaosResp
	72, // 79: mgmt.MgmtSvc.SystemGetAttr:output_type -> mgmt.SystemGetAttrResp
	65, // 80: mgmt.MgmtSvc.SystemSetProp:output_type -> mgmt.DaosResp
	73, // 81: mgmt.MgmtSvc.SystemGetProp:output_type -> mgmt.SystemGetPropResp
