...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x32, 0xd8, 0x0d, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a, 0x04,
	...
	0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0d,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*SystemSetAttrReq)(nil),        // 26: mgmt.SystemSetAttrReq
	(*SystemGetAttrReq)(nil),        // 27: mgmt.SystemGetAttrReq
	(*JoinResp)(nil),                // 28: mgmt.JoinResp
	(*shared.ClusterEventResp)(nil), // 29: shared.ClusterEventResp
	(*LeaderQueryResp)(nil),         // 30: mgmt.LeaderQueryResp
	(*PoolCreateResp)(nil),          // 31: mgmt.PoolCreateResp
	(*PoolDestroyResp)(nil),         // 32: mgmt.PoolDestroyResp
	(*PoolEvictResp)(nil),           // 33: mgmt.PoolEvictResp
	(*PoolExcludeResp)(nil),         // 34: mgmt.PoolExcludeResp
	(*PoolDrainResp)(nil),           // 35: mgmt.PoolDrainResp
	(*PoolExtendResp)(nil),          // 36: mgmt.PoolExtendResp
	(*PoolReintegrateResp)(nil),     // 37: mgmt.PoolReintegrateResp
	(*PoolQueryResp)(nil),           // 38: mgmt.PoolQueryResp
	(*PoolSetPropResp)(nil),         // 39: mgmt.PoolSetPropResp
	(*PoolGetPropResp)(nil),         // 40: mgmt.PoolGetPropResp
	(*ACLResp)(nil),                 // 41: mgmt.ACLResp
	(*GetAttachInfoResp)(nil),       // 42: mgmt.GetAttachInfoResp
	(*ListPoolsResp)(nil),           // 43: mgmt.ListPoolsResp
	(*ListContResp)(nil),            // 44: mgmt.ListContResp
	(*ContSetOwnerResp)(nil),        // 45: mgmt.ContSetOwnerResp
	(*SystemQueryResp)(nil),         // 46: mgmt.SystemQueryResp
	(*SystemStopResp)(nil),          // 47: mgmt.SystemStopResp
	(*SystemStartResp)(nil),         // 48: mgmt.SystemStartResp
	(*SystemEraseResp)(nil),         // 49: mgmt.SystemEraseResp
	(*SystemCleanupResp)(nil),       // 50: mgmt.SystemCleanupResp
	(*PoolUpgradeResp)(nil),         // 51: mgmt.PoolUpgradeResp
	(*DaosResp)(nil),                // 52: mgmt.DaosResp
	(*SystemGetAttrResp)(nil),       // 53: mgmt.SystemGetAttrResp
}
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	26, // 27: mgmt.MgmtSvc.SystemSetAttr:input_type -> mgmt.SystemSetAttrReq
	27, // 28: mgmt.MgmtSvc.SystemGetAttr:input_type -> mgmt.SystemGetAttrReq
	28, // 29: mgmt.MgmtSvc.Join:output_type -> mgmt.JoinResp
	29, // 30: mgmt.MgmtSvc.ClusterEvent:output_type -> shared.ClusterEventResp
	30, // 31: mgmt.MgmtSvc.LeaderQuery:output_type -> mgmt.LeaderQueryResp
	31, // 32: mgmt.MgmtSvc.PoolCreate:output_type -> mgmt.PoolCreateResp
	32, // 33: mgmt.MgmtSvc.PoolDestroy:output_type -> mgmt.PoolDestroyResp
	33, // 34: mgmt.MgmtSvc.PoolEvict:output_type -> mgmt.PoolEvictResp
	34, // 35: mgmt.MgmtSvc.PoolExclude:output_type -> mgmt.PoolExcludeResp
	35, // 36: mgmt.MgmtSvc.PoolDrain:output_type -> mgmt.PoolDrainResp
	36, // 37: mgmt.MgmtSvc.PoolExtend:output_type -> mgmt.PoolExtendResp
	37, // 38: mgmt.MgmtSvc.PoolReintegrate:output_type -> mgmt.PoolReintegrateResp
	38, // 39: mgmt.MgmtSvc.PoolQuery:output_type -> mgmt.PoolQueryResp
	39, // 40: mgmt.MgmtSvc.PoolSetProp:output_type -> mgmt.PoolSetPropResp
	40, // 41: mgmt.MgmtSvc.PoolGetProp:output_type -> mgmt.PoolGetPropResp
	41, // 42: mgmt.MgmtSvc.PoolGetACL:output_type -> mgmt.ACLResp
	41, // 43: mgmt.MgmtSvc.PoolOverwriteACL:output_type -> mgmt.ACLResp
	41, // 44: mgmt.MgmtSvc.PoolUpdateACL:output_type -> mgmt.ACLResp
	41, // 45: mgmt.MgmtSvc.PoolDeleteACL:output_type -> mgmt.ACLResp
	42, // 46: mgmt.MgmtSvc.GetAttachInfo:output_type -> mgmt.GetAttachInfoResp
	43, // 47: mgmt.MgmtSvc.ListPools:output_type -> mgmt.ListPoolsResp
	44, // 48: mgmt.MgmtSvc.ListContainers:output_type -> mgmt.ListContResp
	45, // 49: mgmt.MgmtSvc.ContSetOwner:output_type -> mgmt.ContSetOwnerResp
	46, // 50: mgmt.MgmtSvc.SystemQuery:output_type -> mgmt.SystemQueryResp
	47, // 51: mgmt.MgmtSvc.SystemStop:output_type -> mgmt.SystemStopResp
	48, // 52: mgmt.MgmtSvc.SystemStart:output_type -> mgmt.SystemStartResp
	49, // 53: mgmt.MgmtSvc.SystemErase:output_type -> mgmt.SystemEraseResp
	50, // 54: mgmt.MgmtSvc.SystemCleanup:output_type -> mgmt.SystemCleanupResp
	51, // 55: mgmt.MgmtSvc.PoolUpgrade:output_type -> mgmt.PoolUpgradeResp
	52, // 56: mgmt.MgmtSvc.SystemSetAttr:output_type -> mgmt.DaosResp
	53, // 57: mgmt.MgmtSvc.SystemGetAttr:output_type -> mgmt.SystemGetAttrResp
