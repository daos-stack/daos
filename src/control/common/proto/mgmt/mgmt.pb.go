...
func (JoinResp_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{1, 0}
}
...
func (*JoinReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{0}
}
...
func (*JoinResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{1}
}
...
func (*GetAttachInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{2}
}
...
func (*GetAttachInfoResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{3}
}
...
func (*GetAttachInfoResp_Psr) Descriptor() ([]byte, []int) {
	return fileDescriptor_mgmt_e0bea519ee292f6c, []int{3, 0}
}
...
type MgmtSvcClient interface {
	...
	DestroyPool(ctx context.Context, in *DestroyPoolReq, opts ...grpc.CallOption) (*DaosResponse, error)
...
func (c *mgmtSvcClient) DestroyPool(ctx context.Context, in *DestroyPoolReq, opts ...grpc.CallOption) (*DaosResponse, error) {
...
type MgmtSvcServer interface {
	...
	// Destroy a DAOS pool allocated across a number of ranks
	DestroyPool(context.Context, *DestroyPoolReq) (*DaosResponse, error)
	// Get the information required by libdaos to attach to the system.
...
func init() { proto.RegisterFile("mgmt.proto", fileDescriptor_mgmt_e0bea519ee292f6c) }

var fileDescriptor_mgmt_e0bea519ee292f6c = []byte{
	// 393 bytes of a gzipped FileDescriptorProto
	,
}
