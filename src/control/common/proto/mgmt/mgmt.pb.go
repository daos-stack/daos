...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0x90, 0x0f, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a,
	...
	0x67, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x11, 0x46,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*chk.CheckReport)(nil),         // 30: chk.CheckReport
	...
	(*PoolUpgradeResp)(nil),         // 58: mgmt.PoolUpgradeResp
...
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	30, // 31: mgmt.MgmtSvc.FaultInjectReport:input_type -> chk.CheckReport
	...
	58, // 62: mgmt.MgmtSvc.PoolUpgrade:output_type -> mgmt.PoolUpgradeResp
	59, // 63: mgmt.MgmtSvc.FaultInjectReport:output_type -> mgmt.DaosResp
