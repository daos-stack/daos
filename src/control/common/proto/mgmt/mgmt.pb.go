...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0x92, 0x13, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a,
	...
	0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0f, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x12, 0x12, 0x2e, 0x6d, 0x67, 0x6d, 0x74, 0x2e,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x1a, 0x13, 0x2e, 0x6d,
	0x67, 0x6d, 0x74, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x73,
	...
	0x6f, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0d, 0x53, 0x79, 0x73, 0x74,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*CheckEnableReq)(nil),          // 26: mgmt.CheckEnableReq
	(*CheckDisableReq)(nil),         // 27: mgmt.CheckDisableReq
	(*CheckStartReq)(nil),           // 28: mgmt.CheckStartReq
	(*CheckStopReq)(nil),            // 29: mgmt.CheckStopReq
	(*CheckQueryReq)(nil),           // 30: mgmt.CheckQueryReq
	(*CheckPropReq)(nil),            // 31: mgmt.CheckPropReq
	(*CheckActReq)(nil),             // 32: mgmt.CheckActReq
	(*PoolUpgradeReq)(nil),          // 33: mgmt.PoolUpgradeReq
	(*chk.CheckReport)(nil),         // 34: chk.CheckReport
	...
	(*JoinResp)(nil),                // 39: mgmt.JoinResp
	(*shared.ClusterEventResp)(nil), // 40: shared.ClusterEventResp
	(*LeaderQueryResp)(nil),         // 41: mgmt.LeaderQueryResp
	(*PoolCreateResp)(nil),          // 42: mgmt.PoolCreateResp
	(*PoolDestroyResp)(nil),         // 43: mgmt.PoolDestroyResp
	(*PoolEvictResp)(nil),           // 44: mgmt.PoolEvictResp
	(*PoolExcludeResp)(nil),         // 45: mgmt.PoolExcludeResp
	(*PoolDrainResp)(nil),           // 46: mgmt.PoolDrainResp
	(*PoolExtendResp)(nil),          // 47: mgmt.PoolExtendResp
	(*PoolReintegrateResp)(nil),     // 48: mgmt.PoolReintegrateResp
	(*PoolQueryResp)(nil),           // 49: mgmt.PoolQueryResp
	(*PoolQueryTargetResp)(nil),     // 50: mgmt.PoolQueryTargetResp
	(*PoolSetPropResp)(nil),         // 51: mgmt.PoolSetPropResp
	(*PoolGetPropResp)(nil),         // 52: mgmt.PoolGetPropResp
	(*ACLResp)(nil),                 // 53: mgmt.ACLResp
	(*GetAttachInfoResp)(nil),       // 54: mgmt.GetAttachInfoResp
	(*ListPoolsResp)(nil),           // 55: mgmt.ListPoolsResp
	(*ListContResp)(nil),            // 56: mgmt.ListContResp
	(*ContSetOwnerResp)(nil),        // 57: mgmt.ContSetOwnerResp
	(*SystemQueryResp)(nil),         // 58: mgmt.SystemQueryResp
	(*SystemStopResp)(nil),          // 59: mgmt.SystemStopResp
	(*SystemStartResp)(nil),         // 60: mgmt.SystemStartResp
	(*SystemEraseResp)(nil),         // 61: mgmt.SystemEraseResp
	(*SystemCleanupResp)(nil),       // 62: mgmt.SystemCleanupResp
	(*DaosResp)(nil),                // 63: mgmt.DaosResp
	(*CheckStartResp)(nil),          // 64: mgmt.CheckStartResp
	(*CheckStopResp)(nil),           // 65: mgmt.CheckStopResp
	(*CheckQueryResp)(nil),          // 66: mgmt.CheckQueryResp
	(*CheckPropResp)(nil),           // 67: mgmt.CheckPropResp
	(*CheckActResp)(nil),            // 68: mgmt.CheckActResp
	(*PoolUpgradeResp)(nil),         // 69: mgmt.PoolUpgradeResp
	(*SystemGetAttrResp)(nil),       // 70: mgmt.SystemGetAttrResp
	(*SystemGetPropResp)(nil),       // 71: mgmt.SystemGetPropResp
}
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	26, // 27: mgmt.MgmtSvc.SystemCheckEnable:input_type -> mgmt.CheckEnableReq
	27, // 28: mgmt.MgmtSvc.SystemCheckDisable:input_type -> mgmt.CheckDisableReq
	28, // 29: mgmt.MgmtSvc.SystemCheckStart:input_type -> mgmt.CheckStartReq
	29, // 30: mgmt.MgmtSvc.SystemCheckStop:input_type -> mgmt.CheckStopReq
	30, // 31: mgmt.MgmtSvc.SystemCheckQuery:input_type -> mgmt.CheckQueryReq
	31, // 32: mgmt.MgmtSvc.SystemCheckProp:input_type -> mgmt.CheckPropReq
	32, // 33: mgmt.MgmtSvc.SystemCheckRepair:input_type -> mgmt.CheckActReq
	33, // 34: mgmt.MgmtSvc.PoolUpgrade:input_type -> mgmt.PoolUpgradeReq
	34, // 35: mgmt.MgmtSvc.FaultInjectReport:input_type -> chk.CheckReport
	...
	39, // 40: mgmt.MgmtSvc.Join:output_type -> mgmt.JoinResp
	40, // 41: mgmt.MgmtSvc.ClusterEvent:output_type -> shared.ClusterEventResp
	41, // 42: mgmt.MgmtSvc.LeaderQuery:output_type -> mgmt.LeaderQueryResp
	42, // 43: mgmt.MgmtSvc.PoolCreate:output_type -> mgmt.PoolCreateResp
	43, // 44: mgmt.MgmtSvc.PoolDestroy:output_type -> mgmt.PoolDestroyResp
	44, // 45: mgmt.MgmtSvc.PoolEvict:output_type -> mgmt.PoolEvictResp
	45, // 46: mgmt.MgmtSvc.PoolExclude:output_type -> mgmt.PoolExcludeResp
	46, // 47: mgmt.MgmtSvc.PoolDrain:output_type -> mgmt.PoolDrainResp
	47, // 48: mgmt.MgmtSvc.PoolExtend:output_type -> mgmt.PoolExtendResp
	48, // 49: mgmt.MgmtSvc.PoolReintegrate:output_type -> mgmt.PoolReintegrateResp
	49, // 50: mgmt.MgmtSvc.PoolQuery:output_type -> mgmt.PoolQueryResp
	50, // 51: mgmt.MgmtSvc.PoolQueryTarget:output_type -> mgmt.PoolQueryTargetResp
	51, // 52: mgmt.MgmtSvc.PoolSetProp:output_type -> mgmt.PoolSetPropResp
	52, // 53: mgmt.MgmtSvc.PoolGetProp:output_type -> mgmt.PoolGetPropResp
	53, // 54: mgmt.MgmtSvc.PoolGetACL:output_type -> mgmt.ACLResp
	53, // 55: mgmt.MgmtSvc.PoolOverwriteACL:output_type -> mgmt.ACLResp
	53, // 56: mgmt.MgmtSvc.PoolUpdateACL:output_type -> mgmt.ACLResp
	53, // 57: mgmt.MgmtSvc.PoolDeleteACL:output_type -> mgmt.ACLResp
	54, // 58: mgmt.MgmtSvc.GetAttachInfo:output_type -> mgmt.GetAttachInfoResp
	55, // 59: mgmt.MgmtSvc.ListPools:output_type -> mgmt.ListPoolsResp
	56, // 60: mgmt.MgmtSvc.ListContainers:output_type -> mgmt.ListContResp
	57, // 61: mgmt.MgmtSvc.ContSetOwner:output_type -> mgmt.ContSetOwnerResp
	58, // 62: mgmt.MgmtSvc.SystemQuery:output_type -> mgmt.SystemQueryResp
	59, // 63: mgmt.MgmtSvc.SystemStop:output_type -> mgmt.SystemStopResp
	60, // 64: mgmt.MgmtSvc.SystemStart:output_type -> mgmt.SystemStartResp
	61, // 65: mgmt.MgmtSvc.SystemErase:output_type -> mgmt.SystemEraseResp
	62, // 66: mgmt.MgmtSvc.SystemCleanup:output_type -> mgmt.SystemCleanupResp
	63, // 67: mgmt.MgmtSvc.SystemCheckEnable:output_type -> mgmt.DaosResp
	63, // 68: mgmt.MgmtSvc.SystemCheckDisable:output_type -> mgmt.DaosResp
	64, // 69: mgmt.MgmtSvc.SystemCheckStart:output_type -> mgmt.CheckStartResp
	65, // 70: mgmt.MgmtSvc.SystemCheckStop:output_type -> mgmt.CheckStopResp
	66, // 71: mgmt.MgmtSvc.SystemCheckQuery:output_type -> mgmt.CheckQueryResp
	67, // 72: mgmt.MgmtSvc.SystemCheckProp:output_type -> mgmt.CheckPropResp
	68, // 73: mgmt.MgmtSvc.SystemCheckRepair:output_type -> mgmt.CheckActResp
	69, // 74: mgmt.MgmtSvc.PoolUpgrade:output_type -> mgmt.PoolUpgradeResp
	63, // 75: mgmt.MgmtSvc.FaultInjectReport:output_type -> mgmt.DaosResp
	63, // 76: mgmt.MgmtSvc.SystemSetAttr:output_type -> mgmt.DaosResp
	70, // 77: mgmt.MgmtSvc.SystemGetAttr:output_type -> mgmt.SystemGetAttrResp
	63, // 78: mgmt.MgmtSvc.SystemSetProp:output_type -> mgmt.DaosResp
	71, // 79: mgmt.MgmtSvc.SystemGetProp:output_type -> mgmt.SystemGetPropResp
