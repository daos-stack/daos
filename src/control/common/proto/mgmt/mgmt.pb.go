...
var file_mgmt_mgmt_proto_rawDesc = []byte{
	...
	0x32, 0xdf, 0x0c, 0x0a, 0x07, 0x4d, 0x67, 0x6d, 0x74, 0x53, 0x76, 0x63, 0x12, 0x27, 0x0a, 0x04,
...
var file_mgmt_mgmt_proto_goTypes = []interface{}{
	...
	(*PoolResolveIDResp)(nil),       // 30: mgmt.PoolResolveIDResp
	...
	(*PoolSetPropResp)(nil),         // 38: mgmt.PoolSetPropResp
	(*PoolGetPropResp)(nil),         // 39: mgmt.PoolGetPropResp
	(*ACLResp)(nil),                 // 40: mgmt.ACLResp
	(*GetAttachInfoResp)(nil),       // 41: mgmt.GetAttachInfoResp
	(*ListPoolsResp)(nil),           // 42: mgmt.ListPoolsResp
	(*ListContResp)(nil),            // 43: mgmt.ListContResp
	(*ContSetOwnerResp)(nil),        // 44: mgmt.ContSetOwnerResp
	(*SystemQueryResp)(nil),         // 45: mgmt.SystemQueryResp
	(*SystemStopResp)(nil),          // 46: mgmt.SystemStopResp
	(*SystemStartResp)(nil),         // 47: mgmt.SystemStartResp
	(*SystemEraseResp)(nil),         // 48: mgmt.SystemEraseResp
	(*SystemCleanupResp)(nil),       // 49: mgmt.SystemCleanupResp
}
var file_mgmt_mgmt_proto_depIdxs = []int32{
	...
	30, // 31: mgmt.MgmtSvc.PoolResolveID:output_type -> mgmt.PoolResolveIDResp
	...
	38, // 39: mgmt.MgmtSvc.PoolSetProp:output_type -> mgmt.PoolSetPropResp
	39, // 40: mgmt.MgmtSvc.PoolGetProp:output_type -> mgmt.PoolGetPropResp
	40, // 41: mgmt.MgmtSvc.PoolGetACL:output_type -> mgmt.ACLResp
	40, // 42: mgmt.MgmtSvc.PoolOverwriteACL:output_type -> mgmt.ACLResp
	40, // 43: mgmt.MgmtSvc.PoolUpdateACL:output_type -> mgmt.ACLResp
	40, // 44: mgmt.MgmtSvc.PoolDeleteACL:output_type -> mgmt.ACLResp
	41, // 45: mgmt.MgmtSvc.GetAttachInfo:output_type -> mgmt.GetAttachInfoResp
	42, // 46: mgmt.MgmtSvc.ListPools:output_type -> mgmt.ListPoolsResp
	43, // 47: mgmt.MgmtSvc.ListContainers:output_type -> mgmt.ListContResp
	44, // 48: mgmt.MgmtSvc.ContSetOwner:output_type -> mgmt.ContSetOwnerResp
	45, // 49: mgmt.MgmtSvc.SystemQuery:output_type -> mgmt.SystemQueryResp
	46, // 50: mgmt.MgmtSvc.SystemStop:output_type -> mgmt.SystemStopResp
	47, // 51: mgmt.MgmtSvc.SystemStart:output_type -> mgmt.SystemStartResp
	48, // 52: mgmt.MgmtSvc.SystemErase:output_type -> mgmt.SystemEraseResp
	49, // 53: mgmt.MgmtSvc.SystemCleanup:output_type -> mgmt.SystemCleanupResp
