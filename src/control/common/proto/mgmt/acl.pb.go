...
type ACLResp struct {
	...
	Entries    []string `protobuf:"bytes,2,rep,name=entries,proto3" json:"entries,omitempty"`                         // List of ACEs in short string format
	OwnerUser  string   `protobuf:"bytes,3,opt,name=owner_user,json=ownerUser,proto3" json:"owner_user,omitempty"`    // Name of user that owns the resource
	OwnerGroup string   `protobuf:"bytes,4,opt,name=owner_group,json=ownerGroup,proto3" json:"owner_group,omitempty"` // Name of group that owns the resource
}
...
func (x *ACLResp) GetEntries() []string {
	if x != nil {
		return x.Entries
	}
	return nil
...
var file_mgmt_acl_proto_rawDesc = []byte{
	...
	,
