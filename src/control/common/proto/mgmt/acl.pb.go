...
func (*ACLResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_acl_4b307a9030fc155b, []int{0}
}
...
func (*GetACLReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_acl_4b307a9030fc155b, []int{1}
}
...
func (*ModifyACLReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_acl_4b307a9030fc155b, []int{2}
}
...
func (*DeleteACLReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_acl_4b307a9030fc155b, []int{3}
}
...
func init() { proto.RegisterFile("acl.proto", fileDescriptor_acl_4b307a9030fc155b) }

var fileDescriptor_acl_4b307a9030fc155b = []byte{
