...
type HandleList struct {
	PoolUUID             string   `protobuf:"bytes,1,opt,name=poolUUID,proto3" json:"poolUUID,omitempty"`
	PoolHandles          []string `protobuf:"bytes,2,rep,name=poolHandles,proto3" json:"poolHandles,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *HandleList) Reset()         { *m = HandleList{} }
func (m *HandleList) String() string { return proto.CompactTextString(m) }
func (*HandleList) ProtoMessage()    {}
func (*HandleList) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5747b2e02f0c537, []int{13}
}

func (m *HandleList) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_HandleList.Unmarshal(m, b)
}
func (m *HandleList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_HandleList.Marshal(b, m, deterministic)
}
func (m *HandleList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HandleList.Merge(m, src)
}
func (m *HandleList) XXX_Size() int {
	return xxx_messageInfo_HandleList.Size(m)
}
func (m *HandleList) XXX_DiscardUnknown() {
	xxx_messageInfo_HandleList.DiscardUnknown(m)
}

var xxx_messageInfo_HandleList proto.InternalMessageInfo

func (m *HandleList) GetPoolUUID() string {
	if m != nil {
		return m.PoolUUID
	}
	return ""
...
func (m *HandleList) GetPoolHandles() []string {
	if m != nil {
		return m.PoolHandles
	}
	return nil
}

type PoolHandleCleanupReq struct {
	Handles              []*HandleList `protobuf:"bytes,1,rep,name=handles,proto3" json:"handles,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *PoolHandleCleanupReq) Reset()         { *m = PoolHandleCleanupReq{} }
func (m *PoolHandleCleanupReq) String() string { return proto.CompactTextString(m) }
func (*PoolHandleCleanupReq) ProtoMessage()    {}
func (*PoolHandleCleanupReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5747b2e02f0c537, []int{14}
}

func (m *PoolHandleCleanupReq) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PoolHandleCleanupReq.Unmarshal(m, b)
}
func (m *PoolHandleCleanupReq) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PoolHandleCleanupReq.Marshal(b, m, deterministic)
}
func (m *PoolHandleCleanupReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PoolHandleCleanupReq.Merge(m, src)
}
func (m *PoolHandleCleanupReq) XXX_Size() int {
	return xxx_messageInfo_PoolHandleCleanupReq.Size(m)
}
func (m *PoolHandleCleanupReq) XXX_DiscardUnknown() {
	xxx_messageInfo_PoolHandleCleanupReq.DiscardUnknown(m)
}

var xxx_messageInfo_PoolHandleCleanupReq proto.InternalMessageInfo

func (m *PoolHandleCleanupReq) GetHandles() []*HandleList {
	if m != nil {
		return m.Handles
	}
	return nil
...
type PoolHandleCleanupResp struct {
	Status               int32    `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *PoolHandleCleanupResp) Reset()         { *m = PoolHandleCleanupResp{} }
func (m *PoolHandleCleanupResp) String() string { return proto.CompactTextString(m) }
func (*PoolHandleCleanupResp) ProtoMessage()    {}
func (*PoolHandleCleanupResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5747b2e02f0c537, []int{15}
}

func (m *PoolHandleCleanupResp) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PoolHandleCleanupResp.Unmarshal(m, b)
}
func (m *PoolHandleCleanupResp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PoolHandleCleanupResp.Marshal(b, m, deterministic)
}
func (m *PoolHandleCleanupResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PoolHandleCleanupResp.Merge(m, src)
}
func (m *PoolHandleCleanupResp) XXX_Size() int {
	return xxx_messageInfo_PoolHandleCleanupResp.Size(m)
}
func (m *PoolHandleCleanupResp) XXX_DiscardUnknown() {
	xxx_messageInfo_PoolHandleCleanupResp.DiscardUnknown(m)
}

var xxx_messageInfo_PoolHandleCleanupResp proto.InternalMessageInfo

func (m *PoolHandleCleanupResp) GetStatus() int32 {
	if m != nil {
		return m.Status
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*HandleList)(nil), "mgmt.HandleList")
	proto.RegisterType((*PoolHandleCleanupReq)(nil), "mgmt.PoolHandleCleanupReq")
	proto.RegisterType((*PoolHandleCleanupResp)(nil), "mgmt.PoolHandleCleanupResp")
}
...
var fileDescriptor_e5747b2e02f0c537 = []byte{
	...
	,
}
