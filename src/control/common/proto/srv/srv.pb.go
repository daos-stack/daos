...
var file_srv_srv_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_srv_srv_proto_goTypes = []interface{}{
	...
	(*ListPoolsReq)(nil),        // 6: srv.ListPoolsReq
	(*ListPoolsResp)(nil),       // 7: srv.ListPoolsResp
	(*ListPoolsResp_Pool)(nil),  // 8: srv.ListPoolsResp.Pool
}
var file_srv_srv_proto_depIdxs = []int32{
	8, // 0: srv.ListPoolsResp.pools:type_name -> srv.ListPoolsResp.Pool
