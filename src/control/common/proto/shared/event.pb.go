...
type RASEvent struct {
	...
	HwId      string `protobuf:"bytes,8,opt,name=hw_id,json=hwId,proto3" json:"hw_id,omitempty"`               // (optional) Hardware component involved in event.
	ProcId    uint64 `protobuf:"varint,9,opt,name=proc_id,json=procId,proto3" json:"proc_id,omitempty"`        // (optional) Process involved in event.
	ThreadId  uint64 `protobuf:"varint,10,opt,name=thread_id,json=threadId,proto3" json:"thread_id,omitempty"` // (optional) Thread involved in event.
	JobId     string `protobuf:"bytes,11,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`           // (optional) Job involved in event.
	PoolUuid  string `protobuf:"bytes,12,opt,name=pool_uuid,json=poolUuid,proto3" json:"pool_uuid,omitempty"`  // (optional) Pool UUID involved in event.
	ContUuid  string `protobuf:"bytes,13,opt,name=cont_uuid,json=contUuid,proto3" json:"cont_uuid,omitempty"`  // (optional) Container UUID involved in event.
	ObjId     string `protobuf:"bytes,14,opt,name=obj_id,json=objId,proto3" json:"obj_id,omitempty"`           // (optional) Object involved in event.
	CtlOp     string `protobuf:"bytes,15,opt,name=ctl_op,json=ctlOp,proto3" json:"ctl_op,omitempty"`           // (optional) Recommended automatic action.
...
func (x *RASEvent) GetRankStateInfo() *RASEvent_RankStateEventInfo {
	if x, ok := x.GetExtendedInfo().(*RASEvent_RankStateInfo); ok {
...
type RASEvent_StrInfo struct {
	StrInfo string `protobuf:"bytes,16,opt,name=str_info,json=strInfo,proto3,oneof"` // Opaque data blob.
}
...
func (x *RASEvent_RankStateEventInfo) Reset() {
	*x = RASEvent_RankStateEventInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *RASEvent_RankStateEventInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RASEvent_RankStateEventInfo) ProtoMessage() {}

func (x *RASEvent_RankStateEventInfo) ProtoReflect() protoreflect.Message {
	mi := &file_shared_event_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RASEvent_RankStateEventInfo.ProtoReflect.Descriptor instead.
func (*RASEvent_RankStateEventInfo) Descriptor() ([]byte, []int) {
	return file_shared_event_proto_rawDescGZIP(), []int{0, 0}
}

func (x *RASEvent_RankStateEventInfo) GetInstance() uint32 {
	if x != nil {
		return x.Instance
	}
	return 0
...
func (x *RASEvent_RankStateEventInfo) GetErrored() bool {
	if x != nil {
		return x.Errored
	}
	return false
...
func (x *RASEvent_RankStateEventInfo) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_shared_event_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x22, 0xe5, 0x05, 0x0a,
	...
	,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65,
...
var file_shared_event_proto_goTypes = []interface{}{
	...
	(*RASEvent_RankStateEventInfo)(nil), // 3: shared.RASEvent.RankStateEventInfo
	(*RASEvent_PoolSvcEventInfo)(nil),   // 4: shared.RASEvent.PoolSvcEventInfo
}
var file_shared_event_proto_depIdxs = []int32{
	3, // 0: shared.RASEvent.rank_state_info:type_name -> shared.RASEvent.RankStateEventInfo
...
func file_shared_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shared_event_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RASEvent_RankStateEventInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
