...
type NvmeAddDeviceReq struct {
	...
	PciAddr       string `protobuf:"bytes,1,opt,name=pci_addr,json=pciAddr,proto3" json:"pci_addr,omitempty"` // an NVMe controller PCI address
	EngineIndex   uint32 `protobuf:"varint,2,opt,name=engine_index,json=engineIndex,proto3" json:"engine_index,omitempty"`
	BdevTierIndex uint32 `protobuf:"varint,3,opt,name=bdev_tier_index,json=bdevTierIndex,proto3" json:"bdev_tier_index,omitempty"` // storage config bdev tier to add to
}
...
func (x *NvmeAddDeviceReq) GetBdevTierIndex() uint32 {
	if x != nil {
		return x.BdevTierIndex
	}
	return 0
}
...
var file_ctl_storage_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x78, 0x0a, 0x10, 0x4e, 0x76, 0x6d, 0x65, 0x41, 0x64, 0x64,
	...
	0x6e, 0x65, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x26, 0x0a, 0x0f, 0x62, 0x64, 0x65, 0x76, 0x5f,
	0x74, 0x69, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0d, 0x62, 0x64, 0x65, 0x76, 0x54, 0x69, 0x65, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22,
	0x3d, 0x0a, 0x11, 0x4e, 0x76, 0x6d, 0x65, 0x41, 0x64, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x12, 0x28, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x63, 0x74, 0x6c, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x42, 0x39,
