...
type StorageFormatReq struct {
	...
	EngineIdx     uint32                 `protobuf:"varint,6,opt,name=engine_idx,json=engineIdx,proto3" json:"engine_idx,omitempty"` // Specific engine instance index to format (optional)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StorageFormatReq) GetEngineIdx() uint32 {
	if x != nil {
		return x.EngineIdx
	}
	return 0
