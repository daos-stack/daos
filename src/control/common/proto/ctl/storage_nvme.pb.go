...
type NvmeController_SmdDevice struct {
	...
	ClusterSize uint64  `protobuf:"varint,7,opt,name=cluster_size,json=clusterSize,proto3" json:"cluster_size,omitempty"` // blobstore cluster size in bytes
	TrAddr      string  `protobuf:"bytes,8,opt,name=tr_addr,json=trAddr,proto3" json:"tr_addr,omitempty"`                 // transport address of the blobstore
	DevState    string  `protobuf:"bytes,9,opt,name=dev_state,json=devState,proto3" json:"dev_state,omitempty"`           // NVMe device state
}
...
var file_ctl_storage_nvme_proto_rawDesc = []byte{
	...
	0x79, 0x74, 0x65, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f,
	0x73, 0x69, 0x7a, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x72, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x72, 0x41, 0x64, 0x64, 0x72,
	0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x76, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x09, 0x20,
