...
const (
	...
	CtlSvc_CheckEngineRepair_FullMethodName    = "/ctl.CtlSvc/CheckEngineRepair"
)
...
type CtlSvcClient interface {
	...
	// Send the desired action to repair an inconsistency on a given engine.
	CheckEngineRepair(ctx context.Context, in *CheckEngineActReq, opts ...grpc.CallOption) (*CheckEngineActResp, error)
}
...
func (c *ctlSvcClient) StorageScan(ctx context.Context, in *StorageScanReq, opts ...grpc.CallOption) (*StorageScanResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_StorageScan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) StorageNvmeRebind(ctx context.Context, in *NvmeRebindReq, opts ...grpc.CallOption) (*NvmeRebindResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_StorageNvmeRebind_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) StorageNvmeAddDevice(ctx context.Context, in *NvmeAddDeviceReq, opts ...grpc.CallOption) (*NvmeAddDeviceResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_StorageNvmeAddDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) SmdQuery(ctx context.Context, in *SmdQueryReq, opts ...grpc.CallOption) (*SmdQueryResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_SmdQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) SmdManage(ctx context.Context, in *SmdManageReq, opts ...grpc.CallOption) (*SmdManageResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_SmdManage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) SetEngineLogMasks(ctx context.Context, in *SetLogMasksReq, opts ...grpc.CallOption) (*SetLogMasksResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_SetEngineLogMasks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) PrepShutdownRanks(ctx context.Context, in *RanksReq, opts ...grpc.CallOption) (*RanksResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RanksResp)
	err := c.cc.Invoke(ctx, CtlSvc_PrepShutdownRanks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) StopRanks(ctx context.Context, in *RanksReq, opts ...grpc.CallOption) (*RanksResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RanksResp)
	err := c.cc.Invoke(ctx, CtlSvc_StopRanks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) ResetFormatRanks(ctx context.Context, in *RanksReq, opts ...grpc.CallOption) (*RanksResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RanksResp)
	err := c.cc.Invoke(ctx, CtlSvc_ResetFormatRanks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) StartRanks(ctx context.Context, in *RanksReq, opts ...grpc.CallOption) (*RanksResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RanksResp)
	err := c.cc.Invoke(ctx, CtlSvc_StartRanks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) CollectLog(ctx context.Context, in *CollectLogReq, opts ...grpc.CallOption) (*CollectLogResp, error) {
	...
	err := c.cc.Invoke(ctx, CtlSvc_CollectLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ctlSvcClient) CheckEngineRepair(ctx context.Context, in *CheckEngineActReq, opts ...grpc.CallOption) (*CheckEngineActResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckEngineActResp)
	err := c.cc.Invoke(ctx, CtlSvc_CheckEngineRepair_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CtlSvcServer interface {
	...
	// Send the desired action to repair an inconsistency on a given engine.
	CheckEngineRepair(context.Context, *CheckEngineActReq) (*CheckEngineActResp, error)
	mustEmbedUnimplementedCtlSvcServer()
}

// UnimplementedCtlSvcServer must be embedded to have
...
func (UnimplementedCtlSvcServer) StorageScan(context.Context, *StorageScanReq) (*StorageScanResp, error) {
	return nil, status.Error(codes.Unimplemented, "method StorageScan not implemented")
}
...
func (UnimplementedCtlSvcServer) StorageNvmeAddDevice(context.Context, *NvmeAddDeviceReq) (*NvmeAddDeviceResp, error) {
	return nil, status.Error(codes.Unimplemented, "method StorageNvmeAddDevice not implemented")
}
...
func (UnimplementedCtlSvcServer) SmdManage(context.Context, *SmdManageReq) (*SmdManageResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SmdManage not implemented")
}
func (UnimplementedCtlSvcServer) SetEngineLogMasks(context.Context, *SetLogMasksReq) (*SetLogMasksResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetEngineLogMasks not implemented")
}
func (UnimplementedCtlSvcServer) PrepShutdownRanks(context.Context, *RanksReq) (*RanksResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PrepShutdownRanks not implemented")
}
func (UnimplementedCtlSvcServer) StopRanks(context.Context, *RanksReq) (*RanksResp, error) {
	return nil, status.Error(codes.Unimplemented, "method StopRanks not implemented")
}
func (UnimplementedCtlSvcServer) ResetFormatRanks(context.Context, *RanksReq) (*RanksResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetFormatRanks not implemented")
}
func (UnimplementedCtlSvcServer) StartRanks(context.Context, *RanksReq) (*RanksResp, error) {
	return nil, status.Error(codes.Unimplemented, "method StartRanks not implemented")
}
func (UnimplementedCtlSvcServer) CollectLog(context.Context, *CollectLogReq) (*CollectLogResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectLog not implemented")
}
func (UnimplementedCtlSvcServer) CheckEngineRepair(context.Context, *CheckEngineActReq) (*CheckEngineActResp, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckEngineRepair not implemented")
}
func (UnimplementedCtlSvcServer) mustEmbedUnimplementedCtlSvcServer() {}
func (UnimplementedCtlSvcServer) testEmbeddedByValue()                {}
...
func RegisterCtlSvcServer(s grpc.ServiceRegistrar, srv CtlSvcServer) {
	// If the following call panics, it indicates UnimplementedCtlSvcServer was
...
func _CtlSvc_CheckEngineRepair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckEngineActReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CtlSvcServer).CheckEngineRepair(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CtlSvc_CheckEngineRepair_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CtlSvcServer).CheckEngineRepair(ctx, req.(*CheckEngineActReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CtlSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckEngineRepair",
			Handler:    _CtlSvc_CheckEngineRepair_Handler,
		},
	},
