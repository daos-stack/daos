...
func (*UnimplementedMgmtCtlServer) StorageUpdate(req *StorageUpdateReq, srv MgmtCtl_StorageUpdateServer) error {
	return status.Errorf(codes.Unimplemented, "method StorageUpdate not implemented")
}
func (*UnimplementedMgmtCtlServer) StorageBurnIn(req *StorageBurnInReq, srv MgmtCtl_StorageBurnInServer) error {
	return status.Errorf(codes.Unimplemented, "method StorageBurnIn not implemented")
}
func (*UnimplementedMgmtCtlServer) FetchFioConfigPaths(req *EmptyReq, srv MgmtCtl_FetchFioConfigPathsServer) error {
	return status.Errorf(codes.Unimplemented, "method FetchFioConfigPaths not implemented")
}
func (*UnimplementedMgmtCtlServer) ListFeatures(req *EmptyReq, srv MgmtCtl_ListFeaturesServer) error {
