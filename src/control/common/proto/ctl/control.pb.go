...
type MgmtCtlClient interface {
	...
	RequestDeviceScanStreamer(ctx context.Context, in *DeviceScanRequest, opts ...grpc.CallOption) (MgmtCtl_RequestDeviceScanStreamerClient, error)
}
...
func (c *mgmtCtlClient) RequestDeviceScanStreamer(ctx context.Context, in *DeviceScanRequest, opts ...grpc.CallOption) (MgmtCtl_RequestDeviceScanStreamerClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MgmtCtl_serviceDesc.Streams[5], "/ctl.MgmtCtl/RequestDeviceScanStreamer", opts...)
	if err != nil {
		return nil, err
	}
	x := &mgmtCtlRequestDeviceScanStreamerClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type MgmtCtl_RequestDeviceScanStreamerClient interface {
...
func (x *mgmtCtlRequestDeviceScanStreamerClient) Recv() (*DeviceScanReply, error) {
...
type MgmtCtlServer interface {
	...
	// Perform a fabric scan to determine the available provider, device, NUMA node combinations
	RequestDeviceScanStreamer(*DeviceScanRequest, MgmtCtl_RequestDeviceScanStreamerServer) error
}
...
func _MgmtCtl_RequestDeviceScanStreamer_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DeviceScanRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(MgmtCtlServer).RequestDeviceScanStreamer(m, &mgmtCtlRequestDeviceScanStreamerServer{stream})
}

type MgmtCtl_RequestDeviceScanStreamerServer interface {
	Send(*DeviceScanReply) error
	grpc.ServerStream
}

type mgmtCtlRequestDeviceScanStreamerServer struct {
	grpc.ServerStream
}

func (x *mgmtCtlRequestDeviceScanStreamerServer) Send(m *DeviceScanReply) error {
	return x.ServerStream.SendMsg(m)
}
...
var _MgmtCtl_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "RequestDeviceScanStreamer",
			Handler:       _MgmtCtl_RequestDeviceScanStreamer_Handler,
			ServerStreams: true,
		},
	},
...
func init() { proto.RegisterFile("control.proto", fileDescriptor_control_5f2d31ac97bea903) }

var fileDescriptor_control_5f2d31ac97bea903 = []byte{
	// 327 bytes of a gzipped FileDescriptorProto
	,
}
