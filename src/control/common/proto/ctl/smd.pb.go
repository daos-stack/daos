...
type DevStateResp struct {
	...
	DevState int32  `protobuf:"varint,3,opt,name=dev_state,json=devState,proto3" json:"dev_state,omitempty"` // BIO device state
}
...
func (x *DevStateResp) GetDevState() int32 {
	if x != nil {
		return x.DevState
	}
	return 0
...
func (x *DevReplaceResp) GetDevState() int32 {
	if x != nil {
		return x.DevState
	}
	return 0
...
type SmdDevResp_Device struct {
	...
	BioState int32   `protobuf:"varint,3,opt,name=bio_state,json=bioState,proto3" json:"bio_state,omitempty"`  // BIO device state
...
func (x *SmdDevResp_Device) GetBioState() int32 {
	if x != nil {
		return x.BioState
	}
	return 0
...
func (x *SmdQueryResp_Device) GetBioState() int32 {
	if x != nil {
		return x.BioState
	}
	return 0
...
var file_ctl_smd_proto_rawDesc = []byte{
	...
	0x6f, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x62,
	...
	0x65, 0x76, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x64, 0x65, 0x76, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x62, 0x69, 0x6f, 0x53, 0x74, 0x61,
