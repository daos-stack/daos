...
type DevStateResp struct {
	...
	DevState uint32 `protobuf:"varint,4,opt,name=dev_state,json=devState,proto3" json:"dev_state,omitempty"` // BIO device state
}
...
type SmdDevResp_Device struct {
	...
	BioState uint32  `protobuf:"varint,5,opt,name=bio_state,json=bioState,proto3" json:"bio_state,omitempty"`  // BIO device state
}
...
func (x *SmdDevResp_Device) GetBioState() uint32 {
	if x != nil {
		return x.BioState
	}
	return 0
...
type SmdQueryResp_Device struct {
	...
	BioState uint32         `protobuf:"varint,6,opt,name=bio_state,json=bioState,proto3" json:"bio_state,omitempty"`  // BIO device state
}
...
func (x *SmdQueryResp_Device) GetBioState() uint32 {
	if x != nil {
		return x.BioState
	}
	return 0
...
var file_ctl_smd_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x69, 0x6f, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x62, 0x69, 0x6f, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x70, 0x52, 0x06, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x69, 0x6f,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x62, 0x69,
	0x6f, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x52, 0x05, 0x73, 0x74,
