...
const (
	...
	VmdLedState_QUICK_BLINK VmdLedState = 1 // Equivalent to SPDK_VMD_LED_STATE_IDENTIFY
	VmdLedState_ON          VmdLedState = 2 // Equivalent to SPDK_VMD_LED_STATE_FAULT
	VmdLedState_SLOW_BLINK  VmdLedState = 3 // Equivalent to SPDK_VMD_LED_STATE_REBUILD
	VmdLedState_NA          VmdLedState = 4 // Equivalent to SPDK_VMD_LED_STATE_UNKNOWN
)
...
type DevManageReq_Action int32

const (
	DevManageReq_GET   DevManageReq_Action = 0
	DevManageReq_SET   DevManageReq_Action = 1
	DevManageReq_RESET DevManageReq_Action = 2
)

// Enum value maps for DevManageReq_Action.
var (
	DevManageReq_Action_name = map[int32]string{
		0: "GET",
		1: "SET",
		2: "RESET",
	}
	DevManageReq_Action_value = map[string]int32{
		"GET":   0,
		"SET":   1,
		"RESET": 2,
	}
...
func (x DevManageReq_Action) Enum() *DevManageReq_Action {
	p := new(DevManageReq_Action)
	*p = x
	return p
}

func (x DevManageReq_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DevManageReq_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_ctl_smd_proto_enumTypes[1].Descriptor()
}

func (DevManageReq_Action) Type() protoreflect.EnumType {
	return &file_ctl_smd_proto_enumTypes[1]
}

func (x DevManageReq_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DevManageReq_Action.Descriptor instead.
func (DevManageReq_Action) EnumDescriptor() ([]byte, []int) {
...
func (x *SmdDevice) GetDevState() string {
	if x != nil {
		return x.DevState
	}
	return ""
...
type DevManageReq struct {
	...
	TrAddrs   []string            `protobuf:"bytes,1,rep,name=tr_addrs,json=trAddrs,proto3" json:"tr_addrs,omitempty"`
	DevUuids  []string            `protobuf:"bytes,2,rep,name=dev_uuids,json=devUuids,proto3" json:"dev_uuids,omitempty"`
	LedAction DevManageReq_Action `protobuf:"varint,3,opt,name=led_action,json=ledAction,proto3,enum=ctl.DevManageReq_Action" json:"led_action,omitempty"`
...
func (x *DevManageReq) GetTrAddrs() []string {
	if x != nil {
		return x.TrAddrs
	}
	return nil
...
func (x *DevManageReq) GetDevUuids() []string {
	if x != nil {
		return x.DevUuids
	}
	return nil
...
func (x *DevManageReq) GetLedAction() DevManageReq_Action {
	if x != nil {
		return x.LedAction
	}
	return DevManageReq_GET
}
...
type DevManageResp struct {
	...
	Status  int32                   `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Results []*DevManageResp_Result `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty"`
}
...
func (x *DevManageResp) GetResults() []*DevManageResp_Result {
	if x != nil {
		return x.Results
	}
	return nil
...
type DevManageResp_Result struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DevManageResp_Result) Reset() {
	*x = DevManageResp_Result{}
	if protoimpl.UnsafeEnabled {
...
func (x *DevManageResp_Result) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DevManageResp_Result) ProtoMessage() {}

func (x *DevManageResp_Result) ProtoReflect() protoreflect.Message {
	mi := &file_ctl_smd_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DevManageResp_Result.ProtoReflect.Descriptor instead.
func (*DevManageResp_Result) Descriptor() ([]byte, []int) {
	return file_ctl_smd_proto_rawDescGZIP(), []int{8, 0}
}

func (x *DevManageResp_Result) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *DevManageResp_Result) GetDevice() *SmdDevice {
	if x != nil {
		return x.Device
	}
	return nil
...
var file_ctl_smd_proto_rawDesc = []byte{
	...
	0x22, 0x9d, 0x01, 0x0a, 0x09, 0x53, 0x6d, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x12,
	...
	0x41, 0x64, 0x64, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x76, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x76, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x12, 0x2d, 0x0a, 0x09, 0x6c, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x63, 0x74, 0x6c, 0x2e, 0x56, 0x6d, 0x64, 0x4c, 0x65,
	0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x08, 0x6c, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	0x54, 0x10, 0x02, 0x22, 0xa6, 0x01, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x2e, 0x63, 0x74, 0x6c, 0x2e, 0x44, 0x65, 0x76, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x73, 0x1a, 0x48, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a, 0x06,
	...
	,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4a, 0x04, 0x08,
	0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x9e, 0x03, 0x0a, 0x0b, 0x53, 0x6d,
	...
	0x42, 0x69, 0x6f, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x74,
	0x5f, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x73,
	0x65, 0x74, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x69, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04,
	...
	,
	...
	,
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x74, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_ctl_smd_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_ctl_smd_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_ctl_smd_proto_goTypes = []interface{}{
	(VmdLedState)(0),                         // 0: ctl.VmdLedState
	(DevManageReq_Action)(0),                 // 1: ctl.DevManageReq.Action
	(*BioHealthReq)(nil),                     // 2: ctl.BioHealthReq
	(*BioHealthResp)(nil),                    // 3: ctl.BioHealthResp
	(*SmdDevice)(nil),                        // 4: ctl.SmdDevice
	(*SmdDevReq)(nil),                        // 5: ctl.SmdDevReq
	(*SmdDevResp)(nil),                       // 6: ctl.SmdDevResp
	(*SmdPoolReq)(nil),                       // 7: ctl.SmdPoolReq
	(*SmdPoolResp)(nil),                      // 8: ctl.SmdPoolResp
	(*DevManageReq)(nil),                     // 9: ctl.DevManageReq
	(*DevManageResp)(nil),                    // 10: ctl.DevManageResp
	(*DevReplaceReq)(nil),                    // 11: ctl.DevReplaceReq
	(*DevReplaceResp)(nil),                   // 12: ctl.DevReplaceResp
	(*SmdQueryReq)(nil),                      // 13: ctl.SmdQueryReq
	(*SmdQueryResp)(nil),                     // 14: ctl.SmdQueryResp
	(*SmdPoolResp_Pool)(nil),                 // 15: ctl.SmdPoolResp.Pool
	(*DevManageResp_Result)(nil),             // 16: ctl.DevManageResp.Result
...
var file_ctl_smd_proto_depIdxs = []int32{
	0,  // 0: ctl.SmdDevice.led_state:type_name -> ctl.VmdLedState
	4,  // 1: ctl.SmdDevResp.devices:type_name -> ctl.SmdDevice
	15, // 2: ctl.SmdPoolResp.pools:type_name -> ctl.SmdPoolResp.Pool
	1,  // 3: ctl.DevManageReq.led_action:type_name -> ctl.DevManageReq.Action
	0,  // 4: ctl.DevManageReq.led_state:type_name -> ctl.VmdLedState
	16, // 5: ctl.DevManageResp.results:type_name -> ctl.DevManageResp.Result
	4,  // 6: ctl.DevReplaceResp.device:type_name -> ctl.SmdDevice
	19, // 7: ctl.SmdQueryResp.ranks:type_name -> ctl.SmdQueryResp.RankResp
	4,  // 8: ctl.DevManageResp.Result.device:type_name -> ctl.SmdDevice
	4,  // 9: ctl.SmdQueryResp.SmdDeviceWithHealth.details:type_name -> ctl.SmdDevice
	3,  // 10: ctl.SmdQueryResp.SmdDeviceWithHealth.health:type_name -> ctl.BioHealthResp
...
func file_ctl_smd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ctl_smd_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DevManageResp_Result); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
