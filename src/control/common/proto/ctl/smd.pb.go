...
type SmdQueryReq struct {
	...
	Identify         bool   `protobuf:"varint,10,opt,name=identify,proto3" json:"identify,omitempty"`                                          // set the LED state to quickly blink
	...
	ResetLed         bool   `protobuf:"varint,13,opt,name=reset_led,json=resetLed,proto3" json:"reset_led,omitempty"`                          // for resetting LED, debug only
	GetLed           bool   `protobuf:"varint,14,opt,name=get_led,json=getLed,proto3" json:"get_led,omitempty"`                                // get LED state of devices
...
type LedManageReq struct {
	...
	LedState  LedState  `protobuf:"varint,4,opt,name=led_state,json=ledState,proto3,enum=ctl.LedState" json:"led_state,omitempty"`     // LED control case
}
...
type SmdManageResp struct {
	...
	Status int32                     `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"` // DAOS error code
	Ranks  []*SmdManageResp_RankResp `protobuf:"bytes,2,rep,name=ranks,proto3" json:"ranks,omitempty"`    // List of per-rank responses
}
...
func (x *SmdManageResp) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *SmdManageResp_RankResp) GetDevices() []*SmdDevice {
	if x != nil {
		return x.Devices
	}
	return nil
...
var file_ctl_smd_proto_rawDesc = []byte{
	...
	0x22, 0xa6, 0x02, 0x0a, 0x09, 0x53, 0x6d, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x12,
	...
	0x74, 0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x09, 0x6c, 0x65, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x63, 0x74, 0x6c, 0x2e, 0x4c, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x04, 0x72, 0x61, 0x6e, 0x6b, 0x22, 0x0b, 0x0a, 0x09, 0x53, 0x6d, 0x64,
	...
	0x6c, 0x6f, 0x62, 0x73, 0x22, 0x9e, 0x03, 0x0a, 0x0b, 0x53, 0x6d, 0x64, 0x51, 0x75, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x4e, 0x4b, 0x10, 0x03, 0x12, 0x06, 0x0a, 0x02, 0x4e, 0x41, 0x10, 0x04, 0x2a, 0x28, 0x0a, 0x09,
	0x4c, 0x65, 0x64, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x07, 0x0a, 0x03, 0x47, 0x45, 0x54,
	0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x45, 0x54, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x52,
	0x45, 0x53, 0x45, 0x54, 0x10, 0x02, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_ctl_smd_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_ctl_smd_proto_goTypes = []interface{}{
	...
	(*SmdManageResp_RankResp)(nil),           // 22: ctl.SmdManageResp.RankResp
}
var file_ctl_smd_proto_depIdxs = []int32{
	...
	22, // 11: ctl.SmdManageResp.ranks:type_name -> ctl.SmdManageResp.RankResp
	...
	5,  // 16: ctl.SmdManageResp.RankResp.devices:type_name -> ctl.SmdDevice
