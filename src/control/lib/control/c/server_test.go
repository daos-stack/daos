...
func TestControlC_ServerSetLogmasks(t *testing.T) {
...
func TestControlC_ServerSetLogmasksInvalidHandle(t *testing.T) {
...
func TestControlC_ServerSetLogmasksHostFilter(t *testing.T) {
	for name, tc := range map[string]struct {
		host     string
		wantList []string
	}{
