...
func TestControlC_StorageDeviceList(t *testing.T) {
...
func TestControlC_StorageSetNVMeFault(t *testing.T) {
	for name, tc := range map[string]struct {
		mic   *control.MockInvokerConfig
		host  string
		expRC int
...
func TestControlC_StorageQueryDeviceHealth(t *testing.T) {
	for name, tc := range map[string]struct {
		mic      *control.MockInvokerConfig
		host     string
		statsKey string
...
func TestControlC_ExtractHealthStat(t *testing.T) {
	stats := struct {
...
func TestControlC_StorageDeviceListPopulated(t *testing.T) {
...
func TestControlC_StorageQueryDeviceHealthPopulated(t *testing.T) {
...
func TestControlC_StorageQueryDeviceHealthSeparateBuffers(t *testing.T) {
	devUUIDStr := "00000000-0000-0000-0000-000000000001"
...
func TestControlC_StorageDeviceListUndersizedBuffer(t *testing.T) {
	devs := []*ctlpb.SmdDevice{
		{
...
func TestControlC_StorageDeviceListHostPortStrip(t *testing.T) {
	for name, tc := range map[string]struct {
		respHost string
		expHost  string
	}{
...
func TestControlC_StorageDeviceListAbsentCtrlr(t *testing.T) {
	devs := []*ctlpb.SmdDevice{
		{
...
func TestControlC_StorageDeviceListHostFilter(t *testing.T) {
	for name, tc := range map[string]struct {
		host     string
		wantList []string
	}{
...
func TestControlC_StorageDeviceListErrorResetsNdisks(t *testing.T) {
	log, buf := logging.NewTestLogger(t.Name())
	defer test.ShowBufferOnFailure(t, buf)
...
func TestControlC_StorageOperationsInvalidHandle(t *testing.T) {
	devUUID := uuid.MustParse("12345678-1234-1234-1234-123456789abc")
