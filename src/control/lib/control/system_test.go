...
func TestControl_SystemErase(t *testing.T) {
	member1 := st.MockMember(t, 1, system.MemberStateAwaitFormat)
	member3 := st.MockMember(t, 3, system.MemberStateAwaitFormat)
	member3.Addr = member1.Addr
	member2 := st.MockMember(t, 2, system.MemberStateAwaitFormat)
	member4 := st.MockMember(t, 4, system.MemberStateAwaitFormat)
	member4.Addr = member2.Addr
	member5 := st.MockMember(t, 5, system.MemberStateAwaitFormat)
	member6 := st.MockMember(t, 6, system.MemberStateAwaitFormat)
	member6.Addr = member5.Addr
	member7 := st.MockMember(t, 7, system.MemberStateAwaitFormat)
	member8 := st.MockMember(t, 8, system.MemberStateAwaitFormat)
