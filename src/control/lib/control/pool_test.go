...
func TestControl_PoolQueryResp_MarshallJSON(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"null rankset": {
			...
			exp: `{"enabled_ranks":null,"disabled_ranks":null,"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_engines":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
		},
		"valid rankset": {
			pqr: &PoolQueryResp{
				Status: 0,
			...
			exp: `{"enabled_ranks":[0,1,2,3,5],"disabled_ranks":[],"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_engines":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
		},
	} {
		t.Run(name, func(t *testing.T) {
...
func TestControl_PoolQueryResp_UnmarshallJSON(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"null rankset": {
			data: `{"enabled_ranks":null,"disabled_ranks":null,"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_engines":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
			expResp: PoolQueryResp{
				Status: 0,
				UUID:   "foo",
				PoolInfo: PoolInfo{
		...
		"valid rankset": {
			data: `{"enabled_ranks":"[0,1-3,5]","disabled_ranks":"[]","status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_engines":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
			expResp: PoolQueryResp{
				Status: 0,
				UUID:   "foo",
				PoolInfo: PoolInfo{
		...
		"invalid rankset": {
			data:   `{"enabled_ranks":"a cow goes quack","disabled_ranks":null,"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_engines":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
