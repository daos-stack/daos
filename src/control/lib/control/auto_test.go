...
func TestControl_AutoConfig_correctSSDCounts(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		//			},
		//		},
		//		"allow imbalance with VMD accepts imbalance": {
		//			sd: storageDetails{
		//				NumaSCMs: numaSCMsMap{
		//					0: []string{"/dev/pmem0"},
		//					1: []string{"/dev/pmem1"},
		...
		//					1: hardware.MustNewPCIAddressSet(test.MockVMDPCIAddrs(13, 1, 2)...),
		//				},
		//			},
		//			allowImbalance: true,
		//			expSD: storageDetails{
		...
		//					1: []string{"/dev/pmem1"},
		//				},
		//				// VMD domains kept on original NUMA nodes, imbalance accepted
		//				NumaSSDs: numaSSDsMap{
		//					0: hardware.MustNewPCIAddressSet(test.MockVMDPCIAddrs(5, 2, 4)...),
		//					1: hardware.MustNewPCIAddressSet(test.MockVMDPCIAddrs(13, 1, 2)...),
		//				},
