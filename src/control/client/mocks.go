...
func (m *mockMgmtSvcClient) ListPools(ctx context.Context, req *mgmtpb.PoolListReq, o ...grpc.CallOption) (*mgmtpb.PoolListResp, error) {
	// return successful list pools results
	return &mgmtpb.PoolListResp{}, nil
}
