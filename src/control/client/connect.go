...
type Connect interface {
	...
	PoolCreate(*logging.LeveledLogger, uint64, uint64, string, uint32, string, string, string) (string, string, error)
	PoolDestroy(*logging.LeveledLogger, string, bool) error
}
