...
// returns an error.
//
// Unparsable PEM blocks are preserved in the output bundle so this
...
// CountPEMCerts counts the number of CERTIFICATE blocks in a PEM bundle.
// Non-CERTIFICATE blocks and unparsable bytes do not contribute to the
// count. Used to enforce bundle entry limits before append.
