...
type AuthArgs struct {
	...
	Flavor Flavor `protobuf:"varint,1,opt,name=flavor,proto3,enum=auth.Flavor" json:"flavor,omitempty"` // flavor of this request
	Data   []byte `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`                       // data for authentication
}
...
func (x *AuthArgs) GetFlavor() Flavor {
	if x != nil {
		return x.Flavor
	}
	return Flavor_AUTH_NONE
...
// GetCredResp represents the result of a request to fetch authentication
// credentials.
type GetValidAuthResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Status           int32    `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`                                             // Status of the request
	ValidAuthFlavors []Flavor `protobuf:"varint,2,rep,packed,name=validAuthFlavors,proto3,enum=auth.Flavor" json:"validAuthFlavors,omitempty"` // Auth flavors accepted by agent/server
}

func (x *GetValidAuthResp) Reset() {
	*x = GetValidAuthResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetValidAuthResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetValidAuthResp) ProtoMessage() {}

func (x *GetValidAuthResp) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetValidAuthResp.ProtoReflect.Descriptor instead.
func (*GetValidAuthResp) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{5}
}

func (x *GetValidAuthResp) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *GetValidAuthResp) GetValidAuthFlavors() []Flavor {
	if x != nil {
		return x.ValidAuthFlavors
	}
	return nil
}
...
var file_auth_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x6e, 0x2a, 0x32, 0x0a, 0x06, 0x46, 0x6c, 0x61, 0x76, 0x6f, 0x72, 0x12, 0x0d, 0x0a, 0x09,
	0x41, 0x55, 0x54, 0x48, 0x5f, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x41,
	0x55, 0x54, 0x48, 0x5f, 0x53, 0x59, 0x53, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x55, 0x54,
	0x48, 0x5f, 0x41, 0x4d, 0x10, 0x02, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_auth_proto_goTypes = []interface{}{
	...
	(*AuthArgs)(nil),         // 4: auth.AuthArgs
	(*GetCredResp)(nil),      // 5: auth.GetCredResp
	(*GetValidAuthResp)(nil), // 6: auth.GetValidAuthResp
	(*ValidateCredReq)(nil),  // 7: auth.ValidateCredReq
	(*ValidateCredResp)(nil), // 8: auth.ValidateCredResp
}
var file_auth_proto_depIdxs = []int32{
	...
	0, // 3: auth.AuthArgs.flavor:type_name -> auth.Flavor
	3, // 4: auth.GetCredResp.cred:type_name -> auth.Credential
	0, // 5: auth.GetValidAuthResp.validAuthFlavors:type_name -> auth.Flavor
	3, // 6: auth.ValidateCredReq.cred:type_name -> auth.Credential
	1, // 7: auth.ValidateCredResp.token:type_name -> auth.Token
