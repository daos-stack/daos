...
type GetCredReq struct {
	...
	HandleUuid []byte `protobuf:"bytes,2,opt,name=handle_uuid,json=handleUuid,proto3" json:"handle_uuid,omitempty"`
}
...
type GetCredResp struct {
	...
	NodeCertPop     []byte      `protobuf:"bytes,4,opt,name=node_cert_pop,json=nodeCertPop,proto3" json:"node_cert_pop,omitempty"`
	NodeCertPayload []byte      `protobuf:"bytes,5,opt,name=node_cert_payload,json=nodeCertPayload,proto3" json:"node_cert_payload,omitempty"`
}
...
type ValidateNodeCertReq struct {
	...
	NodeCertPop     []byte `protobuf:"bytes,3,opt,name=node_cert_pop,json=nodeCertPop,proto3" json:"node_cert_pop,omitempty"`
	NodeCertPayload []byte `protobuf:"bytes,4,opt,name=node_cert_payload,json=nodeCertPayload,proto3" json:"node_cert_payload,omitempty"`
