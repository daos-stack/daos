...
// "tenant:<suffix>"). Suffix is restricted to the set [A-Za-z0-9._-],
// alphanumeric at both ends, no doubled separators. As the suffix
// may be used as a path component, in a watermark, and as a cert CN,
// this is the most restrictive set of characters that works for all three
// use cases.
