...
func TestSecurity_ComponentHasAccess(t *testing.T) {
	...
	testCases := map[string][]Component{
		...
		"/mgmt.MgmtSvc/FaultsAddFinding":        {ComponentAdmin},
		"/mgmt.MgmtSvc/SystemCheckerAbort":      {ComponentAdmin},
		"/mgmt.MgmtSvc/SystemCheckerAckFinding": {ComponentAdmin},
		"/mgmt.MgmtSvc/SystemCheckerQuery":      {ComponentAdmin},
		"/mgmt.MgmtSvc/SystemCheckerReset":      {ComponentAdmin},
		"/mgmt.MgmtSvc/SystemCheckerStart":      {ComponentAdmin},
