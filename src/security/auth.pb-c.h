...
typedef struct Auth__Token Auth__Token;
typedef struct Auth__Sys Auth__Sys;
typedef struct Auth__Credential Auth__Credential;
typedef struct Auth__AuthArgs Auth__AuthArgs;
typedef struct Auth__GetCredResp Auth__GetCredResp;
typedef struct Auth__GetValidAuthResp Auth__GetValidAuthResp;
typedef struct Auth__ValidateCredReq Auth__ValidateCredReq;
typedef struct Auth__ValidateCredResp Auth__ValidateCredResp;
...
struct  Auth__AuthArgs
{
  ProtobufCMessage base;
  /*
   * flavor of this request
   */
  Auth__Flavor flavor;
  /*
...
#define AUTH__AUTH_ARGS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&auth__auth_args__descriptor) \
    , AUTH__FLAVOR__AUTH_NONE, {0,NULL} }
...
struct  Auth__GetValidAuthResp
{
  ...
  int32_t status;
  /*
   * Auth flavors accepted by agent/server
   */
  size_t n_validauthflavors;
  Auth__Flavor *validauthflavors;
};
#define AUTH__GET_VALID_AUTH_RESP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&auth__get_valid_auth_resp__descriptor) \
    , 0, 0,NULL }
...
void   auth__get_cred_resp__free_unpacked
                     (Auth__GetCredResp *message,
                      ProtobufCAllocator *allocator);
/* Auth__GetValidAuthResp methods */
...
typedef void (*Auth__Credential_Closure)
                 (const Auth__Credential *message,
                  void *closure_data);
typedef void (*Auth__AuthArgs_Closure)
                 (const Auth__AuthArgs *message,
                  void *closure_data);
typedef void (*Auth__GetCredResp_Closure)
                 (const Auth__GetCredResp *message,
                  void *closure_data);
typedef void (*Auth__GetValidAuthResp_Closure)
                 (const Auth__GetValidAuthResp *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor auth__auth_args__descriptor;
extern const ProtobufCMessageDescriptor auth__get_cred_resp__descriptor;
extern const ProtobufCMessageDescriptor auth__get_valid_auth_resp__descriptor;
