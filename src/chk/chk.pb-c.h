 ...
 */
typedef enum _Chk__CheckResult {
  CHK__CHECK_RESULT__SUCCESS = 0,
  CHK__CHECK_RESULT__DRY_RUN = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CHK__CHECK_RESULT)
} Chk__CheckResult;
...
extern const ProtobufCEnumDescriptor    chk__check_result__descriptor;
