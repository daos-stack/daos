...
uint32_t
chk_ins_merge_status(uint32_t status_a, uint32_t status_b)
{
	...
	if (status_a == CHK__CHECK_INST_STATUS__CIS_INIT ||
	...
	D_ASSERTF(status_a == CHK__CHECK_INST_STATUS__CIS_PAUSED &&
