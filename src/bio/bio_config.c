...
/* Caller responsible for freeing json_config_ctx after config_entry has been used */
static int
decode_daos_data(struct json_config_ctx *ctx, const char *method_name, struct config_entry *cfg)
{
