...
typedef struct Ctl__BioHealthReq Ctl__BioHealthReq;
typedef struct Ctl__BioHealthResp Ctl__BioHealthResp;
typedef struct Ctl__NvmeController Ctl__NvmeController;
typedef struct Ctl__NvmeController__Namespace Ctl__NvmeController__Namespace;
typedef struct Ctl__SmdDevice Ctl__SmdDevice;
typedef struct Ctl__SmdDevReq Ctl__SmdDevReq;
typedef struct Ctl__SmdDevResp Ctl__SmdDevResp;
typedef struct Ctl__SmdPoolReq Ctl__SmdPoolReq;
typedef struct Ctl__SmdPoolResp Ctl__SmdPoolResp;
typedef struct Ctl__SmdPoolResp__Pool Ctl__SmdPoolResp__Pool;
typedef struct Ctl__SmdQueryReq Ctl__SmdQueryReq;
typedef struct Ctl__SmdQueryResp Ctl__SmdQueryResp;
typedef struct Ctl__SmdQueryResp__Pool Ctl__SmdQueryResp__Pool;
typedef struct Ctl__SmdQueryResp__RankResp Ctl__SmdQueryResp__RankResp;
typedef struct Ctl__LedManageReq Ctl__LedManageReq;
typedef struct Ctl__DevReplaceReq Ctl__DevReplaceReq;
typedef struct Ctl__SetFaultyReq Ctl__SetFaultyReq;
typedef struct Ctl__DevManageResp Ctl__DevManageResp;
typedef struct Ctl__SmdManageReq Ctl__SmdManageReq;
typedef struct Ctl__SmdManageResp Ctl__SmdManageResp;
typedef struct Ctl__SmdManageResp__Result Ctl__SmdManageResp__Result;
typedef struct Ctl__SmdManageResp__RankResp Ctl__SmdManageResp__RankResp;
 ...
 */
struct  Ctl__NvmeController__Namespace
{
  ProtobufCMessage base;
  /*
   * namespace id
...
struct  Ctl__SmdQueryResp__Pool
{
  ProtobufCMessage base;
  /*
   * UUID of VOS pool
...
struct  Ctl__SmdQueryResp__RankResp
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  CTL__SMD_MANAGE_REQ__OP_FAULTY = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(CTL__SMD_MANAGE_REQ__OP__CASE)
} Ctl__SmdManageReq__OpCase;

struct  Ctl__SmdManageReq
{
  ProtobufCMessage base;
...
struct  Ctl__SmdManageResp__Result
{
  ProtobufCMessage base;
  /*
   * DAOS error code
...
struct  Ctl__SmdManageResp__RankResp
{
  ProtobufCMessage base;
  /*
   * Rank to which this response corresponds
