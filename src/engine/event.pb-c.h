...
typedef struct Shared__RASEvent Shared__RASEvent;
typedef struct Shared__RASEvent__EngineStateEventInfo Shared__RASEvent__EngineStateEventInfo;
typedef struct Shared__RASEvent__PoolSvcEventInfo Shared__RASEvent__PoolSvcEventInfo;
typedef struct Shared__ClusterEventReq Shared__ClusterEventReq;
typedef struct Shared__ClusterEventResp Shared__ClusterEventResp;
 ...
 */
struct  Shared__RASEvent__EngineStateEventInfo
{
 ...
 */
struct  Shared__RASEvent__PoolSvcEventInfo
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  SHARED__RASEVENT__EXTENDED_INFO_POOL_SVC_INFO = 19
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SHARED__RASEVENT__EXTENDED_INFO__CASE)
} Shared__RASEvent__ExtendedInfoCase;

/*
 * RASEvent describes a RAS event in the DAOS system.
 */
struct  Shared__RASEvent
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Shared__ClusterEventReq
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Shared__ClusterEventResp
{
  ProtobufCMessage base;
  /*
   * Sequence identifier for RAS events.
