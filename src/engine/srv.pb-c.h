...
typedef struct Srv__CheckDeregPoolReq Srv__CheckDeregPoolReq;
...
typedef struct Srv__ListPoolsReq Srv__ListPoolsReq;
typedef struct Srv__ListPoolsResp Srv__ListPoolsResp;
typedef struct Srv__ListPoolsResp__Pool Srv__ListPoolsResp__Pool;
...
struct  Srv__ListPoolsResp__Pool
{
  ProtobufCMessage base;
  /*
   * Pool UUID
