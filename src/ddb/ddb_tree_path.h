 ...
 * structure stores the a part's value and index, while the dv_indexed_tree_path structure contains
...
bool itp_part_value_set(struct dv_indexed_tree_path *itp, path_parts_e part_key, void *part_value);
...
int itp_idx(struct dv_indexed_tree_path *itp, path_parts_e part_key);

/* path part has both index and part_value */
bool itp_has_complete(struct dv_indexed_tree_path *itp, path_parts_e part_key);

/* path part has either index or part_value */
bool itp_has(struct dv_indexed_tree_path *itp, path_parts_e part_key);

/* path part has an index */
bool itp_has_idx(struct dv_indexed_tree_path *itp, path_parts_e part_key);

/* path part has a part value */
bool itp_has_part_value(struct dv_indexed_tree_path *itp, path_parts_e part_key);
...
union itp_part_type *itp_part(struct dv_indexed_tree_path *itp, path_parts_e path_key);
