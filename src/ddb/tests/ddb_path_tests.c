...
path_parts_partial_behavior(void **state)
{
	...
	itp_set_cont_part(&itp, g_uuids[0]);
	itp_print_full(&g_ctx, &itp);
...
parse_path_from_printed_path(void **state)
{
	...
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_int_equal(itp.itp_parts[PATH_PART_CONT].itp_idx,
			 itp_out.itp_parts[PATH_PART_CONT].itp_idx);
	dvt_fake_print_reset();
	itp_free(&itp_out);

	itp_print_parts(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_uuid_equal(itp.itp_parts[PATH_PART_CONT].itp_name.itp_uuid,
			  itp_out.itp_parts[PATH_PART_CONT].itp_name.itp_uuid);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	itp_print_indexes(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_int_equal(itp.itp_parts[PATH_PART_OBJ].itp_idx,
			 itp_out.itp_parts[PATH_PART_OBJ].itp_idx);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	assert_uoid_equal(itp.itp_parts[PATH_PART_OBJ].itp_name.itp_oid,
			  itp_out.itp_parts[PATH_PART_OBJ].itp_name.itp_oid);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	itp_print_indexes(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_int_equal(itp.itp_parts[PATH_PART_DKEY].itp_idx,
			 itp_out.itp_parts[PATH_PART_DKEY].itp_idx);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	assert_key_equal(itp.itp_parts[PATH_PART_DKEY].itp_name.itp_key,
			  itp_out.itp_parts[PATH_PART_DKEY].itp_name.itp_key);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	itp_print_indexes(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_int_equal(itp.itp_parts[PATH_PART_AKEY].itp_idx,
			 itp_out.itp_parts[PATH_PART_AKEY].itp_idx);
	dvt_fake_print_reset();
	itp_free(&itp_out);

	itp_print_parts(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_key_equal(itp.itp_parts[PATH_PART_AKEY].itp_name.itp_key,
			  itp_out.itp_parts[PATH_PART_AKEY].itp_name.itp_key);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	itp_print_indexes(&g_ctx, &itp);
	assert_success(itp_parse(dvt_fake_print_buffer, &itp_out));
	assert_int_equal(itp.itp_parts[PATH_PART_RECX].itp_idx,
			 itp_out.itp_parts[PATH_PART_RECX].itp_idx);
	dvt_fake_print_reset();
	itp_free(&itp_out);
	...
	assert_recx_equal(itp.itp_parts[PATH_PART_RECX].itp_name.itp_recx,
			  itp_out.itp_parts[PATH_PART_RECX].itp_name.itp_recx);
	dvt_fake_print_reset();
