...
static void Test4(void)
{
	...
	ConfigAddString(cfg, CONFIG_SECTION_FLAT, "Mehmet Akif ERSOY",
			"Safahat");
	ConfigAddString(cfg, CONFIG_SECTION_FLAT, "Necip Fazil KISAKUREK",
			"Cile");
 ...
 * /////////////////////////////////////////////////////////////
 */
	ConfigReadString(cfg, CONFIG_SECTION_FLAT, "Mehmet Akif Ersoy",
			 s, sizeof(s), "Poet");
