...
static const struct CMUnitTest vea_uts[] = {
    {.name = "vea_format", .test_func = ut_format},
    {.name = "vea_load", .test_func = ut_load},
    {.name = "vea_query", .test_func = ut_query},
    {.name = "vea_hint_load", .test_func = ut_hint_load},
    {.name = "vea_reserve", .test_func = ut_reserve},
    {.name = "vea_cancel", .test_func = ut_cancel},
    {.name = "vea_tx_publish", .test_func = ut_tx_publish},
    {.name = "vea_free", .test_func = ut_free},
    {.name = "vea_hint_unload", .test_func = ut_hint_unload},
    {.name = "vea_unload", .test_func = ut_unload},
    {.name = "vea_reserve_special", .test_func = ut_reserve_special},
    {.name = "vea_inval_params_format", .test_func = ut_inval_params_format},
    {.name = "vea_inval_params_load", .test_func = ut_inval_params_load},
    {.name = "vea_inval_param_reserve", .test_func = ut_inval_params_reserve},
    {.name = "vea_inval_param_cancel", .test_func = ut_inval_params_cancel},
    {.name = "vea_inval_param_tx_publish", .test_func = ut_inval_params_tx_publish},
    {.name = "vea_inval_param_free", .test_func = ut_inval_params_free},
    {.name = "vea_inval_param_hint_load", .test_func = ut_inval_params_hint_load},
    {.name = "vea_inval_param_set_ext_age", .test_func = ut_inval_params_set_ext_age},
    {.name = "vea_inval_param_get_ext_vector", .test_func = ut_inval_params_get_ext_vector},
    {.name = "vea_free_invalid_space", .test_func = ut_free_invalid_space},
    {.name = "vea_interleaved_ops", .test_func = ut_interleaved_ops},
    {.name = "vea_fragmentation", .test_func = ut_fragmentation}};
