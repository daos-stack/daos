...
//int
//set_pool_svc_ranks(uuid_t pool_uuid, d_rank_list_t **svc_ranks)
//{
//	Srv__GetPoolSvcReq	gps_req = SRV__SET_POOL_SVC_REQ__INIT;
//	Srv__GetPoolSvcResp	*gps_resp = NULL;
//	Drpc__Call		*dreq;
//	Drpc__Response		*dresp;
//	uint8_t			*req;
...
//		DP_UUID(pool_uuid));
//
//	req_size = srv__set_pool_svc_req__get_packed_size(&gps_req);
//	D_ALLOC(req, req_size);
//	if (req == NULL)
//		D_GOTO(out_uuid, rc = -DER_NOMEM);
//
//	srv__set_pool_svc_req__pack(&gps_req, req);
//	rc = drpc_call_create(dss_drpc_ctx, DRPC_MODULE_SRV,
//			      DRPC_METHOD_SRV_SET_POOL_SVC, &dreq);
//	if (rc != 0) {
//		D_FREE(req);
//		goto out_uuid;
//	}
...
//	}
//
//	gps_resp = srv__set_pool_svc_resp__unpack(
//			NULL, dresp->body.len, dresp->body.data);
//	if (gps_resp == NULL) {
//		D_ERROR("failed to unpack resp (get pool svc)\n");
//		D_GOTO(out_dresp, rc = -DER_NOMEM);
