...
{
  {
    ...
    offsetof(Mgmt__PoolSvcEventInfo, svc_reps),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
