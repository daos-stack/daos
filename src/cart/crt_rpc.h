...
#define CRT_IV_RPCS_LIST                                                                           \
	X(CRT_OPC_IV_FETCH, 0, &CQF_crt_iv_fetch, crt_hdlr_iv_fetch, NULL)                         \
	X(CRT_OPC_IV_UPDATE, 0, &CQF_crt_iv_update, crt_hdlr_iv_update, NULL)                      \
	X(CRT_OPC_IV_SYNC, 0, &CQF_crt_iv_sync, crt_hdlr_iv_sync, &crt_iv_sync_co_ops)
...
enum {
	__FIRST_INTERNAL = CRT_PROTO_OPC(CRT_OPC_INTERNAL_BASE, CRT_PROTO_INTERNAL_VERSION, 0) - 1,
	CRT_INTERNAL_RPCS_LIST
};

/* CRT fault injection opcode definitions, must be 0xFF00xxxx.*/
#define CRT_OPC_FI_BASE 0xF1000000UL
enum { __FIRST_FI = CRT_PROTO_OPC(CRT_OPC_FI_BASE, CRT_PROTO_FI_VERSION, 0) - 1, CRT_FI_RPCS_LIST };

/* CRT self-test opcode definitions, must be 0xFF00xxxx.*/
#define CRT_OPC_ST_BASE 0xF2000000UL
enum { __FIRST_ST = CRT_PROTO_OPC(CRT_OPC_ST_BASE, CRT_PROTO_ST_VERSION, 0) - 1, CRT_ST_RPCS_LIST };

/* CRT ctl opcode definitions, must be 0xFF00xxxx.*/
#define CRT_OPC_CTL_BASE 0xF3000000UL
enum {
	__FIRST_CTL = CRT_PROTO_OPC(CRT_OPC_CTL_BASE, CRT_PROTO_CTL_VERSION, 0) - 1,
	CRT_CTL_RPCS_LIST
};

/* CRT IV opcode definitions, must be 0xFF00xxxx.*/
#define CRT_OPC_IV_BASE 0xF4000000UL
enum { __FIRST_IV = CRT_PROTO_OPC(CRT_OPC_IV_BASE, CRT_PROTO_IV_VERSION, 0) - 1, CRT_IV_RPCS_LIST };
...
#define CRT_SEQ_GRP_CACHE                                                                          \
	((d_rank_t)(gc_rank)CRT_VAR)((uint32_t)(gc_tag)CRT_VAR)((d_string_t)(gc_uri)CRT_VAR)
...
#define CRT_ISEQ_ST_SEND_ID     /* input fields */ ((uint64_t)(unused1)CRT_VAR)

#define CRT_ISEQ_ST_SEND_ID_IOV /* input fields */                                                 \
	((uint64_t)(unused1)CRT_VAR)((d_iov_t)(unused2)CRT_VAR)

#define CRT_ISEQ_ST_SEND_ID_IOV_BULK /* input fields */                                            \
	((uint64_t)(unused1)CRT_VAR)((d_iov_t)(unused2)CRT_VAR)((crt_bulk_t)(unused3)CRT_VAR)

#define CRT_ISEQ_ST_SEND_ID_BULK /* input fields */                                                \
	((uint64_t)(unused1)CRT_VAR)((crt_bulk_t)(unused2)CRT_VAR)

#define CRT_OSEQ_ST_REPLY_EMPTY /* output fields */

#define CRT_OSEQ_ST_REPLY_IOV   /* output fields */ ((d_iov_t)(unused1)CRT_VAR)

CRT_RPC_DECLARE(crt_st_send_id_reply_iov, CRT_ISEQ_ST_SEND_ID, CRT_OSEQ_ST_REPLY_IOV)

CRT_RPC_DECLARE(crt_st_send_iov_reply_empty, CRT_ISEQ_ST_SEND_ID_IOV, CRT_OSEQ_ST_REPLY_EMPTY)

CRT_RPC_DECLARE(crt_st_both_iov, CRT_ISEQ_ST_SEND_ID_IOV, CRT_OSEQ_ST_REPLY_IOV)

CRT_RPC_DECLARE(crt_st_send_iov_reply_bulk, CRT_ISEQ_ST_SEND_ID_IOV_BULK, CRT_OSEQ_ST_REPLY_EMPTY)

CRT_RPC_DECLARE(crt_st_send_bulk_reply_iov, CRT_ISEQ_ST_SEND_ID_BULK, CRT_OSEQ_ST_REPLY_IOV)

CRT_RPC_DECLARE(crt_st_both_bulk, CRT_ISEQ_ST_SEND_ID_BULK, CRT_OSEQ_ST_REPLY_EMPTY)

#define CRT_ISEQ_ST_SEND_SESSION /* input fields */                                                \
	((uint32_t)(unused1)CRT_VAR)((uint32_t)(unused2)CRT_VAR)((uint32_t)(unused3)CRT_VAR)(      \
	    (uint32_t)(unused4)CRT_VAR)

#define CRT_OSEQ_ST_REPLY_ID /* output fields */ ((uint64_t)(unused1)CRT_VAR)

CRT_RPC_DECLARE(crt_st_open_session, CRT_ISEQ_ST_SEND_SESSION, CRT_OSEQ_ST_REPLY_ID)

CRT_RPC_DECLARE(crt_st_close_session, CRT_ISEQ_ST_SEND_ID, CRT_OSEQ_ST_REPLY_EMPTY)

#define CRT_ISEQ_ST_START /* input fields */                                                       \
	((crt_group_id_t)(unused1)CRT_VAR)((d_iov_t)(unused2)CRT_VAR)((uint32_t)(unused3)CRT_VAR)( \
	    (uint32_t)(unused4)CRT_VAR)((uint32_t)(unused5)CRT_VAR)((uint32_t)(unused6)CRT_VAR)(   \
	    (uint32_t)(unused7)CRT_VAR)

#define CRT_OSEQ_ST_START /* output fields */ ((int32_t)(unused1)CRT_VAR)

CRT_RPC_DECLARE(crt_st_start, CRT_ISEQ_ST_START, CRT_OSEQ_ST_START)

#define CRT_ISEQ_ST_STATUS_REQ /* input fields */ ((crt_bulk_t)(unused1)CRT_VAR)

#define CRT_OSEQ_ST_STATUS_REQ /* output fields */                                                 \
	((uint64_t)(test_duration_ns)CRT_VAR)((uint32_t)(num_remaining)CRT_VAR)(                   \
	    (int32_t)(status)CRT_VAR)

CRT_RPC_DECLARE(crt_st_status_req, CRT_ISEQ_ST_STATUS_REQ, CRT_OSEQ_ST_STATUS_REQ)

#define CRT_ISEQ_IV_FETCH /* input fields */                                                       \
	/* Namespace ID */                                                                         \
	((uint32_t)(ifi_ivns_id)CRT_VAR)((uint32_t)(ifi_grp_ver)CRT_VAR)(                          \
	    (crt_group_id_t)(ifi_ivns_group)CRT_VAR) /* IV Key */                                  \
	    ((d_iov_t)(ifi_key)CRT_VAR)              /* Bulk handle for iv value */                \
	    ((crt_bulk_t)(ifi_value_bulk)CRT_VAR)    /* Class id */                                \
	    ((int32_t)(ifi_class_id)CRT_VAR)         /* Root node for current fetch operation */   \
	    ((d_rank_t)(ifi_root_node)CRT_VAR)

#define CRT_OSEQ_IV_FETCH /* output fields */ ((int32_t)(ifo_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_iv_fetch, CRT_ISEQ_IV_FETCH, CRT_OSEQ_IV_FETCH)

#define CRT_ISEQ_IV_UPDATE /* input fields */                                                      \
	/* IV namespace ID */                                                                      \
	((uint32_t)(ivu_ivns_id)CRT_VAR)((uint32_t)(ivu_grp_ver)CRT_VAR)(                          \
	    (crt_group_id_t)(ivu_ivns_group)CRT_VAR) /* IOV for key */                             \
	    ((d_iov_t)(ivu_key)CRT_VAR)              /* IOV for sync */                            \
	    ((d_iov_t)(ivu_sync_type)CRT_VAR)        /* Bulk handle for iv value */                \
	    ((crt_bulk_t)(ivu_iv_value_bulk)CRT_VAR) /* Root node for IV UPDATE */                 \
	    ((d_rank_t)(ivu_root_node)CRT_VAR) /* Original node that issued crt_iv_update call */  \
	    ((d_rank_t)(ivu_caller_node)CRT_VAR) /* Class ID */                                    \
	    ((uint32_t)(ivu_class_id)CRT_VAR)((uint32_t)(padding)CRT_VAR)

#define CRT_OSEQ_IV_UPDATE /* output fields */ ((uint64_t)(rc)CRT_VAR)

CRT_RPC_DECLARE(crt_iv_update, CRT_ISEQ_IV_UPDATE, CRT_OSEQ_IV_UPDATE)

#define CRT_ISEQ_IV_SYNC /* input fields */                                                        \
	/* IV Namespace ID */                                                                      \
	((uint32_t)(ivs_ivns_id)CRT_VAR)((uint32_t)(ivs_grp_ver)CRT_VAR)(                          \
	    (crt_group_id_t)(ivs_ivns_group)CRT_VAR) /* IOV for key */                             \
	    ((d_iov_t)(ivs_key)CRT_VAR)              /* IOV for sync type */                       \
	    ((d_iov_t)(ivs_sync_type)CRT_VAR)        /* IV Class ID */                             \
	    ((uint32_t)(ivs_class_id)CRT_VAR)

#define CRT_OSEQ_IV_SYNC /* output fields */ ((int32_t)(rc)CRT_VAR)

CRT_RPC_DECLARE(crt_iv_sync, CRT_ISEQ_IV_SYNC, CRT_OSEQ_IV_SYNC)

#define CRT_ISEQ_CTL /* input fields */                                                            \
	((crt_group_id_t)(cel_grp_id)CRT_VAR)((d_rank_t)(cel_rank)CRT_VAR)

#define CRT_OSEQ_CTL_EP_LS /* output fields */                                                     \
	((d_iov_t)(cel_addr_str)CRT_VAR)((int32_t)(cel_ctx_num)CRT_VAR)((int32_t)(cel_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_ep_ls, CRT_ISEQ_CTL, CRT_OSEQ_CTL_EP_LS)

#define CRT_OSEQ_CTL_GET_URI_CACHE /* output fields */                                             \
	((struct crt_grp_cache)(cguc_grp_cache)CRT_ARRAY)((int32_t)(cguc_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_get_uri_cache, CRT_ISEQ_CTL, CRT_OSEQ_CTL_GET_URI_CACHE)

#define CRT_OSEQ_CTL_GET_HOST /* output fields */                                                  \
	((d_iov_t)(cgh_hostname)CRT_VAR)((int32_t)(cgh_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_get_host, CRT_ISEQ_CTL, CRT_OSEQ_CTL_GET_HOST)

#define CRT_OSEQ_CTL_GET_PID /* output fields */                                                   \
	((int32_t)(cgp_pid)CRT_VAR)((int32_t)(cgp_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_get_pid, CRT_ISEQ_CTL, CRT_OSEQ_CTL_GET_PID)

#define CRT_ISEQ_PROTO_QUERY /* input fields */                                                    \
	((d_iov_t)(pq_ver)CRT_VAR)((int32_t)(pq_ver_count)CRT_VAR)((uint32_t)(pq_base_opc)CRT_VAR)

#define CRT_OSEQ_PROTO_QUERY /* output fields */                                                   \
	((uint32_t)(pq_ver)CRT_VAR)((int32_t)(pq_rc)CRT_VAR)

CRT_RPC_DECLARE(crt_proto_query, CRT_ISEQ_PROTO_QUERY, CRT_OSEQ_PROTO_QUERY)

#define CRT_ISEQ_CTL_FI_ATTR_SET /* input fields */                                                \
	((uint32_t)(fa_fault_id)CRT_VAR)((uint32_t)(fa_interval)CRT_VAR)(                          \
	    (uint64_t)(fa_max_faults)CRT_VAR)((uint32_t)(fa_err_code)CRT_VAR)(                     \
	    (uint32_t)(fa_probability_x)CRT_VAR)((d_string_t)(fa_argument)CRT_VAR)(                \
	    (uint32_t)(fa_probability_y)CRT_VAR)

#define CRT_OSEQ_CTL_FI_ATTR_SET /* output fields */ ((int32_t)(fa_ret)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_fi_attr_set, CRT_ISEQ_CTL_FI_ATTR_SET, CRT_OSEQ_CTL_FI_ATTR_SET)

#define CRT_ISEQ_CTL_FI_TOGGLE /* input fields */ ((bool)(op)CRT_VAR)

#define CRT_OSEQ_CTL_FI_TOGGLE /* output fields */ ((int32_t)(rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_fi_toggle, CRT_ISEQ_CTL_FI_TOGGLE, CRT_OSEQ_CTL_FI_TOGGLE)

#define CRT_ISEQ_CTL_LOG_SET /* input fields */ ((d_string_t)(log_mask)CRT_VAR)

#define CRT_OSEQ_CTL_LOG_SET /* output fields */ ((int32_t)(rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_log_set, CRT_ISEQ_CTL_LOG_SET, CRT_OSEQ_CTL_LOG_SET)

#define CRT_ISEQ_CTL_LOG_ADD_MSG /* input fields */ ((d_string_t)(log_msg)CRT_VAR)

#define CRT_OSEQ_CTL_LOG_ADD_MSG /* output fields */ ((int32_t)(rc)CRT_VAR)

CRT_RPC_DECLARE(crt_ctl_log_add_msg, CRT_ISEQ_CTL_LOG_ADD_MSG, CRT_OSEQ_CTL_LOG_ADD_MSG)
...
#define RPC_ADDREF(RPC)                                                                            \
	do {                                                                                       \
		...
		D_ASSERTF((RPC)->crp_refcount != 0, "%p addref from zero\n", (RPC));               \
...
#define RPC_DECREF(RPC)                                                                            \
	do {                                                                                       \
		int __ref;                                                                         \
		D_SPIN_LOCK(&(RPC)->crp_lock);                                                     \
		D_ASSERTF((RPC)->crp_refcount != 0, "%p decref from zero\n", (RPC));               \
		__ref = --(RPC)->crp_refcount;                                                     \
		D_SPIN_UNLOCK(&(RPC)->crp_lock);                                                   \
...
static inline bool
crt_rpc_cb_customized(struct crt_context *crt_ctx, crt_rpc_t *rpc_pub)
{
...
/* crt_rpc.c */
int
crt_rpc_priv_alloc(crt_opcode_t opc, struct crt_rpc_priv **priv_allocated, bool forward);
void
...
int
crt_req_create_internal(crt_context_t crt_ctx, crt_endpoint_t *tgt_ep, crt_opcode_t opc,
			bool forward, crt_rpc_t **req);
int
