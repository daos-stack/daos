...
int
crt_flat_get_children_cnt(uint32_t grp_size, uint32_t branch_ratio, uint32_t grp_root,
...
int
crt_flat_get_children(uint32_t grp_size, uint32_t branch_ratio, uint32_t grp_root,
...
int
crt_flat_get_parent(uint32_t grp_size, uint32_t branch_ratio, uint32_t grp_root, uint32_t grp_self,
		    uint32_t *parent)
{
	D_ASSERT(grp_size > 0);
...
struct crt_topo_ops crt_flat_ops = {.to_get_children_cnt = crt_flat_get_children_cnt,
