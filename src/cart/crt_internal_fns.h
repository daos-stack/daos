...
int crt_context_get_quota_resource(crt_context_t crt_ctx, crt_quota_type_t quota);
int crt_context_put_quota_resource(crt_context_t crt_ctx, crt_quota_type_t quota);
